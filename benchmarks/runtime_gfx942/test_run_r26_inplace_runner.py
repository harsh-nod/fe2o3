...
class R26RunnerContractTests(unittest.TestCase):
    ...
    def test_runner_uses_the_v4_recycle_accounting_contract(self) -> None:
        self.assertIn("fe2o3.r26-inplace-benchmark.v4", self.source)
        self.assertNotIn("fe2o3.r26-inplace-benchmark.v3", self.source)
        self.assertIn("fe2o3.r26-inplace-benchmark.v4", self.common_source)
        self.assertIn("control_path=n/a", self.common_source)
        self.assertIn('"completion_signal_recycle"', self.common_source)
        self.assertIn('"completion_detach_restore"', self.common_source)
        self.assertIn('"recycle_inclusive"', self.common_source)
