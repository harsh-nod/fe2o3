...
printf 'context schema=fe2o3.async-copy-benchmark.v1 git_commit=%s target=gfx942:xnack- gpu_indices=%s,%s unique_ids=%s,%s bytes=%s depths=%s warmups=%s samples=%s kfd_profile=%s max_busy_percent=%s phase_timeout_seconds=%s rocm_version=%s rustc=%s sdma_manifest_sha256=749e371515337e9ce0ef25f6f96c42087c1b44b3057b0dd905b9e7b635b4fe21\n' \
