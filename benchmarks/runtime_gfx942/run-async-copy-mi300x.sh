...
printf 'context schema=fe2o3.async-copy-benchmark.v1 git_commit=%s target=gfx942:xnack- gpu_indices=%s,%s unique_ids=%s,%s bytes=%s depths=%s warmups=%s samples=%s kfd_profile=%s kfd_multi_profile=directional max_busy_percent=%s phase_timeout_seconds=%s rocm_version=%s rustc=%s sdma_manifest_sha256=289b2b362333d5e6b37903d38e82a2c4eda5adb83d34d053f966acc77adfb17c\n' \
