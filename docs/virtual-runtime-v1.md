...
The V3 binary32 rows are compile-time exact input/result bit tables for the
pinned `rustc_apfloat 0.2.3+llvm-462a31f5a5ab` round-to-nearest-even, NaN,
