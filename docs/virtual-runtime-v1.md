...
| C3 wave/workgroup | Wave32/Wave64 masks, ballot/any/all/integer shuffle, exact V9/V10 software-IEEE f32 XOR-butterfly sum/maximum and bit-preserving broadcast, static LDS, barriers, integer atomics/fences, race/HB exploration | KIR requires full uniform waves and reports partial launch tails exactly; general divergence/reconvergence, scans, matrix/MFMA, dynamic/general LDS, and remaining intrinsics stay typed unsupported |
...
| 4 wave collective | Partial: admitted ballot/any/all/shuffle and V9/V10 f32 sum/maximum/broadcast are exact for full Wave32/Wave64 tiles, with typed divergence/mismatch/partial-mask failures; broader type/operation reduction and scan coverage remains incomplete |
