...
sources=(
    ...
    crates/fe2o3-runtime-model/verus/context_read_invariant_v1.rs
    crates/fe2o3-runtime-model/verus/check-read-invariant.py
    crates/fe2o3-runtime-model/verus/check-negative-quality.py
    crates/fe2o3-runtime-model/verus/verify-verus.sh
    crates/fe2o3-runtime-model/verus/pins/CONTEXT_READ_INVARIANT_SHA256
    crates/fe2o3-runtime-model/verus/pins/READ_INVARIANT_CHECKER_SHA256
    ...
    docs/runtime-context-read-invariant-v1.md
