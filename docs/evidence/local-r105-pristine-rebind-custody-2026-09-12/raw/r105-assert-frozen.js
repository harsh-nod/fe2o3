...
const expected = JSON.parse(fs.readFileSync('/home/harsh/.codex-tmp/r105-frozen-source.json'));
...
if (process.argv[2]) {
  ...
  fs.writeFileSync('/home/harsh/.codex-tmp/r105-restoration-' + name + '.json',
