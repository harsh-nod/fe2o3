...
const evidence = 'docs/evidence/local-r105-pristine-rebind-custody-2026-09-12';
...
assert.strictEqual(git(['rev-parse', 'HEAD']).toString().trim(),
  'c70773b9c9d9383f79a1c2fe829f1e1163596750');
const hash = bytes => crypto.createHash('sha256').update(bytes).digest('hex');
const baseline = JSON.parse(fs.readFileSync(path.join(root, 'raw/r105-frozen-source.json')));
...
const docs = ['docs/runtime-a1-a2-swarm-current.md', 'docs/runtime-a1-a2-next-wave.md',
  ...
  'docs/runtime-pristine-rebind-custody-v1.md',
