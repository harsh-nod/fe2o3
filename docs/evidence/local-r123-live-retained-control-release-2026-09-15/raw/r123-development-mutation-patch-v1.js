...
const helper = '/home/harsh/.codex-tmp/r123-development-mutation-check-v2.js';
assert.strictEqual(crypto.createHash('sha256').update(fs.readFileSync(helper)).digest('hex'),
  '143f0e5dd9747a6ab4436ea8c78de351f9598d2b783c948b657bdfda0d5d3d23');
const M = require(helper), C = M.C;
C.pin(helper, '143f0e5dd9747a6ab4436ea8c78de351f9598d2b783c948b657bdfda0d5d3d23');
C.bytes(__filename);
