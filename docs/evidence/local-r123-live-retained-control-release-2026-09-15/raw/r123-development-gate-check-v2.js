// Local R123 gate validation only. Mutation, native and formal acceptance remain separate.
const fs = require('fs'), path = require('path'), assert = require('assert'), crypto = require('crypto');
const root = '/home/harsh/.codex-tmp', checker = path.join(root, 'r123-development-check-v1.js');
...
// V1's immutable base plan omitted four unchanged dispatch-binding doc fences.
const extraDocRelocations = [
  {path: 'crates/fe2o3-kfd/src/queue_dispatch_binding.rs', from: 3017, to: 3018,
    fence_sha256: '4f33eb779ccdbf31d318b8918a17666b1be38fa2326e1d47fd39f4d10a9aa6b0'},
  {path: 'crates/fe2o3-kfd/src/queue_dispatch_binding.rs', from: 3027, to: 3028,
    fence_sha256: '5b9c98efbe78d001d3b2d74c4b83f6ffee64484eaad1eefb3cf6511f5f41d46c'},
  {path: 'crates/fe2o3-kfd/src/queue_dispatch_binding.rs', from: 3035, to: 3036,
    fence_sha256: '6c490849d07d33cbc9e88cc727c5a38ee7bfed15843d9e67258fa69a872b50ef'},
  {path: 'crates/fe2o3-kfd/src/queue_dispatch_binding.rs', from: 3061, to: 3062,
    fence_sha256: '62ae8451926209736f88f8bdc599ef548c2cd4c68b44809b3d557cf7004ab9a1'},
];
const gates = {...C.p, doc_relocations: [...C.p.doc_relocations, ...extraDocRelocations]};
assert.strictEqual(gates.doc_relocations.length, 7);
assert.strictEqual(new Set(gates.doc_relocations.map(r => r.path + ':' + r.from)).size, 7);
...
function record(spec) {
  return C.completed(spec.run || spec.name, spec.command, spec.predecessor).log;
}
function roster(log) {
  E.assertPassing(log);
...
module.exports = {C, gates, extraDocRelocations, accepted, record, full, leaf, roster, groups, fence, relocate, linux, linuxNames, fullGnu};
