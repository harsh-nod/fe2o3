...
const root = '/home/harsh/.codex-tmp/', helper = root + 'r123-development-check-v1.js';
const helperHash = 'd83f5ab4a189ab67e52d1a938bfacf85d01081b8bdcd3646ca96023387892c4e';
...
const baselinePath = 'docs/evidence/local-r122-live-data-release-2026-09-15/raw/r122-development-clippy-v2-source.json';
const baseline = JSON.parse(C.git(['show', C.p.source_parent + ':' + baselinePath]));
assert.strictEqual(C.hash(JSON.stringify(baseline)), '178fa1fb2c9d3267440dbf36c50e4d79916e66fb2765446d7e1fa8acb8fc90c4');
assert.strictEqual(Object.keys(baseline).length, 5700);
...
const output = root + 'r123-development-source-bundle-v1.json', encoded = JSON.stringify(bundle, null, 2) + '\n';
