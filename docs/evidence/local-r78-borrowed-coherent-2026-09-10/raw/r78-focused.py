"""Retain focused borrowed-initialization CPU gates, without hardware work."""
import os
...
command = ['cargo', '+nightly-2026-04-03', 'test', '--locked', '--offline',
           '--no-fail-fast', '-p', 'fe2o3-kfd', '-p', 'fe2o3-runtime',
           '--all-features', '--lib', 'borrowed_initialization']
log = root / f'r78-focused-{sys.argv[1]}.log'
