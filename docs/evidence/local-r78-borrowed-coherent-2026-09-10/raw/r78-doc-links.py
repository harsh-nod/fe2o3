"""Check local Markdown references in the current R78 contract and dispatch documents."""
...
paths = [
    ...
    'docs/evidence/local-r78-borrowed-coherent-2026-09-10/README.md',
]
count = 0
for name in paths:
    source = repo / name
...
(repo.parent / 'r78-doc-links.log').write_text(result + '\n')
print(result)
