...
commands = [
    ('r78-proof-inventory.log', ['python3', '-I',
    ...
    ('r78-production-metadata.json', ['cargo', '+nightly-2026-04-03', 'metadata',
        '--locked', '--offline', '--no-default-features', '--format-version', '1',
        '--filter-platform', 'x86_64-unknown-linux-musl']),
    ('r78-production-audit.log', ['python3', '-B', 'scripts/runtime_pure_rust_audit.py',
        'metadata', '--input', str(root / 'r78-production-metadata.json'), '--root', 'fe2o3-runtime']),
]
