...
CAPTURED_AUDIT = HERE / 'audit1/controls-source/docs/evidence/dev-mixed-acquisition-proof-2026-09-24/audit.py'
A = module(CAPTURED_AUDIT if CAPTURED_AUDIT.exists() else HERE / 'audit.py',
    '5212f2e9697e14aec1b55a5b21468723e3d59186bfd359b57b61c836b39805be', 'mixed_final_audit')
