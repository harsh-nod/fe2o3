// Check local references in the R93 contract, evidence and dispatch documents.
const fs = require('fs');
const path = require('path');
const repo = '/home/harsh/.codex-tmp/fe2o3-r61-execution';
const files = [
  'docs/runtime-primary-queue-construction-custody-v1.md',
  'docs/evidence/local-r93-primary-sequence-2026-09-11/README.md',
...
console.log('PASS: ' + count + ' local Markdown links/anchors in ' + files.length + ' R93 documents');
