#!/usr/bin/env python3
"""Record/replay CPU regression evidence for lower XGMI currentness diagnostics."""
...
ROOT = HERE.parents[2]
PREFIX = "docs/evidence/dev-xgmi-currentness-diagnostic-cpu-2026-09-20/"
...
spec = importlib.util.spec_from_file_location("currentness_cpu_helpers", path)
C = importlib.util.module_from_spec(spec)
spec.loader.exec_module(C)
need, sha, read = C.need, C.sha, C.read

STATIC = ("cpu.py", "test_cpu.py", "PROTOCOL.md")
DOC = "docs/runtime-xgmi-currentness-diagnostics-v1.md"
FMT = tuple("crates/fe2o3-kfd/src/" + path for path in (
    "currentness.rs", "currentness/full.rs", "currentness/full/tests.rs",
    "currentness/full/tests/diagnostic.rs", "currentness_diagnostic.rs", "lib.rs",
    "memory_linux.rs", "sdma.rs", "shared_memory.rs",
    "shared_memory/pair_currentness.rs", "shared_memory/pair_currentness/tests.rs",
    "topology.rs", "topology/tests/host_diagnostics.rs",
))
FILTERS = ("topology::tests::", "currentness::", "currentness_diagnostic::",
           "shared_memory::pair_currentness::tests::", "device::tests::", "sdma::tests::")
NEW_TESTS = C.family("currentness::full::tests::diagnostic::", """
both_modes_preserve_every_pair_callback_error_panic_and_terminal_reentry
both_modes_preserve_identity_snapshot_route_and_prior_poison_rejections
both_modes_preserve_success_and_latch_order_and_disabled_has_no_clock_reads
final_diagnostic_panic_cannot_reactivate_devices_or_sessions
""") | C.family("topology::tests::host_diagnostics::", """
closing_identity_changes_fail_identically_in_each_mode
every_traced_io_panic_preserves_payload_and_order_in_both_modes
timing_preserves_fresh_complete_host_snapshots_and_ordered_io
timing_preserves_static_topology_identity_and_render_failures
""") | C.family("currentness_diagnostic::tests::", """
disabled_timer_is_zero_sized_and_never_reads_the_clock
measured_operations_run_once_and_preserve_errors_and_panics
""") | C.family("currentness_diagnostic::enabled::tests::", """
invalid_duplicate_missing_and_overflow_intervals_are_unavailable
clock_inversion_and_nested_containment_are_checked
""")
CONFIGURATIONS = ("gnu", "musl", "feature-off")
PYTHON_TESTS = {"test_commands", "test_test_output", "test_inventory", "test_typed_binding"}
SELECTED_COUNT = 198
SELECTED_SHA = "1378290024ccf185a2c789d388c0734a99715b75862f4f446022fab948cfef8e"
...
def derive(archive, execution_root, target, live=False):
    ...
    need(set(FMT) <= set(source["files"]), "all changed diagnostic source included")
    ...
    return {"schema": "fe2o3.xgmi-currentness-diagnostic-cpu.v1", "execution_root": str(execution_root),
