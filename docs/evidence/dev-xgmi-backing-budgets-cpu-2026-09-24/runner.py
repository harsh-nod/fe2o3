...
def main():
    ...
    commands = [
        ...
        ('gnu', cargo + ['test'] + packages + ['--all-features', '--lib', '--', '--test-threads=4'], 1200),
        ('musl', cargo + ['test'] + packages + ['--all-features', '--lib', '--target', 'x86_64-unknown-linux-musl', '--', '--test-threads=4'], 1200),
