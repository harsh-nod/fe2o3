"""Retain one host regression selection, including an explicitly expected mutation rejection."""
import os
...
assert re.fullmatch(r"r85-[a-z0-9-]+", label)
...
command = ['cargo', '+nightly-2026-04-03', 'test', '--locked', '--offline',
    '-p', 'fe2o3-host', '--all-features', '--lib', selection]
