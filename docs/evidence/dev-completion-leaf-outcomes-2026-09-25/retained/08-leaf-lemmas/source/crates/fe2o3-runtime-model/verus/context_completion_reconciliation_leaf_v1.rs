...
pub closed spec fn eligible_leaf(table: CompletionTableV1, id: RuntimeSubmissionIdV1) -> bool {
    leaf_shape(table, id)
}
...
pub closed spec fn leaf_effect(before: CompletionTableV1, after: CompletionTableV1,
