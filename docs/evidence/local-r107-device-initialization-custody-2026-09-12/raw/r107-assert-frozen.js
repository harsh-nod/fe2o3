...
const expected = JSON.parse(fs.readFileSync('/home/harsh/.codex-tmp/r107-frozen-source.json'));
...
if (process.argv[2]) {
  ...
  fs.writeFileSync('/home/harsh/.codex-tmp/r107-restoration-' + name + '.json',
