...
const mutation = read('r107-accepted-mutations.json').find(m => m.name === name);
assert(mutation, 'known mutation');
const run = read('r107-accepted-' + prefix + 'mut-' + name + '.json');
...
assert.strictEqual(run.source_head, '5ba89a0e642cf02effc8e462e33be93b19aec1c2');
...
const inputs = read('r107-accepted-' + prefix + 'mut-' + name + '-source.json');
