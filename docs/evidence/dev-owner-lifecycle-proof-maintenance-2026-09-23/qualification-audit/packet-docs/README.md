...
- Both entire lifecycle roots: 1,240 verified obligations, zero errors.
- All 49 scoped logical negative controls reject at intended proof obligations.
...
Run `python3 -B audit.py --repo <Git-repository> --selftest` from this packet to
