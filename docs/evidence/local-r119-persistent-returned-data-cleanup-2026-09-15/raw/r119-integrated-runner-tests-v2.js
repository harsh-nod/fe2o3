...
const inputs = JSON.parse(fs.readFileSync(path.join(root, 'r119-integrated-runner-inputs-v2.json'), 'utf8'));
...
assert.deepStrictEqual(inputs.helpers.map(item => item.name), ['r119-integrated-runner-tests-v2.js', 'r119-integrated-run-v1.js']);
