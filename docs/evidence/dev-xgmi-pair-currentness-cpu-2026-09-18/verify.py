#!/usr/bin/env python3
"""Isolated acceptance of the frozen CPU-only XGMI pair-currentness run."""
...
PREFIX = "docs/evidence/dev-xgmi-pair-currentness-cpu-2026-09-18/"
PRIOR = "docs/evidence/dev-xgmi-host-attribution-cpu-2026-09-18/"
BASE = "dccf5cb85ab79c31e493f0efe4e9b7ac76fd1770"
SOURCE_SHA = "87462da0047e92771bdb69f20c4db1eec8cd89e60ee839b89074090562f2f872"
SOURCE_FILES = 5572
DOC = "docs/runtime-xgmi-pair-currentness-v1.md"
DOC_SHA = "769291d16f43961af0e0e0db7daa0650a7e8ed28756d989eb2f1b08a35539ab4"
ROSTERS = {
    "kfd": (148, "b717a84e905c39606b585ddd7feb3c7219eaca4df17baef9d1790c1bc3cd1312"),
...
TOOLS = {
    ...
    PREFIX
    + "qualify.py": "06f5d1e8ba5f8e8afee3c7a3dce2373a64b9c1cb9621314613ef2eaa7da38686",
}
...
def verify_bundle(archive=HERE, live=False):
    ...
    for name in (
        ...
        need(
            ...
            "required pair-currentness/retirement source included",
        )
    if live:
        current = json.loads(
