...
git -C "$owned/source" fetch --no-tags https://github.com/harsh-nod/fe2o3.git ecad7245fa9fa051daf3a9cb3cd82724da5446eb
...
git -C "$owned/source" checkout --detach ecad7245fa9fa051daf3a9cb3cd82724da5446eb
cd "$owned/source"
