#!/usr/bin/env python3
"""Bounded development CPU qualification of directed async operations."""
import hashlib
...
def main():
    ...
    if len(sys.argv) > 2 and sys.argv[2] == 'focused':
        commands = [('focused', cargo + ['test', '-p', 'fe2o3-runtime', '--all-features',
                                         '--lib', 'async_engine::tests::owned_tests::snapshot_tests'], 1200)]
