...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix='fe2o3-evidence-selftest-') as owned:
        ...
        api['need'](len(campaign_check()) == 14, 'baseline complete campaign')
        ...
        adverse('changed candidate', case / 'producer.rs', lambda b: b + b'\n', campaign_check)
        ...
        if not args.campaign_only:
            ...
            qualification_check()
        api['need'](len(campaign_check()) == 14, 'restored campaign')
