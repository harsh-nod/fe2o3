...
printf 'context diagnostic=shared-host-kfd-native-wait git_commit=fcd5a89a113c6538338598bfcdb6769fb5c06042 gpu=4 unique_id=0x54f88318ca05093d bytes=268435456 depth=1 warmups=3 samples=10 repetitions=4 optional_context_journal=disabled placement=cpu48-95-memory1\n'
