...
git -C "$owned/source" fetch --no-tags https://github.com/harsh-nod/fe2o3.git fcd5a89a113c6538338598bfcdb6769fb5c06042
...
git -C "$owned/source" checkout --detach fcd5a89a113c6538338598bfcdb6769fb5c06042
cd "$owned/source"
