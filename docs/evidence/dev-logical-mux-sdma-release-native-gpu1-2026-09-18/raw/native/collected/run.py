#!/usr/bin/env python3
"""LogicalMux-SDMA teardown runner requiring reviewed payload and fresh device admission."""
...
def main():
    ...
    P.need(
        re.fullmatch(
            r"/home/harsh/fe2o3-logical-mux-sdma-20260918\.[A-Za-z0-9]{8}", str(root)
        ),
    ...
    P.need(
        ...
        "specific root approval and shared-host permission",
    )
    ...
    state = {
        ...
        "logical_lane_execution_claim": False,
        "cursor_observation_claim": False,
    }
    try:
