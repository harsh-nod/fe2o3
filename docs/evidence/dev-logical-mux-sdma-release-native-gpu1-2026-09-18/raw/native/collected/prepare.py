...
CPU = Path("docs/evidence/dev-logical-mux-sdma-example-cpu-2026-09-18")
SELECTED = {
    ...
    "crates/fe2o3-kfd/src/queue_live.rs": "source/queue_live.rs",
    "crates/fe2o3-kfd/src/sdma.rs": "source/sdma.rs",
    "crates/fe2o3-kfd/src/sdma/multi_queue/logical_mux.rs": "source/logical_mux.rs",
    ...
    "crates/fe2o3-kfd/src/queue_live/construction_primary/integration_release_logical_mux_sdma_tests.rs": "source/integration_release_logical_mux_sdma_tests.rs",
    "crates/fe2o3-kfd/src/queue_live/construction_primary/integration_release_tests.rs": "source/integration_release_tests.rs",
...
def main():
    ...
    P.need(len(cohort) == P.COHORT_FILE_COUNT, "final source cohort size")
    started = time.time_ns()
    P.need(P.sha(Path(__file__).resolve().parent / "allowed-signers") == P.SIGNERS_SHA, "reviewed public signer")
    signature_command = [
        "git",
        "-c",
        "gpg.ssh.allowedSignersFile=" + str(Path(__file__).resolve().parent / "allowed-signers"),
        "verify-commit",
        "--raw",
        P.COMMIT,
    ]
    ...
    for name in ("run.py", "protocol.py", "test_protocol.py", "PLAN.md", "prepare.py", "allowed-signers"):
