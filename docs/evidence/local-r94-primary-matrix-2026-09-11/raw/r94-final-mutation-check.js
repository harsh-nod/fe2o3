...
const baseline = JSON.parse(fs.readFileSync(path.join(root, 'r94-guard-formatted-source.json')));
...
for (const mutation of JSON.parse(fs.readFileSync(path.join(root, 'r94-corrected-mutations.json')))) {
