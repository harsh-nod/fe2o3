...
const evidence = 'docs/evidence/local-r103-replacement-input-custody-2026-09-12';
...
assert.strictEqual(git(['rev-parse', 'HEAD']).toString().trim(),
  '50c4eb075013fde0a984a003c0b5b90eae562847');
const hash = bytes => crypto.createHash('sha256').update(bytes).digest('hex');
const baseline = JSON.parse(fs.readFileSync(path.join(root, 'raw/r103-frozen-source.json')));
...
const docs = ['docs/runtime-a1-a2-swarm-current.md', 'docs/runtime-a1-a2-next-wave.md',
  'docs/runtime-a1-a2-swarm-dispatch-r83.md', 'docs/runtime-primary-queue-construction-custody-v1.md',
  'docs/runtime-context-version-journal-v1.md',
  evidence + '/README.md'];
let links = 0;
