#!/usr/bin/env python3
"""Record CPU correctness and paired ordering/search/enrollment measurements."""
import argparse
import hashlib
...
def commands():
    return [
        ...
        *[(name, ['cargo', 'test', '--locked', '-p', 'fe2o3-runtime-model', '--release', name + '_performance',
                  '--', '--ignored', '--nocapture', '--test-threads=1']) for name in ('ordering', 'search', 'enrollment')],
    ]
