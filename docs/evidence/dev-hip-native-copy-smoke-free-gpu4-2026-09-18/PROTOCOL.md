...
The earlier sealed refusal packet
`docs/evidence/dev-hip-native-copy-smoke-1890a64e1-2026-09-18` separately records
installed driver/source identities and read-only excerpts. Those historical
records are not fresh results of this attempt. They support the interpretation
of busy percentage as firmware aggregate activity, not PID ownership; they do
not identify a previous transient's cause or rehabilitate failed observations.

## Independent Attempt

The earlier packet remains refused and immutable. This new attempt was
authorized separately after a new planning inventory identified GPU4 as a
candidate. It exports and builds the same committed inputs anew in a fresh
owned directory; no old result or admission is reused. Native execution still
requires its own fresh strict preflight and explicit primary READY.
