"""Check local Markdown references in the current R77 contract and dispatch documents."""
...
paths = [
    'docs/runtime-persistent-generated-projection-v1.md',
    'docs/runtime-context-generated-preparation-v1.md',
    'docs/runtime-a1-a2-next-wave.md',
    'docs/runtime-a1-a2-swarm-plan.md',
    'docs/evidence/local-r77-persistent-projection-2026-09-10/README.md',
]
count = 0
for name in paths:
    source = repo / name
...
(repo.parent / 'r77-doc-links.log').write_text(result + '\n')
print(result)
