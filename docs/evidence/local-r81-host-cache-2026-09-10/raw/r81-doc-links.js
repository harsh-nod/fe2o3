// Check local references in the R81 contract, evidence and current roadmap.
const fs = require('fs');
const path = require('path');
const repo = '/home/harsh/.codex-tmp/fe2o3-r61-execution';
const files = [
  'docs/runtime-host-cache-limits-v1.md',
  ...
  'docs/evidence/local-r81-host-cache-2026-09-10/README.md',
];
let count = 0;
