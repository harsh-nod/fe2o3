...
const {checkBaseline} = require('./r114-qualification-collect.js');
const {map, helpers, previous} = checkBaseline();
const name = 'r114-qualification-manifest.json';
...
console.log('Pinned 34 cohort entries, 15 prospective mutations, ' + helpers.length + ' helpers and ' + pins.length + ' historical artifacts');
