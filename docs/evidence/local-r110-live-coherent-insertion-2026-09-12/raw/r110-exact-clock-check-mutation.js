...
const mutation = read('r110-exact-mutations.json').find(m => m.name === name);
assert(mutation, 'known mutation');
const run = read('r110-' + prefix + 'mut-' + name + '.json');
...
assert.strictEqual(run.source_head, 'a9e1c73bb9b752610e58be9cd96861962e140787');
...
const inputs = read('r110-' + prefix + 'mut-' + name + '-source.json');
