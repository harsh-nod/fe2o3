...
const expected = JSON.parse(fs.readFileSync('/home/harsh/.codex-tmp/r104-frozen-source.json'));
...
if (process.argv[2]) {
  ...
  fs.writeFileSync('/home/harsh/.codex-tmp/r104-restoration-' + name + '.json',
