#!/usr/bin/env python3
"""Bounded local controller for one exact root-approved striped-SDMA directory."""
...
BUNDLE = Path(
    "/home/harsh/.codex-tmp/fe2o3-striped-sdma-native-bundle-v2-20260918"
)
OWNED = "/tmp/fe2o3-striped-sdma-20260918.ee30bc89"
