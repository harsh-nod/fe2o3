...
def main():
    ...
    payload = Path(
        tempfile.mkdtemp(
            prefix="fe2o3-xgmi-settled-20260918.", dir="/home/harsh/.codex-tmp"
        )
    )
    ...
    try:
        ...
        binding = {
            "schema": "fe2o3.xgmi-settled-native-development.v1",
            "commit": commit,
            ...
            "bytes": 1048576,
            "depths": [1],
            "settled_delay_seconds": 2,
            "delayed_delay_seconds": 20,
            "delayed_anchor": "settled-endpoints-complete",
            "warmups": 10,
            "samples": 30,
