#!/usr/bin/env python3
"""Bounded local controller for one exact root-approved single-SDMA directory."""
...
BUNDLE = Path(
    "/home/harsh/.codex-tmp/fe2o3-single-sdma-native-bundle-20260918"
)
OWNED = "/tmp/fe2o3-single-sdma-20260918.yxqxau8y"
PAYLOAD = "a14984f90e5ddecab7de82dd8e1db1d029109c75683d7106e527b0ac0af4388f"
SSH_OPTIONS = [
    "-o",
    "BatchMode=yes",
    "-o",
...
def main():
    ...
    try:
        ...
        launched = remote(recorder, "native-outer", "launch", 1300)
