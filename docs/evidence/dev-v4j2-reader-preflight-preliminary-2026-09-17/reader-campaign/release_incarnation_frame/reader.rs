...
#[path = "context_version_journal_issuance_v1.rs"]
mod issuance;
use issuance::*;
use vstd::prelude::*;
...
{
    acquire_preflight_exec_v1(contents, consumer, requests, output.as_slice())
}
...
{
    let result = release_preflight_exec_v1(contents, consumer, references, evidence_consumer, observed_free_capacity);
