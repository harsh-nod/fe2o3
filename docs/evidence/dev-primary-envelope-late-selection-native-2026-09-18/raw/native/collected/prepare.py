...
CPU = Path("docs/evidence/dev-primary-envelope-late-selection-cpu-2026-09-18")
SELECTED = {
    ...
    "crates/fe2o3-runtime/src/kfd_backend/retained_release_tests/primary_envelope.rs": "source/primary_envelope.rs",
