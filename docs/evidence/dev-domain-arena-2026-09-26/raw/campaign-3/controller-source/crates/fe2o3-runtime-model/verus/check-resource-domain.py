...
UNITS = (('planner', ROOT, 19), ('arena', ARENA_ROOT, 20))
...
MANIFEST_SHA = '165e0deaae1dde029eac688866d3fa0e2a0dd9aa24b3b1b07c29f2aaa6b84db8'
...
def classify(code, log, negative=False, obligations=19):
    need(obligations in (19, 20), 'reviewed proof unit')
...
def main():
    ...
    print('R75_SHARED_DOMAIN_PLANNER_OK planner=19 arena=20 positives=2 mutations=31')
