...
const q = JSON.parse(pin('r122-development-qualification-plan-v1.json',
...
const collector = 'r122-development-qualification-collect-v1.js';
pin(collector, '3490290bd4d9e61f5ae0e7635a65496e059bd4438cae7d4f69d825caf67b982b');
bytes(__filename);
...
assert.strictEqual(report.helper_calibrations, 81);
...
const summary = {
  ...
  compiled_negatives: 12, distinct_mutations: 12, helper_calibration_tests: 81,
...
const readme = [
  ...
  'All seventeen source gates, ten auxiliary checks, restored 35/10 KFD/runtime suites and 81 checker-calibration cases pass.',
