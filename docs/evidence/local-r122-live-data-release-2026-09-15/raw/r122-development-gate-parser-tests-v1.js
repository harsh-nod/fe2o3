...
const helper = '/home/harsh/.codex-tmp/r122-development-gate-check-v1.js';
const helperHash = 'f6c9a9ccbb1e2a1697c3da59ca4a53c122b459431d450220dd764fc0a90d3882';
...
const correctedLinux = replaceOne(currentLinux, '0 measured; 1152 filtered out;', '0 measured; 1170 filtered out;');
...
const observedLockLog = accepted(locks), waitLine = '    Blocking waiting for file lock on package cache\n';
const lockLog = observedLockLog.split(waitLine).join('');
