...
const q = JSON.parse(initialPin('r122-development-qualification-plan-v2.json',
...
console.log(JSON.stringify({development_only: true, publication_pending: true, scope: q.scope,
  ...
  helper_calibrations: 89, restored_suites: [35, 10], runs, mutations, raw_artifacts: raw,
