...
const evidence = 'docs/evidence/local-r100-auxiliary-create-outcomes-2026-09-11';
...
assert.strictEqual(git(['rev-parse', 'HEAD']).toString().trim(),
  'e6ac41c7fe61fbbb3e9a7003a8e9fd9a8a0c97a4');
const hash = bytes => crypto.createHash('sha256').update(bytes).digest('hex');
const baseline = JSON.parse(fs.readFileSync(path.join(root, 'raw/r100-frozen-source.json')));
