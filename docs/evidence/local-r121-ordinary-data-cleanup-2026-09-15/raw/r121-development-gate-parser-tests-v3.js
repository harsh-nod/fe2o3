...
const helper = '/home/harsh/.codex-tmp/r121-development-gate-check-v3.js';
const source = fs.readFileSync(helper, 'utf8');
assert.strictEqual(crypto.createHash('sha256').update(source).digest('hex'), 'e0652f1c76bfff0afef5401616670e786bcb73841dc4ab6af44272e55f630762');
