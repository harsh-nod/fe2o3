...
const q = JSON.parse(pin('r121-development-qualification-inputs-v2.json',
  '13a11676fe2ca6d2bf7ac8bf12ec848dcc6b5aa80be78df7c140268c86ff06a1'));
...
assert.strictEqual(report.helper_calibrations, 20);
...
const summary = {
  ...
  rejected_attempts: ['r121-development-gnu-all-v1', 'r121-development-musl-all-v1'],
...
const readme = [
  ...
  'All seventeen source gates, ten auxiliary checks, restored 59/17 cleanup suites and twenty transcript-parser calibrations pass.',
