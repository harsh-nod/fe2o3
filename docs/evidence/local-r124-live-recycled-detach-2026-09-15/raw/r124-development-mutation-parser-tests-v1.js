...
const helper = root + 'r124-development-mutation-check-v1.js';
const helperHash = '0d72aad2e3d8bed06cd6e954c0cbe2c7f13c1704d624dd702e059fa7c2a190cc';
...
assert.strictEqual(cases.filter(test => test.expected === 'accept').length, 39);
assert.strictEqual(cases.filter(test => test.expected === 'reject').length, 61);
