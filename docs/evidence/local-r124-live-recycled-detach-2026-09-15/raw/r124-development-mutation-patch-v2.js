...
const helper = '/home/harsh/.codex-tmp/r124-development-mutation-check-v2.js';
assert.strictEqual(crypto.createHash('sha256').update(fs.readFileSync(helper)).digest('hex'),
  '7a943a91d7e81869f91bae66e7dc90b513c9afbf8ff460caa149f794d44ac6eb');
const M = require(helper), C = M.C;
C.pin(helper, '7a943a91d7e81869f91bae66e7dc90b513c9afbf8ff460caa149f794d44ac6eb');
C.bytes(__filename);
