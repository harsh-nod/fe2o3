...
(async () => {
  ...
  assert(!['r124-development-gnu-all-v1', 'r124-development-musl-all-v1'].includes(name), 'preserve prior runs');
  let previous = null;
  if (previousName !== '-') {
  ...
  const declaredFullCommand = name === 'r124-development-musl-all-v2' ? [...fullCommand, '--target', 'x86_64-unknown-linux-musl']
    : null;
