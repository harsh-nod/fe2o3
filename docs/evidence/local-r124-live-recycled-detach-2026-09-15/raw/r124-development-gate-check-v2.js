// Local R124 gate validation only. Mutation, native and formal acceptance remain separate.
const fs = require('fs'), path = require('path'), assert = require('assert'), crypto = require('crypto');
const root = '/home/harsh/.codex-tmp', checker = path.join(root, 'r124-development-check-v2.js');
