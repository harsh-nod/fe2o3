...
const checker = root + 'r124-development-check-v1.js';
...
const p = JSON.parse(C.pin('r124-development-mutations-v1.json', '02d94b392d6b62eee40152fa5391db2ccb0a10d111db4e6c05625605280bee48'));
...
function negative(mutation) {
  ...
  const {record, log} = C.completed(name, [...p.test_command, mutation.test, '--', '--exact'],
    'r124-development-gnu-all-v1.json', changed, 101);
