#!/usr/bin/env python3
"""Bounded, owned-directory KFD full-currentness host attribution."""
...
PREFIX = "/home/harsh/fe2o3-xgmi-currentness-attribution-20260920."
PAYLOAD = (
    "native.py",
    "results.py",
    "hot.py",
...
def trial_specs(owned):
    ...
    for ordinal, mode in enumerate(PLAN["order"], 1):
        flag = (
            "--aggregate-peer-batch-hot-currentness-diagnose"
            if mode == "on"
