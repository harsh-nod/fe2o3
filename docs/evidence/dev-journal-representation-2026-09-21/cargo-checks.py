#!/usr/bin/env python3
"""Record production journal declaration and comparison regressions."""
import argparse
import hashlib
...
def main():
    ...
    spec = importlib.util.spec_from_file_location('enrollment_cargo_recorder', path)
    ...
    files = [repo / 'Cargo.toml', repo / 'Cargo.lock', Path(__file__).resolve(), path,
             ...
             repo / 'crates/fe2o3-runtime-model/verus/context_journal_representation_v1.rs']
