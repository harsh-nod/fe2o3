...
const helper = '/home/harsh/.codex-tmp/r125-development-gate-check-v2.js';
const helperHash = 'ca743ebf03fee6732c1aa486d39ca426f1103df42c2b88349d00c704949725d4';
...
const correctedLinux = replaceOne(currentLinux, '0 measured; 1206 filtered out;', '0 measured; 1223 filtered out;');
...
for (const relocation of gates.doc_relocations) {
  ...
  assert(name, 'declared R125 doctest');
...
assert.strictEqual(cases.length, 49);
