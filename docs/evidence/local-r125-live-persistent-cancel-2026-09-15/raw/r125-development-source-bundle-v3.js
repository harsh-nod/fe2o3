...
const root = '/home/harsh/.codex-tmp/', helper = root + 'r125-development-check-v3.js';
...
const output = root + 'r125-development-source-bundle-v3.json', encoded = JSON.stringify(bundle, null, 2) + '\n';
