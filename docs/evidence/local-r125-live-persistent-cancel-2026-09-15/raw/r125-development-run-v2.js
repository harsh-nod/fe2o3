// R125 revised test cohort; preserve runner-v1 and its interrupted GNU attempt.
...
(async () => {
  ...
  const declaredFullCommand = name === 'r125-development-gnu-all-v2' ? fullCommand
    : name === 'r125-development-musl-all-v2' ? [...fullCommand, '--target', 'x86_64-unknown-linux-musl']
    : null;
  if (declaredFullCommand) {
    ...
    assert.strictEqual(hash(JSON.stringify(before)),
      '902a842fa783f96fcb96e44e03a9be07aea7302bc6ccd02949abaa1416f50833', 'declared full-test source');
