...
const checker = root + 'r125-development-check-v1.js';
...
const p = JSON.parse(C.pin('r125-development-mutations-v1.json', '72c7a34c7352b276d066bbde30f2ffbb2eb4610bbcca011643bf2d459bcbaff1'));
