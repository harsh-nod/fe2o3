...
const p = JSON.parse(pin('r125-development-full-plan-v4.json', '48bb8ccdd866e8bc9926e64cbb1e742092774eda8774741564ba8d75c7d097bf'));
...
pin('r125-development-evidence-v3.js', '515d128606f0aae8fa019e48eea6cf370c3982c1628a8706a66c28fee2a92e6b');
const E = require('./r125-development-evidence-v3.js');
...
function assertFull(log, oldLog) {
  ...
  for (const [kind, count] of [['kfd', 18], ['runtime', 1]]) {
