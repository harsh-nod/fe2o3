// R125 boxed-ledger repair cohort; preserve interrupted v1 and failed v2 evidence.
...
(async () => {
  ...
  const declaredFullCommand = name === 'r125-development-gnu-all-v3' ? fullCommand
    : name === 'r125-development-musl-all-v3' ? [...fullCommand, '--target', 'x86_64-unknown-linux-musl']
    : null;
  if (declaredFullCommand) {
    ...
    assert.strictEqual(hash(JSON.stringify(before)),
      '6486eaa2d52d9a4035db5d137fa216dcef9f853f8df6518c0aa47905534be72e', 'declared full-test source');
