...
const p = JSON.parse(pin('r125-development-full-plan-v2.json', '7b4216028de5e3b004130b14870a0fe8765f205c927cac1b98616ca636db2454'));
...
pin('r125-development-evidence-v1.js', '048e891fdeae77fc15b1911daa2c9c3ead26620f980e670339118ed0826f3d45');
const E = require('./r125-development-evidence-v1.js');
...
function assertFull(log, oldLog) {
  ...
  for (const [kind, count] of [['kfd', 15], ['runtime', 0]]) {
