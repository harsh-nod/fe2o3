// R125 successor of immutable R124 runner-v3; new namespace, parent and source cohort.
...
(async () => {
  ...
  const declaredFullCommand = name === 'r125-development-gnu-all-v1' ? fullCommand
    : name === 'r125-development-musl-all-v1' ? [...fullCommand, '--target', 'x86_64-unknown-linux-musl']
    : null;
  if (declaredFullCommand) {
    ...
    assert.strictEqual(hash(JSON.stringify(before)),
      '121d2ee48ac902b27234b8e584af7007528f22480e21e805a9cf3b8e6a9b9b1d', 'declared full-test source');
