...
const root = '/home/harsh/.codex-tmp/', helper = root + 'r125-development-check-v1.js';
const helperHash = 'e37aab2693167424232e925bec843e3a187fcf7192add1f78244cf52ecbd8981';
...
const output = root + 'r125-development-source-bundle-v1.json', encoded = JSON.stringify(bundle, null, 2) + '\n';
