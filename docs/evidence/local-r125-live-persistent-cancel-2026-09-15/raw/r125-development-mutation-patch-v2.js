// Emit an apply_patch payload only; the primary owns each edit and restoration.
const fs = require('fs'), assert = require('assert'), crypto = require('crypto');
const helper = '/home/harsh/.codex-tmp/r125-development-mutation-check-v3.js';
const helperHash = 'd6cf905321ad87c86f583ccc77dcc9c8df168d30a6784ad16e36ed5fd2ae9793';
...
function scope(text) {
  ...
  assert.strictEqual(text.split(end).length, 2);
