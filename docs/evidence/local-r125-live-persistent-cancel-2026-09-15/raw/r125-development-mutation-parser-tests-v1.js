...
const helper = root + 'r125-development-mutation-check-v1.js';
const helperHash = 'a33a3681f2d24f890eb70179edf71aea22d71df7bbf7f4b3ccae79f0d1c8f04e';
...
assert.strictEqual(cases.length, 97);
assert.strictEqual(cases.filter(test => test.expected === 'accept').length, 37);
assert.strictEqual(cases.filter(test => test.expected === 'reject').length, 60);
