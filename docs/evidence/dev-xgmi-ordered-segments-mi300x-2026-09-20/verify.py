...
ROOT = HERE.parents[2]
SOURCE = "b7fd95cfb007fb8406649849459fa1de8cbc2088"
EXECUTION_ROOT = "/home/harsh/.codex-tmp/fe2o3-c4-completion-20260917"
LOCAL_OUTPUT = "/home/harsh/.codex-tmp/fe2o3-xgmi-segments-results-z0nhw803"
...
def verify(folder=HERE, sealed=True):
    expected = {"README.md", "verify.py", "test_verify.py", "local", "remote", "binding.json", "owner.json", "collection.json", "remote-inventory.json"}
