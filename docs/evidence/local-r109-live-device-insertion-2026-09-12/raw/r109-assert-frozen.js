...
const expected = JSON.parse(fs.readFileSync('/home/harsh/.codex-tmp/r109-frozen-source.json'));
...
if (process.argv[2]) {
  ...
  fs.writeFileSync('/home/harsh/.codex-tmp/r109-restoration-' + name + '.json',
