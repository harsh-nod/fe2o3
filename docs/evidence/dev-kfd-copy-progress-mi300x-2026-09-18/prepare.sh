...
git -C "$owned/source" fetch --no-tags https://github.com/harsh-nod/fe2o3.git 3e12ef82bbb41fb116afbb7ddf7cffdad735ec7d
...
git -C "$owned/source" checkout --detach 3e12ef82bbb41fb116afbb7ddf7cffdad735ec7d
cd "$owned/source"
