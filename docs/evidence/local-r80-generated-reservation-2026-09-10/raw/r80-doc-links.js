// Check local references in the R80 contract, evidence and current roadmap.
const fs = require('fs');
const path = require('path');
const repo = '/home/harsh/.codex-tmp/fe2o3-r61-execution';
const files = [
  'docs/runtime-generated-reservation-v1.md',
  ...
  'docs/evidence/local-r80-generated-reservation-2026-09-10/README.md',
];
let count = 0;
...
console.log('PASS: ' + count + ' local Markdown links/anchors');
