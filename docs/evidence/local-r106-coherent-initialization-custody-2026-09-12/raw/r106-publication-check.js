...
const evidence = 'docs/evidence/local-r106-coherent-initialization-custody-2026-09-12';
...
assert.strictEqual(git(['rev-parse', 'HEAD']).toString().trim(),
  '42d614d352f39fb13b4026b6d2c2b9af94a41200');
const hash = bytes => crypto.createHash('sha256').update(bytes).digest('hex');
const baseline = JSON.parse(fs.readFileSync(path.join(root, 'raw/r106-frozen-source.json')));
...
const docs = ['docs/runtime-a1-a2-swarm-current.md', 'docs/runtime-a1-a2-next-wave.md',
  'docs/runtime-borrowed-coherent-initialization-v1.md',
  'docs/runtime-session-transition-custody-v1.md', evidence + '/README.md'];
let links = 0;
