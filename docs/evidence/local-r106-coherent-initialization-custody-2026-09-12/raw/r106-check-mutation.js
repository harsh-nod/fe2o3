...
const mutation = read('r106-mutations.json').find(m => m.name === name);
assert(mutation, 'known mutation');
const run = read('r106-' + prefix + 'mut-' + name + '.json');
...
assert.strictEqual(run.source_head, '42d614d352f39fb13b4026b6d2c2b9af94a41200');
...
const inputs = read('r106-' + prefix + 'mut-' + name + '-source.json');
