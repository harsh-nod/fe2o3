...
const evidence = 'docs/evidence/local-r102-auxiliary-roster-slots-2026-09-12';
...
assert.strictEqual(git(['rev-parse', 'HEAD']).toString().trim(),
  '77ce1196f2867e79eb450b5a9ba5924ed13152fa');
const hash = bytes => crypto.createHash('sha256').update(bytes).digest('hex');
const baseline = JSON.parse(fs.readFileSync(path.join(root, 'raw/r102-frozen-source.json')));
