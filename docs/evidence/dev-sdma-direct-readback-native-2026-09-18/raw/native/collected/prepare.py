...
CPU = Path("docs/evidence/dev-sdma-direct-readback-cpu-2026-09-18")
SELECTED = {
    ...
    "crates/fe2o3-runtime/src/kfd_backend/retained_release_tests/cold_allocation.rs": "source/cold_allocation.rs",
    "crates/fe2o3-runtime/src/kfd_backend/sdma_host_read.rs": "source/sdma_host_read.rs",
    "crates/fe2o3-runtime/src/kfd_backend/kfd_backend_sdma_seam.rs": "source/kfd_backend_sdma_seam.rs",
    "crates/fe2o3-kfd/src/queue_live.rs": "source/queue_live.rs",
    "crates/fe2o3-runtime/src/kfd_backend/retained_release_tests.rs": "source/retained_release_tests.rs",
    "crates/fe2o3-runtime/src/kfd_backend/compute_dispatch.rs": "source/compute_dispatch.rs",
...
def main():
    ...
    before = cpu / "raw/source-before-final.log"
    after = cpu / "raw/source-after-final.log"
    P.need(P.sha(before) == P.sha(after) == P.COHORT_SHA, "unchanged final source maps")
    cohort = P.load(before)["files"]
    P.need(len(cohort) == 5553, "final source cohort size")
    ...
    shutil.copyfile(binary, output / "runtime-tests")
    (output / "runtime-tests").chmod(0o700)
