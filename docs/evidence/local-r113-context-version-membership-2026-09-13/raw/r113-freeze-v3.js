...
const environment = {
  ...
  runners: ['r113-run.js', 'r113-run-v2.js', 'r113-run-v3.js', 'r113-source-gate.py', 'r113-auxiliary-gates.py',
    'r113-freeze.js', 'r113-freeze-v2.js', 'r113-freeze-v3.js',
    'r113-runner-tests.js', 'r113-runner-tests-v2.js', 'r113-freeze-tests.js', 'r113-freeze-tests-v2.js']
