...
const environment = {
  ...
  runners: ['r113-run.js', 'r113-source-gate.py', 'r113-auxiliary-gates.py', 'r113-freeze.js']
...
assert.deepStrictEqual(Object.fromEntries(paths.map(p => [p, hash(fs.readFileSync(path.join(repo, p)))])), frozen);
