...
function fixture(name, mutate, rejects, openingHead = parent, prerequisite = value => value) {
  ...
  for (const [index, [run, command, previous]] of [p.rebootAnchor, ...p.prerequisites].entries()) {
...
fixture('prerequisite-artifact-substitution', ({artifacts}) => artifacts.set('r115-refreshed-gnu-all.log', 'substituted'), true);
