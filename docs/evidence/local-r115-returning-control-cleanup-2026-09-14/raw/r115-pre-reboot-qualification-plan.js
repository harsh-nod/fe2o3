...
module.exports = {
  ...
  prerequisites: [
    ['r115-preliminary-gnu-all', fullTest, 'r115-preliminary-clippy.json'],
    ['r115-preliminary-musl-all', [...fullTest, '--target', 'x86_64-unknown-linux-musl'], 'r115-preliminary-gnu-all.json'],
  ],
  ...
  freezeContractCount: 30, qualificationContractCount: 80,
