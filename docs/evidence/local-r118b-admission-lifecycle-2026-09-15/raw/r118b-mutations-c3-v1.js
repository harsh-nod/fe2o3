...
add('omit-reject-completion-stop', 'S', 205, [patch(G,
...
add('omit-drop-completion-stop', 'D', 243, [patch(G, dropStop, dropStop)]);
add('dispose-before-stop-observations-close', 'S', 182, [patch(O,
  '                panicked = true;\n            }\n        }\n        panicked\n',
  '        panicked\n', '        self.dispose_quiescent();\n        panicked\n')]);
add('retain-old-waker', 'S', 196, [patch(W,
...
add('calibrate-wrong-callback-thread', 'O', 458, [patch(H,
...
add('calibrate-lost-disposal-identity', 'R', 339, [patch(H,
