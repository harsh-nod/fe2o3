// Begin-write execution candidate. Logical contents, not native or physical storage refinement.
    ...
    ensures result == begin_destination_decision_v1(*journal, destination),
{
    ...
    if entry.pending_member.is_some() { return Err(ReadErrorV1::EpochExhausted); }
