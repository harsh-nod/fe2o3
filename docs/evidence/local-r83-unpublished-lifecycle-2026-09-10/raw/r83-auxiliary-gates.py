"""Retain unpublished-lifecycle focused checks, proof inventory and production dependency audit."""
import os
...
commands = [
    ('r83-proof-inventory.log', ['python3', '-I', 'crates/fe2o3-runtime-model/verus/check-negative-quality.py',
        'crates/fe2o3-runtime-model/verus/negative', 'crates/fe2o3-runtime-model/verus/verify-verus.sh']),
    ('r83-production-metadata.json', ['cargo', '+nightly-2026-04-03', 'metadata', '--locked', '--offline',
        '--no-default-features', '--format-version', '1', '--filter-platform', 'x86_64-unknown-linux-musl']),
    ('r83-production-audit.log', ['python3', '-B', 'scripts/runtime_pure_rust_audit.py', 'metadata',
        '--input', str(root / 'r83-production-metadata.json'), '--root', 'fe2o3-runtime']),
    ('r83-focused-adoption.log', ['cargo', '+nightly-2026-04-03', 'test', '--locked', '--offline', '-p',
        'fe2o3-runtime', '--all-features', '--lib', 'adoption_tests']),
    ('r83-focused-async.log', ['cargo', '+nightly-2026-04-03', 'test', '--locked', '--offline', '-p',
        'fe2o3-runtime', '--all-features', '--lib', 'async_engine::']),
    ('r83-doc-links.log', ['node', str(root / 'r83-doc-links.js')]),
]
