...
record commit-self-test python3 -I "$proof/check-read-commit.py" --self-test "$proof/context_read_commit_v1.rs"
record commit-campaign prlimit --core=0:0 -- python3 -I "$proof/check-read-commit.py" "$proof/context_read_commit_v1.rs" "$verus" 120 "$archive/commit-campaign"
