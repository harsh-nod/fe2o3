#!/usr/bin/env python3
"""Record scoped CPU qualification and observational dependency profiles."""
...
spec = importlib.util.spec_from_file_location(
    "dependencies_prior_cpu_commands", ROOT / (PRIOR + "qualify.py")
)
Q = importlib.util.module_from_spec(spec)
spec.loader.exec_module(Q)
# Retain every inherited runtime filter while focusing KFD on lower batch waits.
