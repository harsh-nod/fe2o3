...
PRIOR = ROOT / "docs/evidence/dev-combined-sdma-release-cpu-2026-09-18"
...
RECEIPTS = {"source-before", "rustc", "cargo", "gnu-example", "musl-example", "clippy", "musl-build", "binary", "binary-kind", "fmt", "diff", "source-after", "source-unchanged", "calibration"}
NAMES = {
    "combined_oracle_accepts_sparse_disjoint_ids_and_exact_capacity",
    "combined_oracle_rejects_every_owner_field_and_capacity_mutation",
    "combined_sdma_accepts_every_admitted_count_and_explicit_device",
    "combined_sdma_rejects_unsupported_or_ambiguous_arguments",
...
def qualify(live=False):
    ...
    need(inventory["base"] == "442aa6c839b909d0af1911746d8a7e9a290859e3" and len(inventory["files"]) == 5557, "source base and count")
    need(sha(PRIOR / "SHA256SUMS") == "c059a10776815aa3468eb2105d73a771972f6eb440e0102e6a4a8248d62d7e48", "prior retained-release CPU seal")
    ...
    return {"example_tests_per_target": 15, "targets": ["gnu", "musl"], "source_files": len(current), "binary_sha256": match[1], "native_execution": False, "formal_refinement": False}
