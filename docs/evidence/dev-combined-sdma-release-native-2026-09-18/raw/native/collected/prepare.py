...
CPU = Path("docs/evidence/dev-combined-sdma-example-cpu-2026-09-18")
SELECTED = {
    ...
    "crates/fe2o3-kfd/src/queue_live/construction_primary/integration_release_combined_sdma_tests.rs": "source/integration_release_combined_sdma_tests.rs",
