...
import {finalSource,readBounded} from './source-files.mjs';
...
function valid(s){
 ...
 assert(s.header.includes('sizeof (native_adapter) + 4096 + 1024 + limits::client_output_bytes + 256'));
}
...
test('all other native behavior including unselected path is byte-identical',()=>{
