...
mod controller;
mod physical_snapshot_v2;
mod rocgdb_mi_parser_v3;
mod syntax;
mod target_report;
mod transitions;
pub use controller::observe;
pub use physical_snapshot_v2::{PhysicalSnapshotV2, SnapshotContextV2, UnavailableV2};
...
pub trait Peer {
    ...
    /// Read the already entry-verified owned inferior stamp, not caller data.
    /// This observational selector grants no PID/process authority.
...
pub struct ProtocolObservation {
    ...
    pub physical_snapshot: PhysicalSnapshotV2,
    pub later_target_4096_output_validation_observed: bool,
    pub post_completion_raw_bytes_recaptured: bool,
