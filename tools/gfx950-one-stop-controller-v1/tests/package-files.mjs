...
const fail=s=>{throw Error('one-stop source package: '+s);};
...
function requireManifest(value){
 ...
 if(value.schema!=='fe2o3-gfx950-one-stop-controller-source-v1'
  ||value.license!=='MIT OR Apache-2.0'||value.runtime_profile!=='unbound'||value.rust_files!==18
...
export function verifyPayload(value,read){
 ...
 return {schema:'fe2o3-gfx950-one-stop-controller-source-check-v1',files:value.files.length,bytes:total,
