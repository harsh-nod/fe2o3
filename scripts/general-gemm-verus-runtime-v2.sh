...
usage() {
    cat >&2 <<'EOF'
usage:
  general-gemm-verus-runtime-v2.sh audit-source VERUS_DIST RUST_TOOLCHAIN RUSTUP
  general-gemm-verus-runtime-v2.sh provision VERUS_DIST RUST_TOOLCHAIN RUSTUP DESTINATION
  general-gemm-verus-runtime-v2.sh audit-installed RUNTIME_ROOT
