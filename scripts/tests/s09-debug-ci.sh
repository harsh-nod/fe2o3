...
rg -q "trap 's09_delete_raw_transcript' EXIT" "${RAW_GUARD}"
rg -q "trap 's09_delete_raw_transcript; exit 129' HUP" "${RAW_GUARD}"
rg -q "trap 's09_delete_raw_transcript; exit 130' INT" "${RAW_GUARD}"
rg -q "trap 's09_delete_raw_transcript; exit 143' TERM" "${RAW_GUARD}"
