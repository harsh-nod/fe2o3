...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs,crates/fe2o3-hsaco-finalize/src/first_build_worker_v2.rs,crates/fe2o3-hsaco-finalize/src/worker_executor.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_link_publication.rs,crates/cargo-fe2o3/src/worker_v2_restart.rs,crates/cargo-fe2o3/tests/worker_v2_vertical_slice.rs,tools/fe2o3-llvm-link-worker/src/WorkerPipeline.cpp,tools/fe2o3-llvm-link-worker/tests/PipelineTests.cpp,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p fe2o3-hsaco-finalize --locked@@cargo test -p fe2o3-artifact-transaction --locked@@cargo test -p cargo-fe2o3 --test worker_v2_vertical_slice --locked@@cargo test -p cargo-fe2o3 --test worker_v2_vertical_slice --features worker-v2-fault-injection-test-only --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_general_v3_alpha_zeta_build_links_and_validate_backend_witnesses -- --ignored --exact@@scripts/tests/run-parity-snapshot.sh	daf0b459ced07a25376670c83b1474eaebcd1a68	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	Direct LLVM and LLD Worker V2 linking now publishes the genuine alpha/zeta COV6 payload through the durable currentness-capable publication path. Worker fe2o3-worker-v1-sha256-234d22f9fb347c86495e7156e53ef8eab55e939d6514973a6df373aee12f77a9 produced digest 3a916cdabca05ac74d340889aab2067221d6d1252a7cde13e61c1786252565c4 with 296/312-byte metadata. The cargo artifact-container adapter remains test-only, and no production prerequisite authenticator promotes proof/effect evidence.
evidence	multi-kernel	crates/cargo-fe2o3/src/worker_v2_artifact_container.rs,crates/fe2o3-artifacts/src/gfx942_bundle.rs,crates/fe2o3-verifier/src/multi_kernel_proof.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs,crates/fe2o3-host/src/worker_v2_bundle_admission.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs,crates/fe2o3-host/src/generated_alpha_zeta_cov6.rs,crates/fe2o3-hsa-runtime/src/lifecycle.rs,crates/fe2o3-hsa-runtime/src/dispatch.rs,crates/fe2o3-hsa-runtime/tests/gfx942_two_kernel_hardware.rs	cargo test --locked -p cargo-fe2o3 worker_v2_artifact_container::tests@@cargo test -p fe2o3-artifacts --locked@@cargo test -p fe2o3-verifier --locked@@cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-hsa-runtime --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_general_v3_alpha_zeta_build_links_and_validate_backend_witnesses -- --ignored --exact@@cargo test -p fe2o3-hsa-runtime --features hardware-test-hooks --test gfx942_two_kernel_hardware gfx942_cov6_alpha_then_zeta_one_executable -- --ignored --exact	daf0b459ced07a25376670c83b1474eaebcd1a68	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	Production durable publication, finalized-bundle admission, currentness lease, authenticated load state machine, generated alpha/zeta safe dispatch SPI, and reviewed HSA adapters exist. The digest-pinned raw unsafe harness passed both kernels on MI300X at lengths 1/255/256/257/1023, but the run is not an archived dashboard hardware strength and did not use generated safe dispatch. The production prerequisite authenticator is absent, and the cargo two-entry container adapter remains test-only/inert.
...
evidence	single-source	crates/cargo-fe2o3/src/binding_wrapper.rs,crates/cargo-fe2o3/src/worker_v2.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/rustc-codegen-fe2o3/src/rust_type_layout_v3.rs,crates/rustc-codegen-fe2o3/src/semantic_witness.rs,crates/rustc-codegen-fe2o3/src/host_object.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-host/src/worker_v2_bundle_admission.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs,crates/fe2o3-host/src/generated_alpha_zeta_cov6.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p fe2o3-macros --locked@@cargo test -p fe2o3-host --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_general_v3_alpha_zeta_build_links_and_validate_backend_witnesses -- --ignored --exact	daf0b459ced07a25376670c83b1474eaebcd1a68	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	One genuine Rust alpha/zeta source fixture lowers through typed IR, emits identity-bound semantic witnesses, links directly with Worker V2, and durably publishes a COV6 payload with exact 296/312-byte metadata. Production publication, host admission/currentness, authenticated HSA lifecycle, and generated safe dispatch SPI exist. Parity remains Partial because no production WorkerV2PrerequisiteAuthenticatorV1 promotes compiler/Verus/proof/effect evidence, the cargo container adapter is test-only, and generated safe dispatch lacks an end-to-end hardware run.
...
evidence	codegen	crates/rustc-codegen-fe2o3/src/amdgpu_llvm.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_codegen.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_general_v3_alpha_zeta_build_links_and_validate_backend_witnesses -- --ignored --exact@@FE2O3_TARGET=gfx1151 scripts/ci-local.sh rocm-compile@@FE2O3_TARGET=gfx942 scripts/ci-local.sh rocm-compile	daf0b459ced07a25376670c83b1474eaebcd1a68	generic,gfx1151,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial,compile-code-object	AMDGPU lowering now carries the bounded genuine alpha/zeta Rust slice through direct Worker V2 COV6 emission with exact 296/312-byte metadata. A separately observed raw unsafe MI300X run passed the five boundary lengths, but it is not an archived dashboard hardware strength. Broad MIR/kernel IR coverage, production prerequisite authentication, generated-safe-path hardware execution, other targets, and machine-code refinement remain incomplete.
