...
evidence	s09-source-debug	crates/fe2o3-process-identity/src/lib.rs,crates/fe2o3-hsa-runtime/tests/s09_gfx942_alpha_hardware.rs,scripts/s09-debug-check.py,scripts/s09-debug-ci.sh,scripts/s09-debug-finalize.sh,scripts/s09-raw-transcript-guard.sh,scripts/s09-rocgdb-profile.sh,scripts/s09-source-state.py,scripts/s09_pinned_snapshot.py,scripts/tests/s09-debug-policy.py,scripts/tests/s09-debug.sh,scripts/tests/s09-debug-ci.sh,scripts/tests/s09-pinned-snapshot.py,scripts/tests/s09-raw-transcript-guard.py,scripts/tests/s09-source-state.py	cargo test -p fe2o3-hsa-runtime --features hardware-test-hooks --test s09_gfx942_alpha_hardware --locked@@scripts/tests/s09-pinned-snapshot.py@@scripts/tests/s09-raw-transcript-guard.py@@scripts/tests/s09-source-state.py@@scripts/tests/s09-debug.sh@@scripts/tests/s09-debug-ci.sh@@scripts/ci-local.sh s09-debug-hardware	5bb8b4caab4d6d386d03bc69ae190bf59bb7115f	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	The retained S09 harness validates pinned source state, process identity, transcript handling, and its bounded hardware fixture. Its retired backend source-debug producer is not part of the current generic compiler pipeline, so no current compiler debug-emission claim is made.
...
evidence	single-source	crates/cargo-fe2o3/src/binding_wrapper.rs,crates/rustc-codegen-fe2o3/src/production_pipeline.rs,crates/rustc-codegen-fe2o3/src/production_semantic_lineage_v3.rs,crates/rustc-codegen-fe2o3/src/production_ranked_projection_v1.rs,crates/rustc-codegen-fe2o3/src/production_worker_handoff.rs,crates/rustc-codegen-fe2o3/src/semantic_layout_bridge.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v3_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_published_claim.rs,crates/fe2o3-host/src/production_application.rs,crates/fe2o3-host/src/worker_v3_verification_admission.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs,crates/rustc-codegen-fe2o3/tests/production_pipeline.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --test production_pipeline --locked@@cargo test -p fe2o3-macros --locked@@cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-hsaco-finalize --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	The production source path binds rustc semantic lineage, ranked PLIRON projection, the Worker V3 handoff, durable HSACO publication, and host admission. No retired Worker V2 publication fallback remains; compiler refinement and hardware execution remain incomplete.
...
evidence	gfx942-collectives-v1	crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/src/sync.rs,crates/rustc-codegen-fe2o3/src/production_semantic_body_v1.rs,crates/rustc-codegen-fe2o3/tests/production_workgroup_sync_driver_v1.rs,crates/fe2o3-amdgcn-model/src/lowering.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --test production_workgroup_sync_driver_v1 --locked@@cargo test -p dialect-amdgcn --locked	234129b911516ee7f62dadf03abea42e70212fdb	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	The current production semantic body admits the bounded collective and workgroup synchronization fragment with a dedicated generic driver. Broader operations, numerical hardware execution, and compiler refinement remain incomplete.
evidence	gfx942-wave-lds-v2	crates/fe2o3-amd-target/src/lib.rs,crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/tests/ui,crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/tests/wire.rs,crates/rustc-codegen-fe2o3/src/production_semantic_body_v1.rs,crates/rustc-codegen-fe2o3/tests/production_workgroup_sync_driver_v1.rs,crates/dialect-amdgcn/tests/gfx942_wave_lds_v1.rs,crates/dialect-amdgcn/tests/fixtures/gfx942_wave_lds_v1_runner.cpp,examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs,examples/verus_vecadd/verus/negative/gfx942_wave_wrong_extent.rs,examples/verus_vecadd/verus/negative/gfx942_lds_missing_barrier_lane.rs,docs/gfx942-wave-lds-v2.md	cargo test -p fe2o3-device --all-targets --locked@@cargo test -p fe2o3-amd-target --all-targets --locked@@cargo test -p fe2o3-kernel-ir --all-targets --locked@@cargo test -p rustc-codegen-fe2o3 --test production_workgroup_sync_driver_v1 --locked@@cargo test -p dialect-amdgcn --all-targets --locked@@cargo test -p dialect-amdgcn --test gfx942_wave_lds_v1 gfx942_xnack_minus_hardware_executes_masked_wave_and_lds_reductions -- --ignored --exact --nocapture@@verus --crate-type lib --triggers-mode silent examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs	c17e847c2017369c1e52d3dfb847001765273cdc	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,verus-0.2026.08.02.b677dd5	source-unit,negative-adversarial,verus-proof	Wave and LDS source, IR, target-model, Verus, and current production synchronization-driver evidence cover the bounded gfx942 fragment. The retired Worker V2 producer and exact compiler fixture are absent; general lowering and archived hardware strength remain incomplete.
