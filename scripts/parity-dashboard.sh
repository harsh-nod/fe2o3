...
evidence	device-ffi	crates/fe2o3-device/src/ffi.rs,crates/rustc-codegen-fe2o3/src/device_ffi.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs,crates/cargo-fe2o3/src/binding_wrapper.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --locked@@scripts/test-direct-llvm-worker.sh	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03,llvm-api-mechanics	source-unit,negative-adversarial	Bounded import/export evidence now reaches a consumed compiler handoff and measured Worker V2 in one gfx942 source fixture; general bidirectional compiler/provider linking, safe wrappers, device-library packaging, authenticated publication, and hardware calls remain absent.
...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs,crates/fe2o3-hsaco-finalize/src/first_build_worker_v2.rs,crates/fe2o3-hsaco-finalize/src/worker_executor.rs,tools/fe2o3-llvm-link-worker/src/WorkerPipeline.cpp	cargo test -p fe2o3-hsaco-finalize --locked@@scripts/test-direct-llvm-worker.sh	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03,llvm-api-mechanics	source-unit,negative-adversarial	The measured, supervised direct LLVM/LLD worker consumes textual compiler modules and requires byte-identical GenericLink/V2 gfx942 output; authenticated HSACO inspection, publication, loading, launch, and general provider closure remain absent.
...
evidence	single-source	crates/cargo-fe2o3/src/binding_wrapper.rs,crates/cargo-fe2o3/src/worker_v2.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	One bounded real Rust source module reaches verified textual AMDGPU IR and measured byte-identical native-link evidence through Cargo; publication, loading, launch, proof-required builds, general signatures, and external-project workflows remain incomplete.
