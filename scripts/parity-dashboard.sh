...
evidence	gfx942-device-library-v1	tools/fe2o3-llvm-link-worker/tests/PipelineTests.cpp,crates/fe2o3-host/src/gfx942_ocml.rs,crates/fe2o3-host/tests/gfx942_ocml_hardware.rs	cargo test -p fe2o3-host --lib --locked@@cargo test -p fe2o3-host --test gfx942_ocml_hardware --locked	97b6ce142fce836055521ca27a04478e59fe5f18	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	Direct in-process LLVM and LLD linking resolves one exact gfx942 xnack-minus OCML sin symbol, and stream-bound host admission checks the reviewed HSACO identity. This proves only the device-library FFI mechanism and one unary operation, not FFT, BLAS, general MathDx functionality, artifact-production authentication, or dashboard hardware strength.
