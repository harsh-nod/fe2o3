...
evidence	generics	crates/rustc-codegen-fe2o3/src/collector.rs	cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Concrete generic and const-generic helper instances are collected deterministically across crates; generic registered roots and general final application bundles remain unsupported.
...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs,crates/fe2o3-hsaco-finalize/src/first_build_worker_v2.rs,crates/fe2o3-hsaco-finalize/src/worker_executor.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_link_publication.rs,crates/fe2o3-artifact-transaction/src/durable_published_claim.rs,tools/fe2o3-llvm-link-worker/src/WorkerPipeline.cpp,tools/fe2o3-llvm-link-worker/tests/PipelineTests.cpp,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs,crates/fe2o3-worker-v2-bundle/src/compiler_transaction.rs,crates/fe2o3-worker-v2-bundle/src/inputs.rs	cargo test -p fe2o3-hsaco-finalize --locked@@cargo test -p fe2o3-artifact-transaction --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --test kernel_ir_codegen worker_v2_general_v3_alpha_zeta_build_links_and_validate_backend_witnesses -- --ignored --exact@@scripts/tests/run-parity-snapshot.sh	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	Direct LLVM and LLD Worker V2 linking publishes the genuine alpha/zeta COV6 payload through the durable currentness path. The former Cargo Worker V2 restart route has been deleted; current evidence covers the surviving finalizer, durable-publication, and backend fixture boundaries. Compiler transaction and envelope values are inert; Cargo does not authenticate proof, compiler, or effect claims. The later production V3 application handoff is outside this linking evidence record.
evidence	multi-kernel	crates/fe2o3-artifacts/src/gfx942_bundle.rs,crates/fe2o3-verifier/src/multi_kernel_proof.rs,crates/fe2o3-verifier/src/persistent_freshness.rs,crates/fe2o3-worker-v2-bundle/src/model.rs,crates/fe2o3-worker-v2-bundle/src/codec.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs,crates/fe2o3-host/src/worker_v3_verification_admission.rs,crates/fe2o3-host/src/generated_worker_v3_dispatch.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs,crates/fe2o3-host/tests/worker_v3_verification_admission_ui.rs,crates/fe2o3-verifier/src/proof_capsule.rs,crates/fe2o3-kernel-analysis/src/machine_effect.rs	cargo test -p fe2o3-artifacts --locked@@cargo test -p fe2o3-worker-v2-bundle --locked@@cargo test -p fe2o3-verifier --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --locked@@cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-host --test worker_v3_verification_admission_ui --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	Durable multi-kernel publication, exact envelope recovery, generic Worker V3 verification admission and dispatch contracts, proof capsules, and bounded machine-effect records exist. The retired Worker V2 host graph is absent; machine effects remain caller-supplied and no production verifier or Worker V3 hardware replay exists.
...
evidence	s09-source-debug	crates/rustc-codegen-fe2o3/src/source_debug.rs,crates/rustc-codegen-fe2o3/src/s09_identity_v2.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs,crates/fe2o3-process-identity/src/lib.rs,crates/fe2o3-hsa-runtime/tests/s09_gfx942_alpha_hardware.rs,scripts/s09-debug-check.py,scripts/s09-debug-ci.sh,scripts/s09-debug-finalize.sh,scripts/s09-raw-transcript-guard.sh,scripts/s09-rocgdb-profile.sh,scripts/s09-source-state.py,scripts/s09_pinned_snapshot.py,scripts/tests/s09-debug-policy.py,scripts/tests/s09-debug.sh,scripts/tests/s09-debug-ci.sh,scripts/tests/s09-pinned-snapshot.py,scripts/tests/s09-raw-transcript-guard.py,scripts/tests/s09-source-state.py	cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p fe2o3-hsa-runtime --features hardware-test-hooks --test s09_gfx942_alpha_hardware --locked@@scripts/tests/s09-pinned-snapshot.py@@scripts/tests/s09-raw-transcript-guard.py@@scripts/tests/s09-source-state.py@@scripts/tests/s09-debug.sh@@scripts/tests/s09-debug-ci.sh@@scripts/ci-local.sh s09-debug-hardware	5bb8b4caab4d6d386d03bc69ae190bf59bb7115f	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	The exact alpha-only gfx942 O0 COV6 local-capability-v2 lane validates bounded source metadata, inert and physical identity, controller oracles, sealed tracked-source snapshots through descriptor-pinned Git, retained host and proc-fd object identity, and finalizer-enforced archive cross-binding across the source commit and tree, HSACO, host, facts, normalized DWARF and ROCgdb output, tools, statuses, and run nonce. Trappable public cancellation removes the raw ROCgdb path, rechecks sealed source state, and performs bounded same-PGID teardown before leader reap. Process-group escape and uncatchable SIGKILL remain outside local containment and can leave raw data or a pathless child; production-v2 requires an independent protected cgroup or job supervisor. This claim does not archive or authenticate hardware evidence, claim dashboard hardware strength, cover aggregates or optimized or general debugging, establish production-v2 trust, or by itself qualify supplemental row S09.
...
evidence	single-source	crates/cargo-fe2o3/src/binding_wrapper.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/rustc-codegen-fe2o3/src/rust_type_layout_v3.rs,crates/rustc-codegen-fe2o3/src/semantic_witness.rs,crates/rustc-codegen-fe2o3/src/host_object.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_published_claim.rs,crates/fe2o3-worker-v2-bundle/src/model.rs,crates/fe2o3-host/src/production_application.rs,crates/fe2o3-host/src/worker_v3_verification_admission.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p fe2o3-worker-v2-bundle --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --locked@@cargo test -p fe2o3-macros --locked@@cargo test -p fe2o3-host --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --test kernel_ir_codegen worker_v2_general_v3_alpha_zeta_build_links_and_validate_backend_witnesses -- --ignored --exact	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	One genuine Rust alpha/zeta fixture lowers through typed IR, emits identity-bound semantic witnesses, links directly, and durably publishes COV6 plus the canonical load envelope. Worker V3 is the sole host route, but no production verifier yet promotes compiler, Verus, proof, or effect evidence into execution authority.
...
evidence	half-math	crates/fe2o3-device/src/half.rs,crates/fe2o3-device/src/math.rs,crates/fe2o3-device/tests/half_math_api.rs,crates/fe2o3-amdgcn-model/src/device_math.rs,crates/dialect-amdgcn/tests/gfx942_math.rs,crates/rustc-codegen-fe2o3/tests/half_math_compiler.rs	cargo test -p fe2o3-device --locked@@cargo test -p dialect-amdgcn --test gfx942_math --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --test half_math_compiler --locked@@FE2O3_TARGET=gfx942 scripts/ci-local.sh rocm-compile	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial,compile-code-object	Target-gated f16/BF16 conversion, packed BF16x2 FMA, strict divide, and selected OCML calls have exact source, lowering, rejection, and gfx942 code-object tests. The public API, complete type/math/rounding matrix, edge-case GPU execution, and architecture breadth remain incomplete.
...
evidence	memory-ops-v1	crates/fe2o3-device/src/memory.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/memory_v1.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering_memory_tests.rs,crates/rustc-codegen-fe2o3/tests/memory_intrinsics_compiler.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --test memory_intrinsics_compiler --locked	9dcad5d95d070f3a19764ac0e424c094e7f7f7c3	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	Trusted gfx942 offset_from, volatile load and store, and nonoverlapping copy calls lower from real Rust source through Worker V2 with layout and address-space checks. The slice is limited to approved pointer forms and types, does not prove caller overlap or provenance preconditions, and has no archived GPU execution strength.
...
evidence	gfx942-wave-lds-v2	crates/fe2o3-amd-target/src/lib.rs,crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/tests/ui,crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/tests/wire.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/collective_v1.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/rustc-codegen-fe2o3/tests/gfx942_wave_lds_compiler.rs,crates/dialect-amdgcn/tests/gfx942_wave_lds_v1.rs,crates/dialect-amdgcn/tests/fixtures/gfx942_wave_lds_v1_runner.cpp,examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs,examples/verus_vecadd/verus/negative/gfx942_wave_wrong_extent.rs,examples/verus_vecadd/verus/negative/gfx942_lds_missing_barrier_lane.rs,docs/gfx942-wave-lds-v2.md	cargo test -p fe2o3-device --all-targets --locked@@cargo test -p fe2o3-amd-target --all-targets --locked@@cargo test -p fe2o3-kernel-ir --all-targets --locked@@scripts/ci-local.sh rustc-codegen-test@@cargo test -p dialect-amdgcn --all-targets --locked@@cargo test -p dialect-amdgcn --test gfx942_wave_lds_v1 gfx942_xnack_minus_hardware_executes_masked_wave_and_lds_reductions -- --ignored --exact --nocapture@@verus --crate-type lib --triggers-mode silent examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs	c17e847c2017369c1e52d3dfb847001765273cdc	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,verus-0.2026.08.02.b677dd5	source-unit,negative-adversarial,verus-proof	Exact gfx942:xnack- evidence covers a Rust-facing logically masked u32 wave64 sum, one compiler-created 256-slot static-LDS workgroup sum, exact target binding through verified Kernel IR wire and Worker V2 handoff, exact ballot/shuffle/LDS/barrier LLVM shape, and Verus activity/ownership/participation obligations. Omitted XNACK, XNACK enabled, either SRAM-ECC state, duplicate/conflicting/unknown features, and other processors fail before verified Kernel IR. A repeatable direct LLVM/LLD MI300X numerical run is documented, but it is not an archived remote-hardware dashboard strength. The genuine Rust fixture still lacks a complete finalizer envelope and source-bound HSACO; the hardware path starts from independently constructed verified Kernel IR, and no compiler or machine-code refinement is proved.
