...
evidence	s09-source-debug	crates/rustc-codegen-fe2o3/src/source_debug.rs,crates/rustc-codegen-fe2o3/src/s09_identity_v2.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs,crates/fe2o3-process-identity/src/lib.rs,crates/fe2o3-hsa-runtime/tests/s09_gfx942_alpha_hardware.rs,scripts/s09-debug-check.py,scripts/s09-debug-ci.sh,scripts/s09-rocgdb-profile.sh,scripts/tests/s09-debug.sh,scripts/tests/s09-debug-ci.sh	cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p fe2o3-hsa-runtime --features hardware-test-hooks --test s09_gfx942_alpha_hardware --locked@@scripts/tests/s09-debug.sh@@scripts/tests/s09-debug-ci.sh@@scripts/ci-local.sh s09-debug-hardware	791ba8ecbf301fad49498b91a9bcd47a12b5888c	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	The exact alpha-only gfx942 O0 COV6 profile has bounded source metadata, inert identity binding, physical descriptor checks, controller oracles, transcript policy, and an opt-in native ROCgdb replay lane. This checked-in claim does not archive or authenticate a hardware result, claim dashboard hardware strength, cover aggregates or optimized debugging, establish general local/argument inspection, or promote S09 from Missing.
