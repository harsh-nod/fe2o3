...
evidence	device-ffi	crates/fe2o3-device/src/ffi.rs,crates/fe2o3-compiler-ffi/src/module_handoff_v2.rs,crates/rustc-codegen-fe2o3/src/device_ffi.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/fe2o3-hsaco-finalize/src/request_construction.rs,crates/rustc-codegen-fe2o3/tests/device_ffi_cross_crate.rs,crates/cargo-fe2o3/src/binding_wrapper.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked@@cargo test -p rustc-codegen-fe2o3 --test device_ffi_cross_crate --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Offline library fixtures validate bounded device-FFI symbol roles, marker parsing, closure consistency, and fail-closed mismatches; the selector-free cross-crate target retains marker-byte coverage. No current test links or publishes an external provider, emits HSACO, or establishes production or runtime authority.
...
evidence	generics	crates/rustc-codegen-fe2o3/src/collector.rs	cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Offline compiler fixtures validate deterministic concrete generic and const-generic helper collection and fail-closed rejection. Selector-free end-to-end source collection, generic registered roots, and final application bundles remain unsupported.
...
evidence	layout	crates/rustc-codegen-fe2o3/src/rust_type_layout_general.rs,crates/fe2o3-mir-model/src/semantic_type.rs	cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked@@cargo test -p dialect-mir --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Offline compiler and MIR-model tests cover bounded scalar, aggregate, direct-enum, and niche-enum layout records. Host packing, constants, production lowering, DSTs, unions, and recursive graphs are not fully connected.
...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs,crates/fe2o3-hsaco-finalize/src/first_build_worker_v2.rs,crates/fe2o3-hsaco-finalize/src/worker_executor.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_link_publication.rs,crates/fe2o3-artifact-transaction/src/durable_published_claim.rs,tools/fe2o3-llvm-link-worker/src/WorkerPipeline.cpp,tools/fe2o3-llvm-link-worker/tests/PipelineTests.cpp,crates/fe2o3-worker-v2-bundle/src/compiler_transaction.rs,crates/fe2o3-worker-v2-bundle/src/inputs.rs	cargo test -p fe2o3-hsaco-finalize --locked@@cargo test -p fe2o3-artifact-transaction --locked@@scripts/tests/run-parity-snapshot.sh	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03,llvm-api-mechanics	source-unit,negative-adversarial	Offline Rust suites validate bounded link plans, worker admission records, and durable publication transitions; the snapshot harness validates orchestration policy. They do not execute the retired backend generator, produce current compiler-linked HSACO, or establish a production Worker V3 application handoff.
evidence	multi-kernel	crates/fe2o3-artifacts/src/gfx942_bundle.rs,crates/fe2o3-verifier/src/multi_kernel_proof.rs,crates/fe2o3-verifier/src/persistent_freshness.rs,crates/fe2o3-worker-v2-bundle/src/model.rs,crates/fe2o3-worker-v2-bundle/src/codec.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/fe2o3-host/src/worker_v3_verification_admission.rs,crates/fe2o3-host/src/generated_worker_v3_dispatch.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs,crates/fe2o3-host/tests/worker_v3_verification_admission_ui.rs,crates/fe2o3-verifier/src/proof_capsule.rs,crates/fe2o3-kernel-analysis/src/machine_effect.rs	cargo test -p fe2o3-artifacts --locked@@cargo test -p fe2o3-worker-v2-bundle --locked@@cargo test -p fe2o3-verifier --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked@@cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-host --test worker_v3_verification_admission_ui --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Artifact, verifier, and host suites validate durable multi-kernel bundle models, exact envelope recovery, generic Worker V3 admission and dispatch contracts, proof capsules, and bounded machine-effect records. Compiler MIR and lowering coverage is offline only; machine effects remain caller-supplied, and no current compiler-produced bundle or Worker V3 hardware replay exists.
...
evidence	registration	crates/fe2o3-macros/src/lib.rs,crates/fe2o3-macros/tests/typed_kernel_fixtures.rs,crates/rustc-codegen-fe2o3/src/collector.rs,crates/rustc-codegen-fe2o3/src/rust_type_layout_v3.rs,crates/rustc-codegen-fe2o3/src/semantic_witness.rs,crates/rustc-codegen-fe2o3/src/host_object.rs,crates/rustc-codegen-fe2o3/tests/general_two_kernel_import.rs	cargo test -p fe2o3-macros --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p rustc-codegen-fe2o3 --test general_two_kernel_import --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Macro, compiler-library, and selector-free fixture tests validate versioned V3 registration, semantic scalar and trusted-slice identities, deterministic root naming, and fail-closed import structure. They do not currently produce the retired alpha/zeta linked COV6 payload or establish compiler-to-machine refinement.
...
evidence	s09-source-debug	crates/rustc-codegen-fe2o3/src/source_debug.rs,crates/rustc-codegen-fe2o3/src/s09_identity_v2.rs,crates/fe2o3-process-identity/src/lib.rs,scripts/s09-debug-check.py,scripts/s09-debug-finalize.sh,scripts/s09-raw-transcript-guard.sh,scripts/s09-rocgdb-profile.sh,scripts/s09-source-state.py,scripts/s09_pinned_snapshot.py,scripts/tests/s09-debug-policy.py,scripts/tests/s09-debug.sh,scripts/tests/s09-debug-ci.sh,scripts/tests/s09-pinned-snapshot.py,scripts/tests/s09-raw-transcript-guard.py,scripts/tests/s09-source-state.py	cargo test -p rustc-codegen-fe2o3 --lib --locked@@scripts/tests/s09-pinned-snapshot.py@@scripts/tests/s09-raw-transcript-guard.py@@scripts/tests/s09-source-state.py@@scripts/tests/s09-debug.sh@@scripts/tests/s09-debug-ci.sh	5bb8b4caab4d6d386d03bc69ae190bf59bb7115f	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Offline unit and checker suites validate bounded source-debug metadata builders, canonical fixtures, pinned source-state and snapshot records, transcript normalization, identity cross-checks, and adversarial rejection. They do not currently generate HSACO, invoke ROCgdb, load or execute GPU code, archive hardware evidence, or establish production trust.
...
evidence	single-source	crates/cargo-fe2o3/src/binding_wrapper.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/rustc-codegen-fe2o3/src/rust_type_layout_v3.rs,crates/rustc-codegen-fe2o3/src/semantic_witness.rs,crates/rustc-codegen-fe2o3/src/host_object.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_published_claim.rs,crates/fe2o3-worker-v2-bundle/src/model.rs,crates/fe2o3-host/src/production_application.rs,crates/fe2o3-host/src/worker_v3_verification_admission.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p fe2o3-worker-v2-bundle --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked@@cargo test -p fe2o3-macros --locked@@cargo test -p fe2o3-host --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Feature-free Cargo and host tests validate the sole Worker V3 route and reject legacy application paths; offline compiler fixtures cover typed IR, witness, host-object, and publication models. No current test establishes genuine Rust source through compiler linking and durable publication into an executable Worker V3 artifact.
...
evidence	codegen	crates/rustc-codegen-fe2o3/src/amdgpu_llvm.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_codegen.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/dialect-amdgcn/tests/lowering.rs	cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked@@FE2O3_TARGET=gfx1151 scripts/ci-local.sh rocm-compile@@FE2O3_TARGET=gfx942 scripts/ci-local.sh rocm-compile	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx1151,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial,compile-code-object	Offline compiler fixtures cover bounded MIR, Kernel IR, and AMDGPU LLVM construction. The independent dialect G1 golden compiles to a target code object in the ROCm lanes; it is not current real-source rustc-to-HSACO evidence, a production Worker V3 artifact, or machine-code refinement.
...
evidence	half-math	crates/fe2o3-device/src/half.rs,crates/fe2o3-device/src/math.rs,crates/fe2o3-device/tests/half_math_api.rs,crates/fe2o3-amdgcn-model/src/device_math.rs,crates/dialect-amdgcn/tests/gfx942_math.rs	cargo test -p fe2o3-device --locked@@cargo test -p dialect-amdgcn --test gfx942_math --locked	2fee8b63b77df73b92f4de79caaabc5b623ab867	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Source APIs and target-lowering model tests cover bounded f16/BF16 conversion, packed BF16x2 FMA, strict divide, selected OCML calls, and fail-closed target gating. Current evidence does not connect genuine Rust source through the compiler, emit a half-math code object, execute edge cases on a GPU, or cover the complete type, math, and rounding matrix.
...
evidence	memory-ops-v1	crates/fe2o3-device/src/memory.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/memory_v1.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering_memory_tests.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked	9dcad5d95d070f3a19764ac0e424c094e7f7f7c3	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Device API and compiler-library model tests cover bounded gfx942 offset_from, volatile load and store, and nonoverlapping copy lowering with layout, address-space, overlap, and write-authority rejection. They do not establish genuine Rust-source compiler correspondence, caller provenance preconditions, code-object emission, or GPU execution.
...
evidence	control-flow-v1	crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/control_flow_ssa.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering_control_flow_tests.rs,crates/rustc-codegen-fe2o3/src/monomorphization_dead.rs,crates/rustc-codegen-fe2o3/tests/g2_monomorphization.rs,crates/fe2o3-macros/src/control_flow_v1.rs	cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked@@cargo test -p rustc-codegen-fe2o3 --test g2_monomorphization --locked@@cargo test -p fe2o3-macros --locked	1f5685cf56fa48ed3e4064152151a4690e03bbb3	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Offline compiler-library and selector-free fixture tests cover bounded fieldless enums, reducible CFGs, nested break and continue edges, literal integer for-loop modeling, and direct fixed-width monomorphized constants with fail-closed rejection. General source collection, payload and niche matches, arbitrary loops, machine-effect propagation, and GPU execution remain incomplete.
...
evidence	gfx942-tile-interop-v1	crates/fe2o3-core/src/stream.rs,crates/fe2o3-host/src/tile_interop.rs,crates/fe2o3-host/tests/gfx942_tile_interop_hardware.rs,crates/fe2o3-host/tests/tile_interop_ui.rs,crates/fe2o3-host/tests/ui/tile_interop	cargo test -p fe2o3-host --test tile_interop_ui --locked@@cargo test -p fe2o3-host --test gfx942_tile_interop_hardware --locked	f30f6aa362a36d029c0aef820aa6fed8f82bb3ec	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	One typed 16x16 BF16 XOR4 tile lease retains exact context, allocation, and stream identities and rejects lifetime substitution. Arbitrary shapes, data types, cross-library families, intra-kernel composition, numerical MFMA interop, and archived hardware strength are not established.
evidence	cross-crate-device-v1	crates/fe2o3-device/src/lib.rs,crates/fe2o3-macros/src/lib.rs,crates/rustc-codegen-fe2o3/src/collector.rs,crates/rustc-codegen-fe2o3/src/device_ffi.rs,crates/rustc-codegen-fe2o3/tests/cross_crate_imports.rs	cargo test -p fe2o3-macros --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p rustc-codegen-fe2o3 --test cross_crate_imports --locked	ac7999df34902d774f1d6d6704bcd7d9a2d62da5	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Macro and compiler-library tests model producer registration, exact kernel and device initializers, and fail-closed cross-crate import structure; the selector-free integration target remains compile-checked. Its live rustc collection cases remain ignored, and no current test establishes a final application bundle or runtime execution.
evidence	s09-composite-debug-v1	crates/rustc-codegen-fe2o3/src/source_debug.rs,scripts/s09-debug-check.py,scripts/s09-rocgdb-profile.sh,scripts/tests/s09-debug.sh	cargo test -p rustc-codegen-fe2o3 --lib --locked@@scripts/tests/s09-debug.sh	6cfec9aad9267e9355842c9f3c1408e366c7fcd9	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	Offline source-debug unit tests and adversarial fixtures validate the expected reference, tuple, two-element array, argument, local-DWARF, and logical debugger representations. They do not materialize current ROCgdb runtime values, generate a debug HSACO, execute a kernel, or establish optimized, general-kernel, production, archived-hardware, or containment evidence.
evidence	gfx942-diagnostics-v1	crates/fe2o3-device/src/diagnostics.rs,crates/fe2o3-kernel-ir/tests/amdgpu_diagnostics.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/diagnostics.rs,crates/dialect-amdgcn/tests/gfx942_diagnostics.rs,crates/fe2o3-device/tests/ui/pass/gfx942_diagnostics_contract.rs	cargo test -p fe2o3-device --locked@@cargo test -p fe2o3-kernel-ir --test amdgpu_diagnostics --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p dialect-amdgcn --test gfx942_diagnostics --locked	e76653692fa4de2a318aa646671fae7008ba9c17	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	A closed gfx942 source API lowers six typed u32 VGPR operations, bounded printf and assert contracts, trap and debugtrap, a low 32-bit clock, and profiling markers. Print markers are not host-readable formatted output; arbitrary assembly, clobbers, memory, control flow, standard profiling, hardware execution, and other targets remain absent.
...
evidence	gfx942-collectives-v1	crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/src/sync.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/collective_v1.rs,crates/fe2o3-amdgcn-model/src/lowering.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p dialect-amdgcn --locked	234129b911516ee7f62dadf03abea42e70212fdb	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	Trusted gfx942 lowering covers Wave64 u32, i32, and f32 sums and scans plus power-of-two one-dimensional workgroups through 256 threads using LDS and s_barrier. Deferred barrier slot zero is a uniform full-workgroup release-barrier-acquire sequence; named split barriers, broader operations, numerical hardware execution, and Verus obligations remain absent.
evidence	gfx942-wave-lds-v2	crates/fe2o3-amd-target/src/lib.rs,crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/src/lds.rs,crates/fe2o3-rustc-front/src/kernel_resource_contract_v1.rs,crates/fe2o3-macros/src/lib.rs,crates/fe2o3-mir-model/src/semantic_mir_v1.rs,crates/fe2o3-lower-mir-kernel/src/production_semantic_kir_v1.rs,crates/rustc-codegen-fe2o3/src/production_geometry_v1.rs,crates/rustc-codegen-fe2o3/src/production_ranked_projection_v1.rs,crates/rustc-codegen-fe2o3/tests/production_workgroup_sync_driver_v1.rs,crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/tests/wire.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/collective_v1.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/rustc-codegen-fe2o3/tests/gfx942_wave_lds_compiler.rs,crates/dialect-amdgcn/tests/gfx942_wave_lds_v1.rs,crates/dialect-amdgcn/tests/fixtures/gfx942_wave_lds_v1_runner.cpp,examples/workgroup_sync_v1/src/kernel.rs,examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs,examples/verus_vecadd/verus/negative/gfx942_wave_wrong_extent.rs,examples/verus_vecadd/verus/negative/gfx942_lds_missing_barrier_lane.rs,docs/gfx942-production-lds-reduction-v1.md,docs/gfx942-wave-lds-v2.md	cargo test -p fe2o3-device --all-targets --locked@@cargo test -p fe2o3-amd-target --all-targets --locked@@cargo test -p fe2o3-kernel-ir --all-targets --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p rustc-codegen-fe2o3 --bin fe2o3-rustc-extract --locked@@cargo test -p rustc-codegen-fe2o3 --test production_workgroup_sync_driver_v1 lds_reduction_source_handoff_finalizes_and_inspects_reproducible_generic_gfx942_hsaco -- --exact --ignored@@cargo test -p dialect-amdgcn --all-targets --locked@@cargo test -p dialect-amdgcn --test gfx942_wave_lds_v1 gfx942_xnack_minus_hardware_executes_masked_wave_and_lds_reductions -- --ignored --exact --nocapture@@FE2O3_TARGET=gfx942 scripts/ci-local.sh rocm-compile@@verus --crate-type lib --triggers-mode silent examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs	01f15791f1e55fa6f632aee555e3e823a1766c67	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics,verus-0.2026.08.02.b677dd5	source-unit,negative-adversarial,compile-code-object,verus-proof	Exact gfx942:xnack- evidence now includes an authenticated ordinary Rust #[kernel] WG64 i32 LDS reduction carried through semantic MIR, resource and geometry joins, checked bounds-edge elimination, upstream LLVM target APIs, in-process LLD, reproducible inspected COV6 HSACO, and exact 256-byte static-LDS descriptor admission. The current repository intentionally does not execute this artifact through the retired HSA qualification harness; executable evidence must enter through the sole Worker V3 application, production verifier, generated dispatch, and pure-Rust KFD runtime. This remains a bounded WG64 i32 reduction plus scoped-atomic slice, not general reductions or scans, arbitrary geometry and types, current GPU execution, compiler-to-machine refinement, or archived hardware strength.
...
row	45	Partial	s09-source-debug
