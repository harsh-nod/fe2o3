...
emit_default_claims() {
  cat <<'EOF'
schema_version	1
fe2o3_commit	fb7d3fcd69b632d9fc154fda2240ee81257bc414
evidence	abi-pack	crates/fe2o3-host/src/generated_argument_plan.rs	cargo test -p fe2o3-host --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Manifest-bound packing is implemented for bounded scalar and slice profiles; standalone pointers, general aggregate reconstruction, memory validity, aliasing, and launch authority remain outside this evidence.
evidence	artifacts	crates/fe2o3-artifacts/src/container.rs,crates/fe2o3-artifacts/src/bundle.rs	cargo test -p fe2o3-artifacts --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The versioned container and bundle models are bounded and canonical, but general compiler production, authenticated proof binding, and all-target loading are incomplete.
...
evidence	cfg	crates/fe2o3-kernel-analysis/src/control_flow.rs	cargo test -p fe2o3-kernel-analysis --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Deterministic dominators, frontiers, and loop analysis exist, but arbitrary reducible MIR is not yet translated and executed end to end.
evidence	clean	crates/cargo-fe2o3/src/clean.rs	cargo test -p cargo-fe2o3 --test clean_cli --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Cleaning is deliberately restricted to project-local fe2o3 output; complete external-project orchestration and baseline behavior differences remain documented gaps.
evidence	cooperative	crates/fe2o3-core/src/cooperative.rs,crates/fe2o3-host/src/cooperative_launch.rs,crates/fe2o3-kernel-descriptor/src/lib.rs	cargo test -p fe2o3-core --locked@@cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-kernel-descriptor --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Observed cooperative authority retains the exact context, loaded function, and stream; safe admission is conservatively limited to one workgroup until per-function occupancy is observed, and raw argument/semantic obligations remain unsafe.
evidence	constants	crates/dialect-mir/src/semantic_constant.rs	cargo test -p dialect-mir --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bounded semantic constants and data relocations are modeled; rustc promotions, emitted device globals/statics, supported symbol resolution, and GPU execution are not integrated.
evidence	device-copy	crates/fe2o3-core/src/device_copy.rs	cargo test -p fe2o3-core --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Host-transfer bit validity is modeled for approved types; general manifest-derived device interpretation and compiler-enforced ABI identity remain incomplete.
evidence	device-ffi	crates/fe2o3-device/src/ffi.rs,crates/fe2o3-kernel-descriptor/src/ffi_contract.rs,crates/fe2o3-macros/src/lib.rs,crates/rustc-codegen-fe2o3/src/device_ffi.rs	cargo test -p fe2o3-device --locked@@cargo test -p fe2o3-kernel-descriptor --locked@@cargo test -p fe2o3-macros --locked@@cargo test -p rustc-codegen-fe2o3 --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bounded unsafe import/export declarations bind symbols, fixed-width scalar or explicit pointer ABI, address spaces, effects, targets, and semantic identities; worker consumption, symbol resolution, safe wrappers, device-library packaging, and hardware calls remain absent.
evidence	differential	crates/fe2o3-differential/src/generate.rs,crates/fe2o3-differential/src/eval.rs,scripts/differential/harness.py,scripts/differential/reference.cpp	cargo test -p fe2o3-differential --locked@@scripts/tests/differential-conformance.sh	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	Deterministic model generation/reduction and a bounded fill/vecadd/affine HIP-or-CPU oracle harness exist; the recorded claim is toolchain-safe evidence only and does not assert broad MIR fuzzing, hardware coverage, or safety proof.
...
evidence	generics	crates/rustc-codegen-fe2o3/src/collector.rs	cargo test -p rustc-codegen-fe2o3 --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Concrete generic and const-generic helper instances are collected deterministically across crates; generic registered roots and general final application bundles remain unsupported.
evidence	inspect	crates/cargo-fe2o3/src/inspect.rs,crates/fe2o3-hsaco/src/elf_inspection.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p fe2o3-hsaco --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bounded IR, artifact, and HSACO inspection exists for supported payloads; a complete stage-by-stage general compiler pipeline is not available.
evidence	layout	crates/rustc-codegen-fe2o3/src/rust_type_layout_general.rs,crates/dialect-mir/src/semantic_type.rs	cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p dialect-mir --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Layout records cover bounded scalar, aggregate, direct-enum, and niche-enum shapes; host packing, constants, general lowering, DSTs, unions, and recursive graphs are not fully connected.
...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs,crates/fe2o3-hsaco-finalize/src/worker_protocol.rs,tools/fe2o3-llvm-link-worker/src/WorkerPipeline.cpp	cargo test -p fe2o3-hsaco-finalize --locked@@scripts/test-direct-llvm-worker.sh	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03,llvm-api-mechanics	source-unit,negative-adversarial	The canonical plan and standalone measured LLVM/LLD worker implement bounded protocol, bitcode linking, AMDGPU emission, and in-process LLD mechanics; runtime supervision, artifact integration, and successful output with one consistent pinned ROCm LLVM development build remain absent.
evidence	multi-kernel	crates/fe2o3-artifacts/src/bundle.rs,crates/fe2o3-artifacts/src/selection.rs	cargo test -p fe2o3-artifacts --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bundles support deterministic indexing and exact kernel selection; compiler emission of multiple kernels into one shared native module remains incomplete.
evidence	peer	crates/fe2o3-core/src/peer_access.rs,crates/fe2o3-core/src/memory.rs	cargo test -p fe2o3-core --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Directional peer observation and enablement retain exact contexts and linear cleanup ownership, including ambiguous-failure retention; they grant no pointer validity, copy, coherence, alias, race, completion, topology, or virtual-memory authority.
evidence	pinned	crates/fe2o3-core/src/pinned_memory.rs,crates/fe2o3-core/src/event.rs	cargo test -p fe2o3-core --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Pinned memory and event lifetime APIs are covered at source/unit level; broad hardware ordering, cancellation, and multi-stream execution evidence is not recorded here.
evidence	registration	crates/fe2o3-macros/src/lib.rs,crates/rustc-codegen-fe2o3/src/collector.rs	cargo test -p fe2o3-macros --locked@@cargo test -p rustc-codegen-fe2o3 --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Versioned kernel metadata, markers, and reachable helper collection exist; generic roots, general calls/returns, and fully trusted compiler association remain incomplete.
evidence	sanitize-plan	crates/cargo-fe2o3/src/tool_commands.rs,crates/cargo-fe2o3/tests/tool_execution_cli.rs	cargo test -p cargo-fe2o3 --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	Plan mode and bounded descriptor-pinned ROCgdb execution exist with timeout, output, identity, environment, and process supervision; precise-memory availability is fail-closed and no race, API, initialization, synchronization, source-metadata, or safety proof is claimed.
evidence	scalar-ir	crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/src/verify.rs	cargo test -p fe2o3-kernel-ir --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The target-neutral IR models a bounded arithmetic and cast subset; the complete Rust operation matrix, pointer provenance policy, and CPU/GPU differential coverage are missing.
evidence	single-source	crates/cargo-fe2o3/src/rustc_wrapper.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	One Cargo flow and real rustc frontend records exist for bounded profiles; general device compilation, proof-required builds, and all external-project workflows remain incomplete.
evidence	switch	crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/src/wire.rs	cargo test -p fe2o3-kernel-ir --locked@@cargo test -p fe2o3-kernel-analysis --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Canonical integer switches are represented, verified, and analyzed; AMDGPU dialect lowering intentionally fails closed, so executable match parity is not established.
evidence	target	crates/fe2o3-amd-target/src/capabilities.rs,crates/fe2o3-core/src/device_target.rs	cargo test -p fe2o3-amd-target --locked@@cargo test -p fe2o3-core --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Target parsing, override, and capability records are bounded; every compiler/runtime payload path is not yet proven to consume the observed target consistently.
evidence	typed-async	crates/fe2o3-completion/src/lifecycle.rs,crates/fe2o3-core/src/operation.rs	cargo test -p fe2o3-completion --locked@@cargo test -p fe2o3-core --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The lifecycle is bounded and fail-closed with exactly-once reclamation; backend quiescence remains unsafe evidence and general generated async composition is incomplete.
evidence	typed-launch	crates/fe2o3-host/src/generated_vecadd.rs,crates/fe2o3-host/src/prepared_launch.rs,crates/fe2o3-macros/src/lib.rs	cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-macros --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Safe generated preparation and launch are limited to exact profiles; arbitrary signatures, general modules, returnable async operations, and machine-code effect authentication are incomplete.
evidence	ui-safety	crates/fe2o3-device/tests/ui,crates/fe2o3-host/tests/ui	cargo test -p fe2o3-device --locked@@cargo test -p fe2o3-host --locked	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Compile-fail coverage spans current brands, witnesses, aliases, and unsafe boundaries; it is not exhaustive over future compiler, runtime, barrier, or FFI APIs.
evidence	views-proof	crates/fe2o3-device/src/thread.rs,crates/fe2o3-host/src/argument_alias.rs,examples/verus_vecadd/verus/vecadd.rs	cargo test -p fe2o3-device --locked@@cargo test -p fe2o3-host --locked@@verus --crate-type lib --triggers-mode silent examples/verus_vecadd/verus/vecadd.rs	fb7d3fcd69b632d9fc154fda2240ee81257bc414	generic	rust-nightly-2026-04-03,verus-0.2026.08.02.b677dd5	source-unit,negative-adversarial,verus-proof	Branded witnesses, alias admission, and source-level bounds/race proofs cover bounded profiles; general launch mappings and machine-code refinement are not established.
    ...
    case "${kind}" in
      ...
      evidence)
        ...
        [[ "${commit}" == "${STATUS_COMMIT}" ]] ||
          die "claim ${id} is newer than its evidence: ${STATUS_COMMIT} versus ${commit}"
