...
emit_default_claims() {
  cat <<'EOF'
schema_version	1
fe2o3_commit	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec
evidence	abi-pack	crates/fe2o3-host/src/generated_argument_plan.rs	cargo test -p fe2o3-host --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Manifest-bound packing is implemented for bounded scalar and slice profiles; standalone pointers, general aggregate reconstruction, memory validity, aliasing, and launch authority remain outside this evidence.
evidence	artifacts	crates/fe2o3-artifacts/src/container.rs,crates/fe2o3-artifacts/src/bundle.rs	cargo test -p fe2o3-artifacts --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The versioned container and bundle models are bounded and canonical, but general compiler production, authenticated proof binding, and all-target loading are incomplete.
evidence	atomics	crates/fe2o3-kernel-ir/src/ir.rs,crates/dialect-amdgcn/src/lowering.rs	cargo test -p fe2o3-kernel-ir --locked@@cargo test -p dialect-amdgcn --locked@@FE2O3_TARGET=gfx1151 scripts/ci-local.sh rocm-compile@@FE2O3_TARGET=gfx942 scripts/ci-local.sh rocm-compile@@FE2O3_TARGET=gfx950 scripts/ci-local.sh rocm-compile	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic,gfx1151,gfx942,gfx950	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial,compile-code-object	Integer atomic lowering covers bounded operations and scopes; float atomics, standard-library integration, coherent-allocation admission, and hardware memory-order execution remain incomplete.
evidence	cfg	crates/fe2o3-kernel-analysis/src/control_flow.rs	cargo test -p fe2o3-kernel-analysis --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Deterministic dominators, frontiers, and loop analysis exist, but arbitrary reducible MIR is not yet translated and executed end to end.
evidence	clean	crates/cargo-fe2o3/src/clean.rs	cargo test -p cargo-fe2o3 --test clean_cli --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Cleaning is deliberately restricted to project-local fe2o3 output; complete external-project orchestration and baseline behavior differences remain documented gaps.
evidence	cooperative	crates/fe2o3-hip-sys/src/cooperative_peer.rs,crates/fe2o3-kernel-descriptor/src/lib.rs	cargo test -p fe2o3-hip-sys --locked@@cargo test -p fe2o3-kernel-descriptor --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Raw cooperative declarations and descriptor requirements exist; safe authority, occupancy proof, topology checks, and observed-device launch admission are absent.
evidence	constants	crates/dialect-mir/src/semantic_constant.rs	cargo test -p dialect-mir --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bounded semantic constants and data relocations are modeled; rustc promotions, emitted device globals/statics, supported symbol resolution, and GPU execution are not integrated.
evidence	device-copy	crates/fe2o3-core/src/device_copy.rs	cargo test -p fe2o3-core --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Host-transfer bit validity is modeled for approved types; general manifest-derived device interpretation and compiler-enforced ABI identity remain incomplete.
evidence	differential	crates/fe2o3-differential/src/generate.rs,crates/fe2o3-differential/src/eval.rs,crates/fe2o3-differential/src/reduce.rs	cargo test -p fe2o3-differential --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Generation, CPU evaluation, reproducer encoding, and reduction are deterministic; this evidence does not compile cases or compare results against GPU execution.
...
evidence	generics	crates/rustc-codegen-fe2o3/src/collector.rs	cargo test -p rustc-codegen-fe2o3 --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Concrete generic and const-generic helper instances are collected deterministically across crates; generic registered roots and general final application bundles remain unsupported.
evidence	inspect	crates/cargo-fe2o3/src/inspect.rs,crates/fe2o3-hsaco/src/elf_inspection.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p fe2o3-hsaco --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bounded IR, artifact, and HSACO inspection exists for supported payloads; a complete stage-by-stage general compiler pipeline is not available.
evidence	layout	crates/rustc-codegen-fe2o3/src/rust_type_layout_general.rs,crates/dialect-mir/src/semantic_type.rs	cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p dialect-mir --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Layout records cover bounded scalar, aggregate, direct-enum, and niche-enum shapes; host packing, constants, general lowering, DSTs, unions, and recursive graphs are not fully connected.
...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs	cargo test -p fe2o3-hsaco-finalize --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	A canonical direct LLVM/LLD link plan and provenance graph exist; no pinned worker executes the plan at this commit and no linked code object is validated.
evidence	multi-kernel	crates/fe2o3-artifacts/src/bundle.rs,crates/fe2o3-artifacts/src/selection.rs	cargo test -p fe2o3-artifacts --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bundles support deterministic indexing and exact kernel selection; compiler emission of multiple kernels into one shared native module remains incomplete.
evidence	peer	crates/fe2o3-hip-sys/src/cooperative_peer.rs,crates/fe2o3-core/src/memory.rs	cargo test -p fe2o3-hip-sys --locked@@cargo test -p fe2o3-core --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Raw peer capability and memory operations exist; safe multi-device topology, context, ownership, lifetime, and virtual-memory authority remain incomplete.
evidence	pinned	crates/fe2o3-core/src/pinned_memory.rs,crates/fe2o3-core/src/event.rs	cargo test -p fe2o3-core --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Pinned memory and event lifetime APIs are covered at source/unit level; broad hardware ordering, cancellation, and multi-stream execution evidence is not recorded here.
evidence	registration	crates/fe2o3-macros/src/lib.rs,crates/rustc-codegen-fe2o3/src/collector.rs	cargo test -p fe2o3-macros --locked@@cargo test -p rustc-codegen-fe2o3 --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Versioned kernel metadata, markers, and reachable helper collection exist; generic roots, general calls/returns, and fully trusted compiler association remain incomplete.
evidence	sanitize-plan	crates/cargo-fe2o3/src/tool_commands.rs	cargo test -p cargo-fe2o3 --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Sanitizer and debugger argument plans are normalized and shell-free; this commit does not execute ROCgdb or a GPU checker and records no hardware diagnostic result.
evidence	scalar-ir	crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/src/verify.rs	cargo test -p fe2o3-kernel-ir --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The target-neutral IR models a bounded arithmetic and cast subset; the complete Rust operation matrix, pointer provenance policy, and CPU/GPU differential coverage are missing.
evidence	single-source	crates/cargo-fe2o3/src/rustc_wrapper.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	One Cargo flow and real rustc frontend records exist for bounded profiles; general device compilation, proof-required builds, and all external-project workflows remain incomplete.
evidence	switch	crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/src/wire.rs	cargo test -p fe2o3-kernel-ir --locked@@cargo test -p fe2o3-kernel-analysis --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Canonical integer switches are represented, verified, and analyzed; AMDGPU dialect lowering intentionally fails closed, so executable match parity is not established.
evidence	target	crates/fe2o3-amd-target/src/capabilities.rs,crates/fe2o3-core/src/device_target.rs	cargo test -p fe2o3-amd-target --locked@@cargo test -p fe2o3-core --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Target parsing, override, and capability records are bounded; every compiler/runtime payload path is not yet proven to consume the observed target consistently.
evidence	typed-async	crates/fe2o3-completion/src/lifecycle.rs,crates/fe2o3-core/src/operation.rs	cargo test -p fe2o3-completion --locked@@cargo test -p fe2o3-core --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The lifecycle is bounded and fail-closed with exactly-once reclamation; backend quiescence remains unsafe evidence and general generated async composition is incomplete.
evidence	typed-launch	crates/fe2o3-host/src/generated_vecadd.rs,crates/fe2o3-host/src/prepared_launch.rs,crates/fe2o3-macros/src/lib.rs	cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-macros --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Safe generated preparation and launch are limited to exact profiles; arbitrary signatures, general modules, returnable async operations, and machine-code effect authentication are incomplete.
evidence	ui-safety	crates/fe2o3-device/tests/ui,crates/fe2o3-host/tests/ui	cargo test -p fe2o3-device --locked@@cargo test -p fe2o3-host --locked	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Compile-fail coverage spans current brands, witnesses, aliases, and unsafe boundaries; it is not exhaustive over future compiler, runtime, barrier, or FFI APIs.
evidence	views-proof	crates/fe2o3-device/src/thread.rs,crates/fe2o3-host/src/argument_alias.rs,examples/verus_vecadd/verus/vecadd.rs	cargo test -p fe2o3-device --locked@@cargo test -p fe2o3-host --locked@@verus --crate-type lib --triggers-mode silent examples/verus_vecadd/verus/vecadd.rs	4a6bd7fd2f4ee89f9e79b05a5bbad503539cc9ec	generic	rust-nightly-2026-04-03,verus-0.2026.08.02.b677dd5	source-unit,negative-adversarial,verus-proof	Branded witnesses, alias admission, and source-level bounds/race proofs cover bounded profiles; general launch mappings and machine-code refinement are not established.
    ...
    case "${kind}" in
      ...
      evidence)
        ...
        validate_csv_values "${id}" toolchain "${toolchains}" \
          rust-nightly-2026-04-03 rocm-7.2 verus-0.2026.08.02.b677dd5
