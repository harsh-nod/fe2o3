...
evidence	gfx942-wave-lds-v2	crates/fe2o3-amd-target/src/lib.rs,crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/tests/ui,crates/fe2o3-kernel-ir/src/ir.rs,crates/fe2o3-kernel-ir/tests/wire.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/collective_v1.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/dialect-amdgcn/tests/gfx942_wave_lds_v1.rs,crates/dialect-amdgcn/tests/fixtures/gfx942_wave_lds_v1_runner.cpp,examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs,examples/verus_vecadd/verus/negative/gfx942_wave_wrong_extent.rs,examples/verus_vecadd/verus/negative/gfx942_lds_missing_barrier_lane.rs,docs/gfx942-wave-lds-v2.md	cargo test -p fe2o3-device --all-targets --locked@@cargo test -p fe2o3-amd-target --all-targets --locked@@cargo test -p fe2o3-kernel-ir --all-targets --locked@@cargo test -p rustc-codegen-fe2o3 --features qualification-oracles-test-only --lib --locked@@cargo test -p dialect-amdgcn --all-targets --locked@@cargo test -p dialect-amdgcn --test gfx942_wave_lds_v1 gfx942_xnack_minus_hardware_executes_masked_wave_and_lds_reductions -- --ignored --exact --nocapture@@verus --crate-type lib --triggers-mode silent examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs	c17e847c2017369c1e52d3dfb847001765273cdc	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,verus-0.2026.08.02.b677dd5	source-unit,negative-adversarial,verus-proof	Source, Kernel IR, offline compiler, dialect, and Verus evidence covers a logically masked u32 wave64 sum, a modeled 256-slot static-LDS workgroup sum, exact gfx942:xnack- target rejection, ballot, shuffle, LDS, and barrier shapes, and activity, ownership, and participation obligations. A direct independently constructed Kernel IR hardware test remains observational and is not archived dashboard hardware strength. No current genuine-Rust compiler handoff, source-bound HSACO, production finalizer envelope, or compiler-to-machine refinement is established.
