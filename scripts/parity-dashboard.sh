...
evidence	gfx942-collectives-v1	crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/src/sync.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/collective_v1.rs,crates/dialect-amdgcn/src/lowering.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p dialect-amdgcn --locked	234129b911516ee7f62dadf03abea42e70212fdb	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2	source-unit,negative-adversarial	Trusted gfx942 lowering covers Wave64 u32, i32, and f32 sums and scans plus power-of-two one-dimensional workgroups through 256 threads using LDS and s_barrier. Deferred barrier slot zero is a uniform full-workgroup release-barrier-acquire sequence; named split barriers, broader operations, numerical hardware execution, and Verus obligations remain absent.
evidence	gfx942-wave-lds-v1	crates/fe2o3-device/src/collective.rs,crates/fe2o3-device/tests/ui,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering/semantic_lowering/collective_v1.rs,crates/rustc-codegen-fe2o3/tests/gfx942_wave_lds_compiler.rs,crates/dialect-amdgcn/tests/gfx942_wave_lds_v1.rs,crates/dialect-amdgcn/tests/fixtures/gfx942_wave_lds_v1_runner.cpp,examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs,examples/verus_vecadd/verus/negative/gfx942_wave_wrong_extent.rs,examples/verus_vecadd/verus/negative/gfx942_lds_missing_barrier_lane.rs	cargo test -p fe2o3-device --lib --locked@@cargo test -p fe2o3-device --test device_api_ui --locked@@cargo test -p rustc-codegen-fe2o3 --lib --locked@@cargo test -p rustc-codegen-fe2o3 --test gfx942_wave_lds_compiler --locked@@cargo test -p dialect-amdgcn --test gfx942_wave_lds_v1 --locked@@cargo test -p dialect-amdgcn --test gfx942_wave_lds_v1 gfx942_xnack_minus_hardware_executes_masked_wave_and_lds_reductions -- --ignored --exact --nocapture@@verus --crate-type lib --triggers-mode silent examples/verus_vecadd/verus/gfx942_wave_lds_v1.rs	fbc06915ffe170925952ae1844dbd341fd1ed3f5	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,verus-0.2026.08.02.b677dd5	source-unit,negative-adversarial,verus-proof	Exact gfx942:xnack- evidence covers a Rust-facing logically masked u32 wave64 sum, one compiler-created 256-slot static-LDS workgroup sum, exact ballot/shuffle/LDS/barrier LLVM shape, and Verus activity/ownership/participation obligations. A repeatable direct LLVM/LLD MI300X numerical run is documented, but it is not an archived remote-hardware dashboard strength. The genuine Rust fixture stops at verified Kernel IR because this profile lacks a complete authenticated Worker V2/finalizer envelope; the hardware path starts from independently constructed verified Kernel IR, and no compiler or machine-code refinement is proved.
...
row	57	Partial	gfx942-wave-lds-v1
row	58	Partial	lds
row	60	Partial	views-proof
row	61	Partial	gfx942-wave-lds-v1
row	62	Partial	gfx942-collectives-v1
row	64	Partial	fence
row	65	Partial	gfx942-wave-lds-v1
row	66	Partial	wave
row	67	Partial	wave
...
row	70	Partial	wave
row	71	Partial	wave
row	72	Partial	gfx942-wave-lds-v1
row	73	Partial	gfx942-wave-lds-v1
