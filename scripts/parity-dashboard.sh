...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs,crates/fe2o3-hsaco-finalize/src/first_build_worker_v2.rs,crates/fe2o3-hsaco-finalize/src/worker_executor.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_link_publication.rs,tools/fe2o3-llvm-link-worker/src/WorkerPipeline.cpp,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p fe2o3-hsaco-finalize --locked@@cargo test -p fe2o3-artifact-transaction --locked@@cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_publishes_inspected_gfx942_hsaco -- --ignored --exact@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_links_an_external_bitcode_provider -- --ignored --exact@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_publishes_two_kernels_with_one_shared_helper -- --ignored --exact	09ccd63e640911991c5ba111c2c4118bfb97e33e	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	The exact manifest-derived plan drives deterministic direct LLVM and LLD Worker V2 linking, raw-HSACO inspection, and durable publication for the bounded gfx942 single-kernel, provider-backed, and two-kernel shared-helper fixtures. These commands compile and inspect code objects only; compiler origin and Verus results are not authenticated, general signatures and packaged device libraries remain incomplete, and no HSA load, dispatch, or kernel execution is claimed.
...
evidence	single-source	crates/cargo-fe2o3/src/binding_wrapper.rs,crates/cargo-fe2o3/src/worker_v2.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs,crates/rustc-codegen-fe2o3/src/mir_import.rs,crates/rustc-codegen-fe2o3/src/kernel_ir_lowering.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_publishes_inspected_gfx942_hsaco -- --ignored --exact@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_links_an_external_bitcode_provider -- --ignored --exact@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_publishes_two_kernels_with_one_shared_helper -- --ignored --exact	09ccd63e640911991c5ba111c2c4118bfb97e33e	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	One sealed Cargo command carries real Rust source, including two entries and one internal helper, through compiler manifest production, direct Worker V2 LLVM linking, HSACO inspection, and durable publication for gfx942. The slice does not yet invoke Verus as part of that command, build a general host API, support arbitrary signatures, or load and execute the published kernels; no remote-hardware kernel execution is claimed.
...
evidence	typed-launch	crates/fe2o3-host/src/generated_vecadd.rs,crates/fe2o3-host/src/prepared_launch.rs,crates/fe2o3-host/src/published_direct_link.rs,crates/fe2o3-host/src/worker_v2_bundle_admission.rs,crates/fe2o3-host/src/hsa_executable_lifecycle.rs,crates/fe2o3-verifier/src/multi_kernel_proof.rs,crates/fe2o3-verifier/tests/authenticated_proof_binding.rs,crates/fe2o3-host/tests/ui/hsa_executable_lifecycle/inert_typed_selection_cannot_clone.rs,crates/fe2o3-host/tests/ui/hsa_executable_lifecycle/unload_while_typed_selection_borrowed.rs	cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-verifier --locked@@cargo test -p fe2o3-macros --locked	96178a0fa123f61368124bbc1568434a7757a763	generic,gfx942	rust-nightly-2026-04-03	source-unit,negative-adversarial	One shared admitted Worker V2 executable can issue two distinct non-clone typed selections bound to exact symbol, ABI, effects, target, physical layout, executable, and per-kernel proof identities, with substitution and unload-while-borrowed rejection. Selection for the second kernel is intentionally inert; safe execution remains limited to the exact vecadd profile, and arbitrary manifest-derived packing, async dispatch, and hardware kernel execution are not claimed.
