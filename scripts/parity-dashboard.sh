...
evidence	abi-pack	crates/fe2o3-host/src/generated_argument_plan.rs	cargo test -p fe2o3-host --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Manifest-bound packing is implemented for bounded scalar and slice profiles; standalone pointers, general aggregate reconstruction, memory validity, aliasing, and launch authority remain outside this evidence.
evidence	artifacts	crates/fe2o3-artifacts/src/container.rs,crates/fe2o3-artifacts/src/bundle.rs	cargo test -p fe2o3-artifacts --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The versioned container and bundle models are bounded and canonical, but general compiler production, authenticated proof binding, and all-target loading are incomplete.
...
evidence	device-ffi	crates/fe2o3-device/src/ffi.rs,crates/fe2o3-compiler-ffi/src/module_handoff_v2.rs,crates/rustc-codegen-fe2o3/src/device_ffi.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/fe2o3-hsaco-finalize/src/request_construction.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs,crates/cargo-fe2o3/src/binding_wrapper.rs	cargo test -p fe2o3-device --locked@@cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_publishes_inspected_gfx942_hsaco -- --ignored --exact@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_links_an_external_bitcode_provider -- --ignored --exact	1b80187e7543bf04d5ad9bc241aac61bbd6128e9	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	One bounded gfx942 Worker V2 slice consumes the exact compiler-produced symbol-role manifest and closes a Rust device import against an external LLVM bitcode provider; its direct and provider-backed compile, admission, and durable-publication tests passed on mi300x. Compiler identity/origin and Verus results are not authenticated; canonical descriptor finalization, HSA load/launch, general signatures, and packaged device libraries remain absent.
...
evidence	link-plan	crates/fe2o3-hsaco-finalize/src/link_plan.rs,crates/fe2o3-hsaco-finalize/src/first_build_worker_v2.rs,crates/fe2o3-hsaco-finalize/src/worker_executor.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/attempt_scoped_hsaco_publication.rs,crates/fe2o3-artifact-transaction/src/durable_link_publication.rs,tools/fe2o3-llvm-link-worker/src/WorkerPipeline.cpp	cargo test -p fe2o3-hsaco-finalize --locked@@cargo test -p fe2o3-artifact-transaction --locked@@cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_publishes_inspected_gfx942_hsaco -- --ignored --exact@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_links_an_external_bitcode_provider -- --ignored --exact	1b80187e7543bf04d5ad9bc241aac61bbd6128e9	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	The exact manifest-derived plan drives reproducible direct LLVM/LLD Worker V2 linking, independent raw-HSACO admission, and durable attempt-scoped byte and provenance publication; both direct and external-bitcode-provider compile/publication tests passed on mi300x. Compiler identity/origin and Verus results are not authenticated; canonical descriptor finalization, HSA load/launch, general signatures, and packaged device libraries remain absent.
evidence	multi-kernel	crates/fe2o3-artifacts/src/bundle.rs,crates/fe2o3-artifacts/src/selection.rs	cargo test -p fe2o3-artifacts --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Bundles support deterministic indexing and exact kernel selection; compiler emission of multiple kernels into one shared native module remains incomplete.
...
evidence	registration	crates/fe2o3-macros/src/lib.rs,crates/rustc-codegen-fe2o3/src/collector.rs	cargo test -p fe2o3-macros --locked@@cargo test -p rustc-codegen-fe2o3 --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Versioned kernel metadata, markers, and reachable helper collection exist; generic roots, general calls/returns, and fully trusted compiler association remain incomplete.
...
evidence	single-source	crates/cargo-fe2o3/src/binding_wrapper.rs,crates/cargo-fe2o3/src/worker_v2.rs,crates/rustc-codegen-fe2o3/src/frontend_record_bridge.rs,crates/rustc-codegen-fe2o3/src/worker_v2_producer.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_admission.rs,crates/fe2o3-hsaco-finalize/src/worker_v2_hsaco_publication.rs,crates/rustc-codegen-fe2o3/tests/kernel_ir_codegen.rs	cargo test -p cargo-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --locked@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_publishes_inspected_gfx942_hsaco -- --ignored --exact@@cargo test -p rustc-codegen-fe2o3 --test kernel_ir_codegen worker_v2_real_source_links_an_external_bitcode_provider -- --ignored --exact	1b80187e7543bf04d5ad9bc241aac61bbd6128e9	generic,gfx942	rust-nightly-2026-04-03,rocm-7.2,llvm-api-mechanics	source-unit,negative-adversarial	One Cargo-driven gfx942 slice carries real Rust source through exact compiler manifest production, optional external LLVM bitcode-provider closure, measured Worker V2 linking, independent HSACO admission, and durable attempt-scoped publication; both compile/publication tests passed on mi300x. Compiler identity/origin and Verus results are not authenticated; canonical descriptor finalization, HSA load/launch, general signatures, and packaged device libraries remain absent.
...
evidence	typed-async	crates/fe2o3-completion/src/lifecycle.rs,crates/fe2o3-core/src/operation.rs	cargo test -p fe2o3-completion --locked@@cargo test -p fe2o3-core --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	The lifecycle is bounded and fail-closed with exactly-once reclamation; backend quiescence remains unsafe evidence and general generated async composition is incomplete.
evidence	typed-launch	crates/fe2o3-host/src/generated_vecadd.rs,crates/fe2o3-host/src/prepared_launch.rs,crates/fe2o3-macros/src/lib.rs	cargo test -p fe2o3-host --locked@@cargo test -p fe2o3-macros --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Safe generated preparation and launch are limited to exact profiles; arbitrary signatures, general modules, returnable async operations, and machine-code effect authentication are incomplete.
evidence	ui-safety	crates/fe2o3-device/tests/ui,crates/fe2o3-host/tests/ui	cargo test -p fe2o3-device --locked@@cargo test -p fe2o3-host --locked	37eee8f15b985190449ece7a93f4ab386aa3cb18	generic	rust-nightly-2026-04-03	source-unit,negative-adversarial	Compile-fail coverage spans current brands, witnesses, aliases, and unsafe boundaries; it is not exhaustive over future compiler, runtime, barrier, or FFI APIs.
