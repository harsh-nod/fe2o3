...
#[test]
fn physical_global_copy_v38_structural_marker_joins_two_pairs_and_actual_u32_pointees() {
...
#[test]
fn physical_global_copy_v38_marker_rejects_ownership_mutability_shape_and_pointee_substitution() {
    let (request, abi) = marker();
    let begin = SemanticCompilerIntrinsicOperationV1::Gfx942PhysicalGlobalCopyBegin;
    for owners in [
        vec![
            SemanticSourceArgumentOwnershipV1::ExclusiveOwner,
            SemanticSourceArgumentOwnershipV1::SharedBorrow,
...
#[test]
fn physical_global_copy_v38_tagged_source_storage_remains_one_bounded_payload() {
