...
fn lds_capability_barriers_epochs_and_ownership_are_closed() {
    let mutations: Vec<fn(&mut fe2o3_kernel_ir::LdsReductionKernelIrV1)> = vec![
        ...
        |value| value.arguments[1].offset = 20,
        |value| value.arguments[1].size = 8,
        |value| value.arguments[1].alignment = 8,
        |value| value.arguments[2].role = WorkgroupSyncArgumentRoleV1::Values,
        |value| value.arguments[2].shape = WorkgroupSyncArgumentShapeV1::SharedReadOnlySlice64,
        |value| value.arguments[2].scalar = fe2o3_kernel_ir::ScalarType::U32,
        |value| value.arguments[2].offset = 32,
        |value| value.arguments[2].size = 8,
