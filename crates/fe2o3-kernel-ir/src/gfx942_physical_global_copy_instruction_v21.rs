//! Fixed descriptor and exact physical-unit input/result roster for KIR21 only.
use super::Gfx942PhysicalGlobalCopyShapeErrorV21 as Error;
use crate::Gfx942PhysicalEntryRegisterV20 as R;

#[repr(u8)]
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum Gfx942PhysicalGlobalCopyOpcodeV1 {
    LoadKernargPair = 0,
    WaitLgkm0 = 1,
    ScalarLshl32 = 2,
    VectorAddU32 = 3,
...
impl Gfx942PhysicalGlobalCopyOpcodeV1 {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct Gfx942PhysicalGlobalCopyInstructionV1 {
    pub opcode: Gfx942PhysicalGlobalCopyOpcodeV1,
    pub destination: u8,
    pub source0: u8,
    pub source1: u8,
    pub immediate: u32,
}
impl Gfx942PhysicalGlobalCopyInstructionV1 {
    ...
    pub fn from_descriptor(bytes: [u8; 8]) -> Result<Self, Error> {
        let value = Self {
            opcode: Gfx942PhysicalGlobalCopyOpcodeV1::from_tag(bytes[0])
    ...
    pub fn validate_shape(self) -> Result<(), Error> {
        use Gfx942PhysicalGlobalCopyOpcodeV1 as O;
        ...
        let valid = match self.opcode {
            ...
            O::ScalarLshl32 => sdest(d) && unit(a) && b == 0 && immediate == 6,
    ...
    pub const fn operand_registers(self) -> [Option<R>; 5] {
        ...
        match self.opcode {
            ...
            O::WaitLgkm0 | O::WaitVm0 | O::Endpgm0 => [None; 5],
        }
    }
    ...
    pub const fn result_registers(self) -> [Option<R>; 4] {
        ...
        match self.opcode {
            ...
            O::VectorAddU32 | O::VectorMove32 | O::GlobalLoadDword => {
                [Some(R::Vgpr(d)), None, None, None]
            }
            O::VectorLshlrev64 => [
                Some(R::Vgpr(d)),
            ...
            O::WaitLgkm0 | O::WaitVm0 | O::GlobalStoreDword | O::Endpgm0 => [None; 4],
        }
    }
}
