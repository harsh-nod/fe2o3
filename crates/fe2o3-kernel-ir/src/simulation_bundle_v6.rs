...
mod tests {
    ...
    use crate::{
        ...
        DebugSourceMapSpanV1, Function, Kernel, LaunchDomain, LaunchExtent, Operation,
        OperationKind, SemanticArgumentOwnershipV1, SemanticArgumentStorageV1,
        SemanticArgumentStorageV2, SemanticComponentStorageBindingV2, SemanticKernargSlotV2,
        SemanticKirComponentRepresentationV2, SemanticKirComponentStorageV2,
        SemanticKirStorageRepresentationV1, SemanticStorageBindingV1, Signature, Terminator, Type,
        ValueDef, ValueId, WorkgroupSize, decode_module_v11,
    };
