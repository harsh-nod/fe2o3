...
mod tests {
    use super::{
        ...
        normalize_invocation, parse_rustup_tool_path, prepare_binding_clippy_args,
        ...
        selected_run_target, source_isa_characteristic_broker_hex,
        source_isa_characteristic_broker_hex_length, source_isa_collection_hex,
