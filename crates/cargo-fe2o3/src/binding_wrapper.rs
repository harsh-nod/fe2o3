...
impl CompilerCapabilities {
    ...
    fn prepare_qualification_command(
        ...
        if compiler_closure_observation {
            ...
            command.env_remove(crate::EXPECTED_COMPILER_CLOSURE_SHA256_ENV);
        }
        self.inherit_invocation_authority(command)?;
        Ok(())
    }
...
mod tests {
    ...
    use super::{
        ...
        os_bytes, pipeline_requires_protected_invocation, pre_spawn_failure,
        prepare_managed_attempt, prepared_rustc_command_sha256, process_start_time_ticks,
