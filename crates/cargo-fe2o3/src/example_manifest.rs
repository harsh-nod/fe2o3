    ...
    fn parses_strict_example_manifest_and_lane_projection() {
        let manifest = parse(&example_manifest(
            "fe2o3-alpha|true|true|true|alpha.hsaco\n\
             fe2o3-pipeline|true|true|false|bias_stage.hsaco,scale_stage.hsaco\n\
        ...
        assert!(!manifest.entries[1].participates(Lane::GpuSmoke));
    ...
    fn cpu_test_partition_is_sorted_disjoint_and_exhaustive() {
        let manifest = parse(&example_manifest(
            "fe2o3-managed|true|false|false|-\n\
             ...
             fe2o3-rocm|true|true|true|rocm.hsaco\n\
...
pub fn alpha() {}"#,
    ...
    fn rejects_unsafe_names_duplicates_and_inconsistent_lanes() {
        let cases = [
            ...
            (
                "a|true|true|false|../escape.hsaco\n",
                "unsafe artifact name",
            ),
            ("a|true|true|false|alpha.o\n", "expected a .hsaco basename"),
            (
                "a|true|true|false|same.hsaco\nb|true|true|false|same.hsaco\n",
                "duplicate artifact",
            ),
            (
                "a|true|true|false|zeta.hsaco,alpha.hsaco\n",
                "artifacts must be sorted lexicographically",
            ),
            (
                "a|true|unknown|false|alpha.hsaco\n",
                "rocm_compile must be exactly",
            ),
            (
                "a|true|true|false|-\n",
...
"##;
    ...
    fn checked_in_manifest_matches_current_repository() {
        ...
        assert!(pipeline.rocm_compile);
        assert!(fill.rocm_compile);
        assert!(fill.gpu_smoke);
