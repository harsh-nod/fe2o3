...
use fe2o3_kernel_ir::{
    ...
    FunctionRole, IndexKind, IntrinsicKind, IntrinsicOperation, Kernel,
    KernelContextSourceIdentityV1, KernelContextTypeV1, LaunchDomain, LaunchExtent, Module,
    Operation, OperationKind, Signature, TargetCapability, Terminator, Type, ValueDef, ValueId,
    VerifiedCanonicalKernelIrV9, VerifiedCanonicalKernelIrV12, WaveWidth, WorkgroupMemory,
