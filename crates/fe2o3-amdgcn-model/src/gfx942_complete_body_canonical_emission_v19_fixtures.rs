//! Synthetic canonical content only; origin bytes do not authenticate source.
use fe2o3_kernel_ir::*;
use fe2o3_kernel_ir::{
    Gfx942CompleteBodyOriginVNext as Origin, Gfx942CompleteBodyStepVNext as Step,
...
fn module(blocks: Vec<BasicBlock>) -> Module {
    ...
    function.required_capabilities = capabilities;
