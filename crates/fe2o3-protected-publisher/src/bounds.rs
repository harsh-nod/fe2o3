...
pub const MAX_NEGATIVE_JWKS_KIDS: usize = 128;
pub const MAX_CACHED_JWKS_KID_BYTES: usize = 256;
pub const JWKS_FORCED_REFRESH_FLOOR_SECS: u64 = 1;
pub const JWKS_FORCED_REFRESH_MAX_BACKOFF_SECS: u64 = 30;
...
pub const MAX_LEDGER_FRAME_BYTES: usize = MAX_LEDGER_RECORD_BYTES + 184;
