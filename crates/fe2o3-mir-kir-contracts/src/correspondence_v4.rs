...
impl MirToKirBlockCorrespondenceEvidenceV4 {
    /// Constructs an exact block-correspondence record for canonical encoding.
...
impl MirToKirStatementSpanEvidenceV4 {
    /// Constructs an exact statement-span record for canonical encoding.
    pub const fn from_parts(
        semantic_function: u32,
        semantic_block: u32,
        statement: u32,
...
impl MirToKirTerminatorSpanEvidenceV4 {
    /// Constructs an exact terminator-span record for canonical encoding.
    pub const fn from_parts(
        semantic_function: u32,
        semantic_block: u32,
        kernel_ir_block: u32,
...
impl MirToKirSyntheticSpanEvidenceV4 {
    /// Constructs an exact synthetic-span record for canonical encoding.
    pub const fn from_parts(
        rule: MirToKirSyntheticRuleEvidenceV4,
        kernel_ir_block: u32,
        first_operation: u32,
...
impl MirToKirParameterBindingEvidenceV4 {
    /// Constructs an exact semantic-parameter binding for canonical encoding.
    pub const fn from_parts(
        semantic_function: u32,
        semantic_local: u32,
        kernel_ir_value: u32,
...
impl InertCanonicalMirToKirCorrespondenceEvidenceV4 {
    /// Canonically encodes already extracted correspondence records and strict nested evidence.
