...
use crate::{ProductionCanonicalKernelIrIdentityV1, ProductionCanonicalKernelIrVersionV1};
...
impl InertCanonicalFormalMemoryAdmissionEvidenceV4 {
    /// Canonically encodes an admitted obligation receipt and its exact KIR identity.
