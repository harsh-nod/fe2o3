...
pub use model_v2::{
    ...
    KERNEL_DESCRIPTOR_SECTION_V2, MAX_ARRAY_ELEMENTS_V2, MAX_CANONICAL_HANDOFF_BYTES_V2,
    MAX_CONSTANT_GLOBAL_BYTES_V2, MAX_EVIDENCE_OBLIGATIONS_V2, MAX_FUNCTION_ATTRIBUTES_V2,
    MAX_FUNCTION_BLOCKS_V2, MAX_FUNCTION_PARAMETERS_V2, MAX_FUNCTIONS_V2, MAX_GEP_INDICES_V2,
    MAX_GLOBALS_V2, MAX_INSTRUCTIONS_PER_FUNCTION_V2, MAX_INTRINSICS_V2, MAX_LOCAL_ARRAY_BYTES_V2,
    MAX_MODULE_FLAGS_V2, MAX_NAMED_METADATA_V2, MAX_PARAMETER_ATTRIBUTES_V2, MAX_SYMBOL_BYTES_V2,
    MAX_VALUES_PER_FUNCTION_V2, MAX_VECTOR_LANES_V2, MIN_ARRAY_ELEMENTS_V2, MIN_VECTOR_LANES_V2,
    ModuleIdentityV2, ReturnTypeV2, ScalarConstantV2, TerminatorV2, TypedValueV2, ValueIdV2,
    ValueTypeV2,
};
