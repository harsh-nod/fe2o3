...
pub proof fn reference_modeled_global_accesses_are_bounded_v1(
    a: Seq<real>,
    b: Seq<real>,
    c: Seq<real>,
    group_x: nat,
            ...
            ) < c.len(),
{
    model::schedule_modeled_global_accesses_are_bounded_v1(
        model::GeneralGemmScheduleModelV1::ReferenceWave64Xor4,
        a, b, c, group_x, group_y, phase, lane, component,
        m, n, k, lda, ldb, ldc,
    );
}

pub proof fn reference_output_region_is_injective_v1(
    left_group_x: nat,
    left_group_y: nat,
    left_lane: nat,
    left_component: nat,
...
pub proof fn reference_scalar_tail_zero_fills_v1(
    a: Seq<real>,
    b: Seq<real>,
    group_x: nat,
    group_y: nat,
...
pub proof fn reference_accumulator_refines_contract_v1(
    a: Seq<real>,
    b: Seq<real>,
    row: nat,
    column: nat,
...
pub proof fn reference_numerical_contract_v1(
    a: Seq<real>,
    b: Seq<real>,
    row: nat,
    column: nat,
...
pub proof fn reference_epilogue_refines_exact_real_contract_v1(
    alpha: real,
    accumulator: real,
    beta: real,
    c: real,
