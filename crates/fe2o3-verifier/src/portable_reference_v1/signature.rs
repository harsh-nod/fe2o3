//! Portable inert logical signature data, not source or provider authority.
//!
...
pub const MAX_REFERENCE_SIGNATURE_INPUTS_V1: usize = HARD_MAX_CALL_ARGUMENTS_V1 as usize;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReferenceRegionV1 {
    Erased,
    Static,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReferenceCarrierV1 {
    DisjointSlice,
    WriteOnlyDisjointSlice,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReferencePointeeV1 {
    Scalar(ReferenceScalarTypeV1),
    Slice(ReferenceScalarTypeV1),
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReferenceSignatureInputV1 {
    Scalar(ReferenceScalarTypeV1),
    Reference {
...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReferenceReturnShapeV1 {
    Unit,
    NonUnit,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReferenceSignatureSideV1 {
    Kernel,
    Reference,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub enum ReferenceSignatureErrorV1 {
    NonUnitReturn,
    UnsafeReference,
    InvalidReferenceAbi,
    InputLimit {
...
pub struct ReferenceLogicalSignaturePreimageV1 {
...
pub struct ReferenceLogicalAbiRelationV1<'a> {
...
impl ReferenceLogicalAbiRelationV1<'_> {
    ...
    pub fn relation_at_raw_argument_v1(
        &self,
