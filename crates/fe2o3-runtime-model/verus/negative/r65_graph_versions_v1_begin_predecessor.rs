...
pub open spec fn begin_write_v1(phase: PhaseV1, pending: Option<nat>, current: Option<nat>, predecessor: nat) -> bool {
    phase == PhaseV1::Planned && pending == None && current.is_some()
}
...
pub proof fn mutated_begin_predecessor_v1(phase: PhaseV1, pending: Option<nat>, current: Option<nat>, predecessor: nat)
