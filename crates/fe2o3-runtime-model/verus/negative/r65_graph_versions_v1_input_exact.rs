...
pub open spec fn input_ready_v1(current: Option<nat>, expected: nat, phase: PhaseV1) -> bool {
    current.is_some() && (phase == PhaseV1::AvailableAtAdmission || phase == PhaseV1::Committed)
}
...
pub proof fn mutated_input_exact_v1(current: Option<nat>, expected: nat, phase: PhaseV1)
