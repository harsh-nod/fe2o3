...
pub open spec fn input_ready_v1(current: Option<nat>, expected: nat, phase: PhaseV1) -> bool {
    current == Some(expected) && (phase == PhaseV1::AvailableAtAdmission || phase == PhaseV1::Committed || phase == PhaseV1::InFlight)
}
...
pub proof fn mutated_input_available_v1(current: Option<nat>, expected: nat, phase: PhaseV1)
