...
pub open spec fn begin_write_v1(phase: PhaseV1, pending: Option<nat>, current: Option<nat>, predecessor: nat) -> bool {
    (phase == PhaseV1::Planned || phase == PhaseV1::Committed) && pending == None && current == Some(predecessor)
}
...
pub proof fn mutated_begin_planned_v1(phase: PhaseV1, pending: Option<nat>, current: Option<nat>, predecessor: nat)
