...
producer_read_lifecycle_proof="$script_dir/context_producer_read_lifecycle_v1.rs"
producer_journal_issuance_proof="$script_dir/context_producer_journal_issuance_v1.rs"
...
r70_resource_batch_proof="$script_dir/r70_resource_batch_v1.rs"
negative_r70_empty_roster="$script_dir/negative/r70_resource_batch_v1_empty_roster.rs"
negative_r70_oversized_roster="$script_dir/negative/r70_resource_batch_v1_oversized_roster.rs"
negative_r70_final_member_omitted="$script_dir/negative/r70_resource_batch_v1_final_member_omitted.rs"
negative_r70_final_dimension_omitted="$script_dir/negative/r70_resource_batch_v1_final_dimension_omitted.rs"
negative_r70_aggregate_overflow="$script_dir/negative/r70_resource_batch_v1_aggregate_overflow.rs"
negative_r70_record_shortage="$script_dir/negative/r70_resource_batch_v1_record_shortage.rs"
...
r74_ordered_peer_copy_proof="$script_dir/r74_ordered_peer_copy_v1.rs"
negative_r74_cancel_prefix="$script_dir/negative/r74_ordered_peer_copy_v1_cancel_prefix.rs"
negative_r74_early_success="$script_dir/negative/r74_ordered_peer_copy_v1_early_success.rs"
negative_r74_failed_close="$script_dir/negative/r74_ordered_peer_copy_v1_failed_close.rs"
negative_r74_clear_publication="$script_dir/negative/r74_ordered_peer_copy_v1_clear_publication.rs"
negative_r74_reopen_recovery="$script_dir/negative/r74_ordered_peer_copy_v1_reopen_recovery.rs"
...
negative_r72_logical_bytes_substitution="$script_dir/negative/r72_host_visible_backing_credits_v1_logical_bytes_substitution.rs"
negative_r72_gpu_view_double_charge="$script_dir/negative/r72_host_visible_backing_credits_v1_gpu_view_double_charge.rs"
negative_r72_allocation_record_omitted="$script_dir/negative/r72_host_visible_backing_credits_v1_allocation_record_omitted.rs"
negative_r72_short_mapping_accepted="$script_dir/negative/r72_host_visible_backing_credits_v1_short_mapping_accepted.rs"
negative_r72_excess_padding_accepted="$script_dir/negative/r72_host_visible_backing_credits_v1_excess_padding_accepted.rs"
negative_r72_unaligned_mapping_accepted="$script_dir/negative/r72_host_visible_backing_credits_v1_unaligned_mapping_accepted.rs"
negative_r72_nonordinary_view_accepted="$script_dir/negative/r72_host_visible_backing_credits_v1_nonordinary_view_accepted.rs"
r71_device_pool_proof="$script_dir/r71_device_pool_v1.rs"
negative_r71_logical_bytes_undercharge="$script_dir/negative/r71_device_pool_v1_logical_bytes_undercharge.rs"
negative_r71_final_record_omitted="$script_dir/negative/r71_device_pool_v1_final_record_omitted.rs"
negative_r71_changed_generation_alias="$script_dir/negative/r71_device_pool_v1_changed_generation_alias.rs"
negative_r71_foreign_domain="$script_dir/negative/r71_device_pool_v1_foreign_domain.rs"
negative_r71_zero_pool_generation="$script_dir/negative/r71_device_pool_v1_zero_pool_generation.rs"
negative_r71_byte_limit_omitted="$script_dir/negative/r71_device_pool_v1_byte_limit_omitted.rs"
negative_r71_record_limit_omitted="$script_dir/negative/r71_device_pool_v1_record_limit_omitted.rs"
negative_r71_zero_byte_limit_as_unlimited="$script_dir/negative/r71_device_pool_v1_zero_byte_limit_as_unlimited.rs"
negative_r71_roster_bound_omitted="$script_dir/negative/r71_device_pool_v1_roster_bound_omitted.rs"
negative_r71_unbounded_wrapping_sum="$script_dir/negative/r71_device_pool_v1_unbounded_wrapping_sum.rs"
...
expected_read_preflight=$(read_pin "$pin_dir/CONTEXT_READ_PREFLIGHT_SHA256")
expected_read_preflight_checker=$(read_pin "$pin_dir/READ_PREFLIGHT_CHECKER_SHA256")
expected_read_commit=$(read_pin "$pin_dir/CONTEXT_READ_COMMIT_SHA256")
...
expected_producer_read_lifecycle=$(read_pin "$pin_dir/CONTEXT_PRODUCER_READ_LIFECYCLE_SHA256")
expected_producer_read_lifecycle_checker=$(read_pin "$pin_dir/PRODUCER_READ_LIFECYCLE_CHECKER_SHA256")
expected_producer_journal_issuance=$(read_pin "$pin_dir/CONTEXT_PRODUCER_JOURNAL_ISSUANCE_SHA256")
expected_producer_journal_issuance_checker=$(read_pin "$pin_dir/PRODUCER_JOURNAL_ISSUANCE_CHECKER_SHA256")
...
expected_r70_resource_batch=$(read_pin "$pin_dir/R70_RESOURCE_BATCH_SHA256")
expected_negative_r70_empty_roster=$(read_pin "$pin_dir/NEGATIVE_R70_EMPTY_ROSTER_SHA256")
expected_negative_r70_oversized_roster=$(read_pin "$pin_dir/NEGATIVE_R70_OVERSIZED_ROSTER_SHA256")
expected_negative_r70_final_member_omitted=$(read_pin "$pin_dir/NEGATIVE_R70_FINAL_MEMBER_OMITTED_SHA256")
expected_negative_r70_final_dimension_omitted=$(read_pin "$pin_dir/NEGATIVE_R70_FINAL_DIMENSION_OMITTED_SHA256")
expected_negative_r70_aggregate_overflow=$(read_pin "$pin_dir/NEGATIVE_R70_AGGREGATE_OVERFLOW_SHA256")
expected_negative_r70_record_shortage=$(read_pin "$pin_dir/NEGATIVE_R70_RECORD_SHORTAGE_SHA256")
...
expected_r74_ordered_peer_copy=$(read_pin "$pin_dir/R74_ORDERED_PEER_COPY_SHA256")
expected_negative_r74_cancel_prefix=$(read_pin "$pin_dir/NEGATIVE_R74_CANCEL_PREFIX_SHA256")
expected_negative_r74_early_success=$(read_pin "$pin_dir/NEGATIVE_R74_EARLY_SUCCESS_SHA256")
expected_negative_r74_failed_close=$(read_pin "$pin_dir/NEGATIVE_R74_FAILED_CLOSE_SHA256")
expected_negative_r74_clear_publication=$(read_pin "$pin_dir/NEGATIVE_R74_CLEAR_PUBLICATION_SHA256")
expected_negative_r74_reopen_recovery=$(read_pin "$pin_dir/NEGATIVE_R74_REOPEN_RECOVERY_SHA256")
...
expected_negative_r72_logical_bytes_substitution=$(read_pin "$pin_dir/NEGATIVE_R72_LOGICAL_BYTES_SUBSTITUTION_SHA256")
expected_negative_r72_gpu_view_double_charge=$(read_pin "$pin_dir/NEGATIVE_R72_GPU_VIEW_DOUBLE_CHARGE_SHA256")
expected_negative_r72_allocation_record_omitted=$(read_pin "$pin_dir/NEGATIVE_R72_ALLOCATION_RECORD_OMITTED_SHA256")
expected_negative_r72_short_mapping_accepted=$(read_pin "$pin_dir/NEGATIVE_R72_SHORT_MAPPING_ACCEPTED_SHA256")
expected_negative_r72_excess_padding_accepted=$(read_pin "$pin_dir/NEGATIVE_R72_EXCESS_PADDING_ACCEPTED_SHA256")
expected_negative_r72_unaligned_mapping_accepted=$(read_pin "$pin_dir/NEGATIVE_R72_UNALIGNED_MAPPING_ACCEPTED_SHA256")
expected_negative_r72_nonordinary_view_accepted=$(read_pin "$pin_dir/NEGATIVE_R72_NONORDINARY_VIEW_ACCEPTED_SHA256")
expected_r71_device_pool=$(read_pin "$pin_dir/R71_DEVICE_POOL_SHA256")
expected_negative_r71_logical_bytes_undercharge=$(read_pin "$pin_dir/NEGATIVE_R71_LOGICAL_BYTES_UNDERCHARGE_SHA256")
expected_negative_r71_final_record_omitted=$(read_pin "$pin_dir/NEGATIVE_R71_FINAL_RECORD_OMITTED_SHA256")
expected_negative_r71_changed_generation_alias=$(read_pin "$pin_dir/NEGATIVE_R71_CHANGED_GENERATION_ALIAS_SHA256")
expected_negative_r71_foreign_domain=$(read_pin "$pin_dir/NEGATIVE_R71_FOREIGN_DOMAIN_SHA256")
expected_negative_r71_zero_pool_generation=$(read_pin "$pin_dir/NEGATIVE_R71_ZERO_POOL_GENERATION_SHA256")
expected_negative_r71_byte_limit_omitted=$(read_pin "$pin_dir/NEGATIVE_R71_BYTE_LIMIT_OMITTED_SHA256")
expected_negative_r71_record_limit_omitted=$(read_pin "$pin_dir/NEGATIVE_R71_RECORD_LIMIT_OMITTED_SHA256")
expected_negative_r71_zero_byte_limit_as_unlimited=$(read_pin "$pin_dir/NEGATIVE_R71_ZERO_BYTE_LIMIT_AS_UNLIMITED_SHA256")
expected_negative_r71_roster_bound_omitted=$(read_pin "$pin_dir/NEGATIVE_R71_ROSTER_BOUND_OMITTED_SHA256")
expected_negative_r71_unbounded_wrapping_sum=$(read_pin "$pin_dir/NEGATIVE_R71_UNBOUNDED_WRAPPING_SUM_SHA256")
...
check_sources() {
    ...
    check_digest "$expected_producer_read_lifecycle" "$producer_read_lifecycle_proof"
    check_digest "$expected_producer_read_lifecycle_checker" "$producer_read_lifecycle_checker"
    check_digest "$expected_producer_journal_issuance" "$producer_journal_issuance_proof"
    ...
    check_digest "$expected_r70_resource_batch" "$r70_resource_batch_proof"
    check_digest "$expected_negative_r70_empty_roster" "$negative_r70_empty_roster"
    check_digest "$expected_negative_r70_oversized_roster" "$negative_r70_oversized_roster"
    check_digest "$expected_negative_r70_final_member_omitted" "$negative_r70_final_member_omitted"
    check_digest "$expected_negative_r70_final_dimension_omitted" "$negative_r70_final_dimension_omitted"
    check_digest "$expected_negative_r70_aggregate_overflow" "$negative_r70_aggregate_overflow"
    check_digest "$expected_negative_r70_record_shortage" "$negative_r70_record_shortage"
    ...
    check_digest "$expected_r74_ordered_peer_copy" "$r74_ordered_peer_copy_proof"
    check_digest "$expected_negative_r74_cancel_prefix" "$negative_r74_cancel_prefix"
    check_digest "$expected_negative_r74_early_success" "$negative_r74_early_success"
    check_digest "$expected_negative_r74_failed_close" "$negative_r74_failed_close"
    check_digest "$expected_negative_r74_clear_publication" "$negative_r74_clear_publication"
    check_digest "$expected_negative_r74_reopen_recovery" "$negative_r74_reopen_recovery"
    ...
    check_digest "$expected_negative_r72_logical_bytes_substitution" "$negative_r72_logical_bytes_substitution"
    check_digest "$expected_negative_r72_gpu_view_double_charge" "$negative_r72_gpu_view_double_charge"
    check_digest "$expected_negative_r72_allocation_record_omitted" "$negative_r72_allocation_record_omitted"
    check_digest "$expected_negative_r72_short_mapping_accepted" "$negative_r72_short_mapping_accepted"
    check_digest "$expected_negative_r72_excess_padding_accepted" "$negative_r72_excess_padding_accepted"
    check_digest "$expected_negative_r72_unaligned_mapping_accepted" "$negative_r72_unaligned_mapping_accepted"
    check_digest "$expected_negative_r72_nonordinary_view_accepted" "$negative_r72_nonordinary_view_accepted"
    check_digest "$expected_r71_device_pool" "$r71_device_pool_proof"
    check_digest "$expected_negative_r71_logical_bytes_undercharge" "$negative_r71_logical_bytes_undercharge"
    check_digest "$expected_negative_r71_final_record_omitted" "$negative_r71_final_record_omitted"
    check_digest "$expected_negative_r71_changed_generation_alias" "$negative_r71_changed_generation_alias"
    check_digest "$expected_negative_r71_foreign_domain" "$negative_r71_foreign_domain"
    check_digest "$expected_negative_r71_zero_pool_generation" "$negative_r71_zero_pool_generation"
    check_digest "$expected_negative_r71_byte_limit_omitted" "$negative_r71_byte_limit_omitted"
    check_digest "$expected_negative_r71_record_limit_omitted" "$negative_r71_record_limit_omitted"
    check_digest "$expected_negative_r71_zero_byte_limit_as_unlimited" "$negative_r71_zero_byte_limit_as_unlimited"
    check_digest "$expected_negative_r71_roster_bound_omitted" "$negative_r71_roster_bound_omitted"
    check_digest "$expected_negative_r71_unbounded_wrapping_sum" "$negative_r71_unbounded_wrapping_sum"
...
/usr/bin/env -i PATH=/usr/bin:/bin /usr/bin/python3 -I "$source_checker" \
    ...
    "$r70_resource_batch_proof" \
    "$negative_r70_empty_roster" \
    "$negative_r70_oversized_roster" \
    "$negative_r70_final_member_omitted" \
    "$negative_r70_final_dimension_omitted" \
    "$negative_r70_aggregate_overflow" \
    "$negative_r70_record_shortage" \
    ...
    "$r74_ordered_peer_copy_proof" \
    "$negative_r74_cancel_prefix" \
    "$negative_r74_early_success" \
    "$negative_r74_failed_close" \
    "$negative_r74_clear_publication" \
    "$negative_r74_reopen_recovery" \
    "$r72_host_visible_backing_credits_proof" \
    "$negative_r72_zero_accepted" \
    "$negative_r72_oversized_accepted" \
    "$negative_r72_logical_bytes_substitution" \
    "$negative_r72_gpu_view_double_charge" \
    "$negative_r72_allocation_record_omitted" \
    "$negative_r72_short_mapping_accepted" \
    "$negative_r72_excess_padding_accepted" \
    "$negative_r72_unaligned_mapping_accepted" \
    "$negative_r72_nonordinary_view_accepted" \
    "$r71_device_pool_proof" \
    "$negative_r71_logical_bytes_undercharge" \
    "$negative_r71_final_record_omitted" \
    "$negative_r71_changed_generation_alias" \
    "$negative_r71_foreign_domain" \
    "$negative_r71_zero_pool_generation" \
    "$negative_r71_byte_limit_omitted" \
    "$negative_r71_record_limit_omitted" \
    "$negative_r71_zero_byte_limit_as_unlimited" \
    "$negative_r71_roster_bound_omitted" \
    "$negative_r71_unbounded_wrapping_sum" \
...
# The reader checker admits only its exact pinned J1 import and audits both files.
...
# Only the commit checker admits the exact pinned include and audits its closure.
...
# The invariant checker authenticates the complete pinned J3/J2/J1 closure.
...
check_positive "$r74_ordered_peer_copy_proof" 'verification results:: 10 verified, 0 errors' r74-ordered-peer-copy
...
check_negative "$negative_r70_empty_roster" mutated_empty_roster_v1 r70-empty-roster
check_negative "$negative_r70_oversized_roster" mutated_oversized_roster_v1 r70-oversized-roster
check_negative "$negative_r70_final_member_omitted" mutated_final_member_omitted_v1 r70-final-member-omitted
check_negative "$negative_r70_final_dimension_omitted" mutated_final_dimension_omitted_v1 r70-final-dimension-omitted
check_negative "$negative_r70_aggregate_overflow" mutated_aggregate_overflow_v1 r70-aggregate-overflow
check_negative "$negative_r70_record_shortage" mutated_record_shortage_v1 r70-record-shortage
...
check_negative "$negative_r74_cancel_prefix" mutated_cancel_prefix_v1 r74-cancel-prefix
check_negative "$negative_r74_early_success" mutated_early_success_v1 r74-early-success
check_negative "$negative_r74_failed_close" mutated_failed_close_v1 r74-failed-close
check_negative "$negative_r74_clear_publication" mutated_clear_publication_v1 r74-clear-publication
check_negative "$negative_r74_reopen_recovery" mutated_reopen_recovery_v1 r74-reopen-recovery
...
check_negative "$negative_r72_gpu_view_double_charge" mutated_gpu_view_double_charge_v1 r72-gpu-view-double-charge
check_negative "$negative_r72_allocation_record_omitted" mutated_allocation_record_omitted_v1 r72-allocation-record-omitted
check_negative "$negative_r72_short_mapping_accepted" mutated_short_mapping_accepted_v1 r72-short-mapping-accepted
check_negative "$negative_r72_excess_padding_accepted" mutated_excess_padding_accepted_v1 r72-excess-padding-accepted
check_negative "$negative_r72_unaligned_mapping_accepted" mutated_unaligned_mapping_accepted_v1 r72-unaligned-mapping-accepted
check_negative "$negative_r72_nonordinary_view_accepted" mutated_nonordinary_view_accepted_v1 r72-nonordinary-view-accepted
check_negative "$negative_r71_logical_bytes_undercharge" mutated_logical_bytes_undercharge_v1 r71-logical-bytes-undercharge
check_negative "$negative_r71_final_record_omitted" mutated_final_record_omitted_v1 r71-final-record-omitted
check_negative "$negative_r71_changed_generation_alias" mutated_changed_generation_alias_v1 r71-changed-generation-alias
check_negative "$negative_r71_foreign_domain" mutated_foreign_domain_v1 r71-foreign-domain
check_negative "$negative_r71_zero_pool_generation" mutated_zero_pool_generation_v1 r71-zero-pool-generation
check_negative "$negative_r71_byte_limit_omitted" mutated_byte_limit_omitted_v1 r71-byte-limit-omitted
check_negative "$negative_r71_record_limit_omitted" mutated_record_limit_omitted_v1 r71-record-limit-omitted
check_negative "$negative_r71_zero_byte_limit_as_unlimited" mutated_zero_byte_limit_as_unlimited_v1 r71-zero-byte-limit-as-unlimited
check_negative "$negative_r71_roster_bound_omitted" mutated_roster_bound_omitted_v1 r71-roster-bound-omitted
check_negative "$negative_r71_unbounded_wrapping_sum" mutated_unbounded_wrapping_sum_v1 r71-unbounded-wrapping-sum
...
transcript="$transcript producer_read_invariant_obligations=181 producer_read_invariant_inherited=156 producer_read_invariant_new=25 producer_read_invariant_test_obligations=1 producer_read_invariant_mutations=12"
transcript="$transcript producer_read_lifecycle_obligations=255 producer_read_lifecycle_inherited=181 producer_read_lifecycle_new=74 producer_read_lifecycle_executable_mutations=19"
transcript="$transcript producer_journal_issuance_obligations=201 producer_journal_issuance_inherited=181 producer_journal_issuance_new=20 producer_journal_issuance_executable_mutations=13"
