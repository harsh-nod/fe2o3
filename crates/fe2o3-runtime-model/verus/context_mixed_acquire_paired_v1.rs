...
#[path = "context_owner_lifecycle_adapters_v1.rs"]
mod owner_lifecycle_adapters;
use owner_lifecycle_adapters::*;
...
#[path = "context_owner_lifecycle_preservation_v1.rs"]
mod owner_lifecycle_preservation;
use owner_lifecycle_preservation::*;
...
mod production {
    ...
    include!("context_owner_lifecycle_correspondence_v1.rs");
    include!("context_owner_lifecycle_observation_v1.rs");
    include!("context_owner_lifecycle_trace_v1.rs");
