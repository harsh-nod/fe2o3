...
// MIR38 source transport and allocated KIR21 executable profile.
// Normal source owners are consumed; no pending Function/Module is an input.
include!("production_physical_global_copy_context_v21.rs");
#[path = "production_physical_global_copy_parameter_v21.rs"]
mod physical_global_copy_parameter_v21;
include!("production_physical_global_copy_transport_v21.rs");
include!("production_physical_global_copy_correspondence_v21.rs");

/// Source reconstruction, budget or exact KIR21 admission failure.
#[derive(Debug)]
pub enum ProductionPhysicalGlobalCopySourceErrorV21 {
    /// The retained source, ABI, launch or exact reconstruction was refused.
    Lowering(ProductionSemanticKirErrorV1),
    /// Exact KIR21 inverse/general/profile admission was refused.
    Canonical(fe2o3_kernel_ir::CanonicalKernelIrReplayAdmissionErrorV21),
}
impl fmt::Display for ProductionPhysicalGlobalCopySourceErrorV21 {
...
impl Error for ProductionPhysicalGlobalCopySourceErrorV21 {}
impl From<ProductionSemanticKirErrorV1> for ProductionPhysicalGlobalCopySourceErrorV21 {
    fn from(e: ProductionSemanticKirErrorV1) -> Self {
        Self::Lowering(e)
    }
}
impl From<ArgumentResourceV1> for ProductionPhysicalGlobalCopySourceErrorV21 {
...
///
/// ```compile_fail
/// use fe2o3_lower_mir_kernel::ProductionPhysicalGlobalCopyPreRankedKirOwnerV21;
/// fn copy<T: Clone>() {}
/// copy::<ProductionPhysicalGlobalCopyPreRankedKirOwnerV21>();
/// ```
/// ```compile_fail
/// use fe2o3_lower_mir_kernel::ProductionPhysicalGlobalCopyPreRankedKirOwnerV21;
/// fn mutate(x: &mut ProductionPhysicalGlobalCopyPreRankedKirOwnerV21) {
///     x.executable().module().functions.clear();
/// }
/// ```
#[must_use]
pub struct ProductionPhysicalGlobalCopyPreRankedKirOwnerV21 {
    ...
    correspondence: PhysicalGlobalCopySourceCorrespondenceV21,
    limits: ProductionSemanticKirLimitsV1,
    retained_storage: usize,
}
impl ProductionPhysicalGlobalCopyPreRankedKirOwnerV21 {
    ...
    pub fn try_materialize_with_budget(
    ...
    ) -> Result<Self, ProductionPhysicalGlobalCopySourceErrorV21> {
        semantic_ssa
            .verify_replay()
        ...
        let context =
            physical_global_copy_context_v21(&semantic_ssa, &source_launch, limits, scope.budget)?;
        let (module, correspondence, temporary, rows) = lower_physical_global_copy_normal_root_v21(
            &semantic_ssa,
            &source_launch,
            &context,
            limits,
        ...
        let (executable, storage) = fe2o3_kernel_ir::VerifiedCanonicalKernelIrModuleV21::
            from_module_ref_with_verification_budget_v21(&module, scope.budget)
            .map_err(ProductionPhysicalGlobalCopySourceErrorV21::Canonical)?;
    ...
    /// One inverse-decoded immutable KIR21 executable owner.
    pub fn executable(&self) -> &fe2o3_kernel_ir::VerifiedCanonicalKernelIrModuleV21 {
        &self.executable
    }
    /// Exact source expansion/elimination relation.
    pub fn correspondence(&self) -> &PhysicalGlobalCopySourceCorrespondenceV21 {
        &self.correspondence
    }
    ...
    pub fn verify_equivalence(
        &self,
        budget: &mut ArgumentBudgetV1<'_>,
    ) -> Result<(), ProductionPhysicalGlobalCopySourceErrorV21> {
        ...
        self.semantic_ssa
            .verify_replay()
            .map_err(ProductionSemanticKirErrorV1::SemanticSsa)?;
        let scope = PhysicalGlobalCopyLedgerScopeV21::new(budget);
        let context = physical_global_copy_context_v21(
            &self.semantic_ssa,
            &self.source_launch,
            self.limits,
            scope.budget,
        )?;
        let (module, correspondence, _, _) = lower_physical_global_copy_normal_root_v21(
            &self.semantic_ssa,
            &self.source_launch,
            &context,
            self.limits,
...
fn lower_physical_global_copy_normal_root_v21(
    owner: &ProductionSemanticSsaOwnerV1,
    launch: &crate::ProductionSourceLaunchRosterV1,
    context: &PhysicalGlobalCopyContextV21<'_>,
    limits: ProductionSemanticKirLimitsV1,
    budget: &mut ArgumentBudgetV1<'_>,
) -> Result<
    (
        Module,
        PhysicalGlobalCopySourceCorrespondenceV21,
        usize,
        usize,
    ),
...
> {
    ...
    let pending = crate::physical_global_copy_materialization_v21::materialize(&input, budget)
        .map_err(physical_global_copy_materialization_error_v21)?;
        ...
        || plan.kernel_ir_function != pending.function().id
    {
        return Err(physical_global_copy_refusal(
            "physical-global-copy ordinary root ABI plan differs",
        ));
    }
    let body = pending
        .function()
    ...
    if body.blocks.len() > limits.max_blocks {
        return Err(physical_global_copy_refusal(
            "physical-global-copy canonical block limit",
        ));
    }
    ...
    if operation_count > limits.max_operations {
        return Err(physical_global_copy_refusal(
            "physical-global-copy canonical operation limit",
        ));
    }
    let (correspondence, rows) = PhysicalGlobalCopySourceCorrespondenceV21::capture(
        context,
    ...
    let capability_payload = physical_global_copy_capability_payload_v21()?;
    ...
    module.functions[0].required_capabilities = physical_global_copy_capabilities_v21();
...
fn physical_global_copy_capabilities_v21()
-> std::collections::BTreeSet<fe2o3_kernel_ir::TargetCapability> {
    ...
    [
        ...
        TargetCapability::Extension {
            namespace: AMDGPU_GFX942_PHYSICAL_GLOBAL_COPY_CAPABILITY_NAMESPACE_V21.into(),
            name: AMDGPU_GFX942_PHYSICAL_GLOBAL_COPY_CAPABILITY_NAME_V21.into(),
        },
    ]
    .into_iter()
    .collect()
...
fn physical_global_copy_capability_payload_v21() -> Result<usize, ArgumentResourceV1> {
    use fe2o3_kernel_ir::{
    ...
    let strings = argument_sum_v1(&[
        ...
        AMDGPU_GFX942_PHYSICAL_GLOBAL_COPY_CAPABILITY_NAMESPACE_V21.len(),
        AMDGPU_GFX942_PHYSICAL_GLOBAL_COPY_CAPABILITY_NAME_V21.len(),
    ])?;
    argument_product_v1(
        3,
        argument_sum_v1(&[
...
fn physical_global_copy_materialization_error_v21(
    error: crate::physical_global_copy_materialization_v21::Error,
) -> ProductionSemanticKirErrorV1 {
    use crate::physical_global_copy_materialization_v21::Error as E;
    match error {
        E::Resource(error) => error.into(),
        E::Origin => {
            physical_global_copy_refusal("physical-global-copy canonical origin is incomplete")
        }
        E::Symbol => physical_global_copy_refusal("physical-global-copy canonical symbol differs"),
        E::Occurrence => {
            physical_global_copy_refusal("physical-global-copy canonical occurrence order differs")
        }
        E::Shape => physical_global_copy_refusal(
            "physical-global-copy canonical control-flow grammar differs",
        ),
        E::Instruction => {
            physical_global_copy_refusal("physical-global-copy canonical instruction shape differs")
        }
        E::UndefinedRegister => physical_global_copy_refusal(
            "physical-global-copy reads an undefined physical register",
        ),
        E::Count => physical_global_copy_refusal(
            "physical-global-copy canonical count exceeds exact bounds",
        ),
        E::Accounting => ArgumentResourceV1::Accounting.into(),
    }
}

struct PhysicalGlobalCopyLedgerScopeV21<'a, 'work> {
    budget: &'a mut ArgumentBudgetV1<'work>,
    floor: usize,
}
impl<'a, 'work> PhysicalGlobalCopyLedgerScopeV21<'a, 'work> {
...
impl Drop for PhysicalGlobalCopyLedgerScopeV21<'_, '_> {
    fn drop(&mut self) {
