...
/// Direct retained-array writes have checked operand placement; other memory
/// and final proof discharges remain unsupported. This view grants no authority.
...
> {
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        let historical = checked_output.native_input_audit_bytes();
