...
fn type_check_initialized_tile(tile: &LdsTile16x16<'_, Bf16, LdsInitialized>) {
    let _: Option<Bf16MfmaFragment> = tile.read_mfma_fragment(0);
}
...
fn main() {
    ...
    let _: fn(&LdsTile16x16<'_, Bf16, LdsInitialized>) = type_check_initialized_tile;
}
