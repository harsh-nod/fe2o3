...
pub enum PersistedSimulationScheduleArtifactV1 {
    ...
    CanonicalKirV10,
    /// Exact canonical Kernel IR V11 was supplied directly.
    CanonicalKirV11,
    /// Exact canonical Kernel IR V12 was supplied directly.
    CanonicalKirV12,
    ...
    /// A Bundle V6 supplied its exact same-module canonical KIR V11 body.
    SimulationBundleV6 {
        bundle_sha256: [u8; 32],
        subject_sha256: [u8; 32],
    },
    /// A Bundle V7 supplied exact canonical KIR V12 at one final graph epoch.
    SimulationBundleV7 {
        bundle_sha256: [u8; 32],
        subject_sha256: [u8; 32],
        final_graph_epoch: u64,
    },
    /// A Bundle V8 supplied exact canonical KIR V13 at one final graph epoch.
    SimulationBundleV8 {
        bundle_sha256: [u8; 32],
        subject_sha256: [u8; 32],
        final_graph_epoch: u64,
...
impl TryFrom<ScheduleDocumentWireV1> for PersistedSimulationScheduleDocumentV1 {
    ...
    fn try_from(wire: ScheduleDocumentWireV1) -> Result<Self, Self::Error> {
        ...
        let (artifact, kir_sha256, kir_canonical_bytes) = match wire.artifact {
            ...
            ArtifactWireV1::CanonicalKirV11 {
                kir_sha256,
                kir_canonical_bytes,
            } => (
            ...
            ArtifactWireV1::CanonicalKirV12 {
                kir_sha256,
                kir_canonical_bytes,
            } => (
            ...
            ArtifactWireV1::SimulationBundleV6 {
                bundle_sha256,
                subject_sha256,
                kir_sha256,
                kir_canonical_bytes,
            ...
            ArtifactWireV1::SimulationBundleV7 {
                bundle_sha256,
                subject_sha256,
                final_graph_epoch,
                kir_sha256,
            ...
            ArtifactWireV1::SimulationBundleV8 {
                bundle_sha256,
                subject_sha256,
                final_graph_epoch,
                kir_sha256,
        ...
        let binding = PersistedSimulationScheduleBindingV1 {
            ...
            kir_wire_version: match artifact {
                ...
                PersistedSimulationScheduleArtifactV1::CanonicalKirV11
                | PersistedSimulationScheduleArtifactV1::SimulationBundleV6 { .. } => 11,
                PersistedSimulationScheduleArtifactV1::CanonicalKirV12 => 12,
                PersistedSimulationScheduleArtifactV1::SimulationBundleV7 { .. } => 12,
                PersistedSimulationScheduleArtifactV1::SimulationBundleV8 { .. } => 13,
            },
            kir_sha256,
            kir_canonical_bytes,
...
fn wire_from_parts<'a>(
    ...
    let artifact = match binding.artifact {
        ...
        PersistedSimulationScheduleArtifactV1::CanonicalKirV11 => ArtifactWireV1::CanonicalKirV11 {
            kir_sha256: HexIdentityV1(binding.kir_sha256),
            kir_canonical_bytes: binding.kir_canonical_bytes,
        },
        PersistedSimulationScheduleArtifactV1::CanonicalKirV12 => ArtifactWireV1::CanonicalKirV12 {
            kir_sha256: HexIdentityV1(binding.kir_sha256),
            kir_canonical_bytes: binding.kir_canonical_bytes,
        },
        PersistedSimulationScheduleArtifactV1::SimulationBundleV1 {
