...
pub const WORKER_V2_APPLICATION_ENVELOPE_FD_ENV_V1: &str = "FE2O3_APPLICATION_ENVELOPE_FD_V1";
pub const WORKER_V2_APPLICATION_ARTIFACT_DIR_FD_ENV_V1: &str =
    "FE2O3_APPLICATION_ARTIFACT_DIR_FD_V1";
pub const WORKER_V2_APPLICATION_HANDOFF_COMMITMENT_ENV_V1: &str =
