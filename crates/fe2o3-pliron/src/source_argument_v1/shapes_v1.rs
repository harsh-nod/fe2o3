...
pub fn check_argument_function_abi_v1(
...
pub fn lower_parameter_scalar_v1(
...
pub fn lower_parameter_memory_element_v1(
    types: &[SemanticTypeDeclV1],
    ty: SemanticTypeIdV1,
) -> Result<Type, ProductionSourceArgumentErrorV1> {
...
pub enum KernelParameterShapeV1 {
    Direct(Type),
    Components(Vec<ByValueKernelParameterComponentV1>),
}

pub fn kernel_parameter_shape_v1(
...
pub type HelperParameterComponentsV1 = Vec<(
    Vec<SemanticKirParameterProjectionV1>,
    SemanticTypeIdV1,
    Type,
)>;

pub fn helper_parameter_shape_v1(
    types: &[SemanticTypeDeclV1],
    function: &SemanticFunctionDeclV1,
    function_id: SemanticFunctionIdV1,
...
pub fn helper_parameter_shape_with_policy_v1(
    types: &[SemanticTypeDeclV1],
    function: &SemanticFunctionDeclV1,
    function_id: SemanticFunctionIdV1,
    mapped: fe2o3_mir_model::SemanticAdjustedArgumentV1<'_>,
