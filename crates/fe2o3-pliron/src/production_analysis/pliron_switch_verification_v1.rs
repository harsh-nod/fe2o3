...
pub(crate) fn census_switch_verification_v1(
    ...
    census_switch_verification_with_observation_v1(context, switch, limits, None)
}

pub(crate) fn census_switch_verification_with_observation_v1(
    context: &Context,
    switch: SwitchOpV3,
    limits: ProductionAnalysisResourceLimitsV1,
    observer: Option<&InvocationObserverV1<'_, '_>>,
    ...
    let result = match observer {
        None => census_switch_verification_inner_v1(context, switch, limits, None),
        Some(observer) => observer.with_projection(&Ok, |nested| {
            census_switch_verification_inner_v1(context, switch, limits, Some(nested))
        }),
    };
...
fn census_switch_verification_inner_v1(
    context: &Context,
    switch: SwitchOpV3,
    limits: ProductionAnalysisResourceLimitsV1,
    observer: Option<&InvocationObserverV1<'_, '_>>,
    ...
    require(limits, HEADER_WORK, FRAME_CELLS, observer)?;
    ...
    require(limits, traversal_work, FRAME_CELLS, observer)?;
