...
pub(super) fn source(repeated: bool, annotated: bool) -> AdmittedInertSemanticMirV1 {
    ...
    .with_kernel_entry(SemanticKernelEntryV1::new(
        SemanticLinkSymbolV1::new(b"defined_math_results_component".to_vec()).unwrap(),
    ...
    let callables = vec![
        ...
        terminal(
            181,
            abi(181, &[], 4, false),
            SemanticCompilerIntrinsicOperationV1::MathContextCurrent { context: ty(4) },
        ),
    ];
    if annotated {
        ...
        let record = SemanticKernelMathDeriveV1::for_defined_function(
            ...
            &callables,
            &types,
            SemanticKernelMathDeriveTypesV1::new([2, 1, 3, 4].map(ty)),
            provenance,
