//! Shared Workgroup address transparency for the exact allocation consumer.
//! This does not prove an issuer or replace the later SSA loan/liveness checks.
...
impl<'a> AllocationBorrow<'a> {
    ...
    pub(super) const fn pair(self) -> (SemanticTypeIdV1, SemanticTypeIdV1) {
