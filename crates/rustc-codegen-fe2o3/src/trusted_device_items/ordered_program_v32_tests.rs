#[test]
fn ordered_program_v32_provider_requires_exact_definition_and_complete_source() {
    let item = TrustedDeviceItem::AmdGpuOrderedProgramE32;
    ...
    for path in [
        "local::__amdgpu_ordered_program_e32_v1",
        "diagnostics::lookalike::__amdgpu_ordered_program_e32_v1",
        "diagnostics::__amdgpu_ordered_xor_add_e32_v1",
    ] {
...
#[test]
fn ordered_program_v32_marker_is_one_closed_non_helper_terminal() {
