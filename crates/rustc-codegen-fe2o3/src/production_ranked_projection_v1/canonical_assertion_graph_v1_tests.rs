mod canonical_assertion_graph_tests {
    ...
    include!("private_array_attachment_v1_tests.rs");
    include!("reachable_induction_roster_v2_tests.rs");
    include!("checked_output_session_v1_tests.rs");
    ...
    fn genuine_absent_source_assertion_is_not_queried_or_relabelled_elided() {
        ...
        assert_same_owner_induction_report_v2(&program);
        let evidence =
            fe2o3_mir_model::InertCanonicalSemanticU32InductionEvidenceV1::from_report(report)
                .unwrap();
        ...
        let replay = evidence
            ...
            .unwrap();
        assert_eq!(
            fe2o3_mir_model::InertCanonicalSemanticU32InductionEvidenceV1::from_report(&replay)
                .unwrap(),
            evidence,
        );
    }
