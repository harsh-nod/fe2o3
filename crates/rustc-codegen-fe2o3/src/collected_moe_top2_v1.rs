...
const TRUSTED_TERMINAL_IDENTITY_V5: [u8; 32] = [
    0xb5, 0x14, 0x20, 0xb6, 0x3c, 0x55, 0x40, 0x85, 0x40, 0x05, 0x48, 0x26, 0xb0, 0x45, 0x0c, 0xb5,
    0x9a, 0xf3, 0x71, 0xeb, 0x24, 0x0b, 0xcf, 0x86, 0x21, 0x64, 0x6d, 0xc7, 0xde, 0xb6, 0xfe, 0xb3,
];
...
mod tests {
    ...
    #[test]
    fn trusted_terminal_manifest_is_the_exact_grid_leader_closure() {
        assert_eq!(
            REQUIRED_TRUSTED_ITEMS_V1[0],
            TrustedDeviceItem::DisjointSlice
        );
        assert_eq!(
            &REQUIRED_TRUSTED_ITEMS_V1[1..],
            REVIEWED_SEMANTIC_TERMINALS_V1
        );
        assert_eq!(
            REVIEWED_SEMANTIC_TERMINALS_V1,
