...
#[path = "production_rustc_driver_v1/amdgpu_outputs_v1.rs"]
mod amdgpu_outputs_v1;
use amdgpu_outputs_v1::{
    extract_amdgpu_compiler_handoff_in_active_session_v1, extract_amdgpu_llvm_in_active_session_v1,
};
...
#[cfg(all(test, target_os = "linux"))]
mod gfx942_physical_global_copy_qualification_v21_tests;
...
#[cfg(all(test, target_os = "linux"))]
mod gfx942_bf16_call_source_cpu_qualification_v1_tests;
#[cfg(all(test, target_os = "linux"))]
