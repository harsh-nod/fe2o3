...
#[path = "production_extraction_publication_v1.rs"]
mod extraction_publication;
use extraction_publication::publish_new_extraction_bytes_v1;
#[cfg(test)]
use extraction_publication::publish_new_extraction_bytes_with_writer_v1;
