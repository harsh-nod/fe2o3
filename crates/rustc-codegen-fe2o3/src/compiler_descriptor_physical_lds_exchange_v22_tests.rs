...
fn exact() -> TargetCapability {
    TargetCapability::Extension {
        namespace: fe2o3_kernel_ir::AMDGPU_GFX942_PHYSICAL_LDS_EXCHANGE_CAPABILITY_NAMESPACE_V22
            .into(),
        name: fe2o3_kernel_ir::AMDGPU_GFX942_PHYSICAL_LDS_EXCHANGE_CAPABILITY_NAME_V22.into(),
    }
}
