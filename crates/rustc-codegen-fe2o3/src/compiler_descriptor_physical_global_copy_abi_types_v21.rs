...
impl From<fe2o3_kernel_ir::PhysicalGlobalCopyKernargReadV21> for Read {
    fn from(row: fe2o3_kernel_ir::PhysicalGlobalCopyKernargReadV21) -> Self {
        Self {
...
impl From<fe2o3_kernel_ir::PhysicalGlobalCopyAccessV21> for Access {
    fn from(row: fe2o3_kernel_ir::PhysicalGlobalCopyAccessV21) -> Self {
        Self {
            location: row.location(),
            site: row.source_site(),
...
impl From<fe2o3_kernel_ir::PhysicalGlobalCopyReadV21> for GlobalRead {
    fn from(row: fe2o3_kernel_ir::PhysicalGlobalCopyReadV21) -> Self {
        Self {
...
impl From<fe2o3_kernel_ir::PhysicalGlobalCopyStoreV21> for GlobalStore {
    fn from(row: fe2o3_kernel_ir::PhysicalGlobalCopyStoreV21) -> Self {
        Self {
            access: row.access().into(),
            value: row.value(),
            mask_at: row.mask_at(),
...
impl Conditions {
    pub(super) fn from_report(
        report: &fe2o3_kernel_ir::PhysicalGlobalCopyMemoryObligationsV21,
    ) -> Self {
