...
pub(super) fn current_sources() -> Vec<FilePin> {
    ...
    for (relative, expected) in [
        (
            "crates/rustc-codegen-fe2o3/tests/fixtures/tiled-region-inspection-v1/src/lib.rs",
            include_bytes!("../../tests/fixtures/tiled-region-inspection-v1/src/lib.rs").as_slice(),
        ),
        (
            "crates/rustc-codegen-fe2o3/tests/fixtures/tiled-region-inspection-v1/Cargo.toml",
            include_bytes!("../../tests/fixtures/tiled-region-inspection-v1/Cargo.toml").as_slice(),
        ),
        (
            "crates/rustc-codegen-fe2o3/tests/fixtures/tiled-region-inspection-v1/Cargo.lock",
            include_bytes!("../../tests/fixtures/tiled-region-inspection-v1/Cargo.lock").as_slice(),
        ),
        (
...
pub(super) fn derive_record(directory: &Path, feature: &str) -> PreparedInvocation {
    ...
    PreparedInvocation {
        schema: "fe2o3-test-tiled-region-invocation-v1".into(),
