//! Actual Rust -> checked KIR21 -> CPU/LLVM/normal inert descriptor handoff.
...
#[path = "gfx942_physical_global_copy_production_observation_v21_tests.rs"]
mod observation;

const OUTPUT_ENV: &str = "FE2O3_TEST_PHYSICAL_GLOBAL_COPY_PRODUCTION_OUTPUT_V21";
const CHILD_ENV: &str = "FE2O3_TEST_PHYSICAL_GLOBAL_COPY_PRODUCTION_INPUTS_V21";
const FEATURE_ENV: &str = "FE2O3_TEST_PHYSICAL_GLOBAL_COPY_PRODUCTION_FEATURE_V21";
const PACKAGE: &str = "fe2o3-production-extraction-fixture";
const CRATE_NAME: &str = "fe2o3_production_extraction_fixture";
const CHILD: &str = "production_rustc_driver_v1::gfx942_physical_global_copy_production_v21_tests::actual_physical_global_copy_production_child";
const PREFIX: &str = "FE2O3_PHYSICAL_GLOBAL_COPY_PRODUCTION_OBSERVATION_V21 ";
const MODE_ENV: &str = "FE2O3_TEST_PHYSICAL_GLOBAL_COPY_PRODUCTION_MODE_V21";
...
fn derive_record(directory: &Path, feature: &str) -> PreparedInvocation {
    ...
    PreparedInvocation {
        schema: "fe2o3-test-source-physical-global-copy-production-invocation-v21".into(),
...
#[test]
#[ignore = "isolated actual AMD rustc child; use actual_physical_global_copy_production_ladder"]
fn actual_physical_global_copy_production_child() {
    let directory =
    ...
    println!(
        ...
        serde_json::to_string(&json!({
            "schema": "fe2o3-test-source-physical-global-copy-production-observation-v21",
...
fn actual_physical_global_copy_production_ladder() {
    ...
    fs::write(
        ...
        serde_json::to_vec_pretty(&json!({
            "schema": "fe2o3-test-source-physical-global-copy-production-ladder-v21", "observations": observations,
            "public_driver_output_relation": "exact_bytes_same_current_source",
            "cpu_positive_cases": 128, "cpu_negative_controls": 6, "exact_negative_runs": 21, "actual_owner_abi_negative_controls": 88, "abi_resource_denial_controls": 8,
...
#[test]
fn physical_global_copy_production_controls_reject_wrong_stage_or_feature() {
