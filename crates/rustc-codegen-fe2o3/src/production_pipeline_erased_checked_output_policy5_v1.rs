...
use super::checked_output_policy5_v1::CheckedOutputPolicy5StageErrorV1;
#[cfg(test)]
...
use fe2o3_lower_mir_kernel::ProductionUnitLocalErasedCheckedOutputOwnerPolicy5V1 as Admitted;
...
/// final fixed Policy5 custody. No conversion to the historical direct owner.
...
impl PreparedErasedCheckedOutputArtifactsV1 {
    pub(crate) fn native_worker_output_v1(
        ...
        super::native_checked_output_handoff_v1::OutputInputsV1 {
            owner: super::native_checked_output_handoff_v1::OutputOwnerV1::Erased5(&self.admitted),
...
> {
    let (parts, retained) = prepare_checked_artifact_parts_v1(
        CheckedArtifactsOwnerRefV1::Erased5(&admitted),
        profile,
        typed_roots,
        source_envelope,
...
impl RankedVerifiedProductionCompilation {
    ...
    #[allow(dead_code)]
    pub(crate) fn lower_silent_unit_checked_output_policy5_v1(
        self,
            ...
            Owner::from_module_ref_with_verification_budget_v12(binding.module(), &mut budget)
                .map_err(|error| {
                    ProductionPipelineError::CheckedOutputPolicy5Stage(
                        CheckedOutputPolicy5StageErrorV1::Canonical(error),
                    )
                })?;
        budget
        ...
        let checked =
            fe2o3_kernel_opt::optimize_checked_canonical_kernel_ir_policy5_v1(&bound, &mut budget)
                .map_err(|error| {
                    ProductionPipelineError::CheckedOutputPolicy5Stage(
                        CheckedOutputPolicy5StageErrorV1::Optimization(Box::new(error)),
                    )
                })?;
        budget
        ...
        phase.complete();
        #[cfg(test)]
        super::checked_output_policy5_v1::snapshots::observe(
            &bound,
            checked
    ...
    > {
        ...
        let (source_lineage, storage) =
            crate::production_native_source_lineage_v1::try_prepare_erased_native_source_lineage_v1(
                ...
                budget,
            ).map_err(|error| ProductionPipelineError::CheckedOutputPolicy5Stage(
