//! Additive actual-I worker preparation. No raw module/source constructor.
use super::*;

pub(crate) fn prepare_checked_output_policy6_worker_handoff(
    ...
    prepare_checked_output_worker_handoff_v1(
        CheckedOutputOwnerRefV1::Direct6(admitted),
        catalog,
        target,
        llvm_ir,
        typed_roots,
...
pub(crate) fn prepare_erased_checked_output_policy6_worker_handoff(
    admitted: &fe2o3_lower_mir_kernel::ProductionUnitLocalErasedCheckedOutputOwnerPolicy6V1,
    catalog: &fe2o3_kernel_ir::InertCanonicalKernelIrContractCatalogV1,
    target: fe2o3_compiler_ffi::DeviceTargetV1,
    llvm_ir: String,
    typed_roots: &[crate::compiler_descriptor::TypedDescriptorRootV1],
    ...
    prepare_checked_output_worker_handoff_v1(
        CheckedOutputOwnerRefV1::Erased6(admitted),
        catalog,
        target,
        llvm_ir,
        typed_roots,
