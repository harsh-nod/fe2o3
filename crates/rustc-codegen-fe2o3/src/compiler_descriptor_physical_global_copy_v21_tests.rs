...
fn exact() -> TargetCapability {
    TargetCapability::Extension {
        namespace: fe2o3_kernel_ir::AMDGPU_GFX942_PHYSICAL_GLOBAL_COPY_CAPABILITY_NAMESPACE_V21
            .into(),
        name: fe2o3_kernel_ir::AMDGPU_GFX942_PHYSICAL_GLOBAL_COPY_CAPABILITY_NAME_V21.into(),
    }
}
