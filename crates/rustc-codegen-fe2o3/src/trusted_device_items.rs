...
const REVIEWED_SAFE_EXECUTION_SOURCE_CLOSURE_V1: [u8; 32] = [
    0xa4, 0xaf, 0xa4, 0x4a, 0xdc, 0x42, 0x03, 0x73, 0x47, 0x61, 0x62, 0x16, 0x27, 0x30, 0x4c, 0xb2,
    0x41, 0x31, 0x1e, 0x8d, 0xb8, 0x57, 0xe2, 0xec, 0x30, 0x77, 0x86, 0x70, 0xcc, 0xe0, 0x95, 0x8f,
];
#[allow(
    dead_code,
...
const REVIEWED_GENERAL_GEMM_DISJOINT_SLICE_DEPENDENCY_V1: [u8; 32] = [
    0xe5, 0xab, 0xc2, 0x4a, 0x2f, 0x42, 0xbe, 0x1a, 0x0c, 0xfa, 0xbc, 0x54, 0xbe, 0x9e, 0x8b, 0x4d,
    0x49, 0x6e, 0x30, 0x34, 0x17, 0x9a, 0xe1, 0x1b, 0x85, 0xb0, 0xae, 0x79, 0x35, 0x8a, 0x3a, 0x6f,
];
...
mod tests {
    ...
    fn existing_flash_moe_and_workgroup_profile_bytes_match_the_parent() {
        ...
        assert_eq!(
            closure,
            digest("a4afa44adc4203734761621627304cb241311e8db857e2ec30778670cce0958f")
        );
