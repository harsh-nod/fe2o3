...
const REVIEWED_GENERAL_GEMM_PROVIDER_SOURCE_CLOSURE_V1: [u8; 32] = [
    0xd5, 0x45, 0x41, 0xfa, 0x80, 0x76, 0x9f, 0x77, 0x2b, 0xf4, 0x71, 0x16, 0xbf, 0x04, 0x1b, 0xb0,
    0xad, 0x34, 0xfe, 0x6a, 0xdf, 0x60, 0x74, 0x44, 0x92, 0xd7, 0x66, 0xc3, 0xe6, 0xd3, 0x6b, 0xa1,
];
...
const REVIEWED_GENERAL_GEMM_COMPILER_OBSERVATIONS_V1: &[(u64, [u8; 16])] = &[
    (
        0x5275_fd81_d2c1_6118,
        [
            0x14, 0x96, 0xc7, 0x3b, 0x06, 0xab, 0xe1, 0x5a, 0x0c, 0xa8, 0x50, 0x75, 0x0c, 0xdd,
            0x60, 0x28,
        ],
    ),
    (
