...
const REVIEWED_SAFE_EXECUTION_SOURCE_CLOSURE_V1: [u8; 32] = [
    0x6a, 0xfd, 0x4f, 0x3c, 0x66, 0xfd, 0x47, 0x78, 0x65, 0xec, 0xae, 0x72, 0x82, 0x38, 0x6a, 0x3b,
    0xf4, 0x5d, 0xd7, 0x1e, 0x60, 0x28, 0xe1, 0xdd, 0xdd, 0x2e, 0x1b, 0x4d, 0xba, 0x9a, 0x5b, 0xe8,
];
...
mod tests {
    ...
    fn source_closure_uses_canonical_relative_order_for_component_prefixes() {
        ...
        assert_eq!(
            closure,
            digest("6afd4f3c66fd477865ecae7282386a3bf45dd71e6028e1dddd2e1b4dba9a5be8")
        );
        assert_eq!(closure, super::REVIEWED_SAFE_EXECUTION_SOURCE_CLOSURE_V1);
    }
