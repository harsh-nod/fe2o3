#[test]
fn physical_global_copy_v38_terminal_allocation_is_exclusively_combined_v8() {
    ...
    for (expansion, tag) in rows {
        ...
        assert_eq!(
            terminal_expansion_tag_for_schema_v1(expansion, TerminalIdentitySchemaV1::CombinedV8),
            tag
        );
        for schema in [
