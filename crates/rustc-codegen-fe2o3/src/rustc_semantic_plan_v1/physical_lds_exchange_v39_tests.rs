#[test]
fn physical_lds_exchange_v39_terminal_allocation_is_exclusively_combined_v9() {
    ...
    for (expansion, tag) in rows {
        ...
        assert_eq!(
            terminal_expansion_tag_for_schema_v1(expansion, TerminalIdentitySchemaV1::CombinedV9),
            tag
        );
        for schema in [
