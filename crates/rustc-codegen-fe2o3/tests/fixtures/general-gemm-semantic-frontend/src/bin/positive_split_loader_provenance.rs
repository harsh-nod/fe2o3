...
pub fn positive_split_loader_provenance(
    a: &[u16],
    b: &[u16],
    ...
    while wave.has_remaining_phases() {
        ...
        let a_bits = [
            positive_hostile_common::split_provenance_load(a, a_row, depth, m, k, lda),
            positive_hostile_common::split_provenance_load(a, a_row, depth + 1, m, k, lda),
            positive_hostile_common::split_provenance_load(a, a_row, depth + 2, m, k, lda),
            positive_hostile_common::split_provenance_load(a, a_row, depth + 3, m, k, lda),
        ];
        let b_bits = [
            positive_hostile_common::split_provenance_load(b, depth, b_column, k, n, ldb),
            positive_hostile_common::split_provenance_load(b, depth + 1, b_column, k, n, ldb),
            positive_hostile_common::split_provenance_load(b, depth + 2, b_column, k, n, ldb),
            positive_hostile_common::split_provenance_load(b, depth + 3, b_column, k, n, ldb),
        ];
