...
use rustc_codegen_fe2o3::semantic_layout_bridge::{
    ...
    SEMANTIC_LAYOUT_EVIDENCE_SCHEMA_V1, SEMANTIC_LAYOUT_EVIDENCE_VERSION_V1,
...
fn g2_layout_evidence_is_versioned_target_bound_and_canonical() {
    ...
    assert_eq!(first.schema(), SEMANTIC_LAYOUT_EVIDENCE_SCHEMA_V1);
    assert_eq!(first.version(), SEMANTIC_LAYOUT_EVIDENCE_VERSION_V1);
    ...
    assert_eq!(
        ...
        concat!(
            "fe2o3.semantic-layout-evidence.v1|",
