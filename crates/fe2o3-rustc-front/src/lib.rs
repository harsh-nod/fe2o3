...
pub use kernel_contract_v1::{
    ...
    FRONTEND_KERNEL_CONTRACT_MAGIC_V1, FRONTEND_KERNEL_CONTRACT_VERSION_V1,
    FrontendGridDimensionsV1, FrontendLaunchBoundsV1, FrontendUnsafeAssemblyDeclarationV1,
    FrontendUnsafeAssemblyTargetV1, FrontendWorkgroupDimensionsV1,
