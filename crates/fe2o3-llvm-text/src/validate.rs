...
use fe2o3_llvm_handoff::{
    ...
    NamedMetadataV1, TerminatorV2, ValueIdV2,
};
        ...
        for block in function.blocks() {
            for instruction in block.instructions() {
                match instruction.kind() {
                    InstructionKindV2::GetElementPtr { indices, .. } if indices.len() != 1 => {
...
fn validate_instruction_uses(
    ...
    match instruction {
        InstructionKindV2::Constant(_) | InstructionKindV2::GlobalAddress(_) => Ok(()),
