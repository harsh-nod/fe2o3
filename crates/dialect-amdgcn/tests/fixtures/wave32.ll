...
declare i32 @llvm.amdgcn.ballot.i32(i1) #2
...
bb0:
  ...
  %v3 = add i32 %v3.lo, 0
  %v4 = call i32 @llvm.amdgcn.ballot.i32(i1 %arg0)
  %v5.mask = call i32 @llvm.amdgcn.ballot.i32(i1 %arg0)
  %v5 = icmp ne i32 %v5.mask, 0
  %v6.mask = call i32 @llvm.amdgcn.ballot.i32(i1 %arg0)
  %v6 = icmp eq i32 %v6.mask, -1
  %v7.lane.lo = call i32 @llvm.amdgcn.mbcnt.lo(i32 -1, i32 0)
  %v7.lane = add i32 %v7.lane.lo, 0
  %v7.tile.base = and i32 %v7.lane, -16
  %v7.tile.relative = and i32 %arg2, 15
