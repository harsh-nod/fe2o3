...
an exact policy identity. A separate readiness record binds the admitted issuer
PID to that exact manifest and policy after durable recovery. Neither record
grants process or signing authority. The crate contains no process launcher,
signer, durable ledger, compiler, artifact publisher, loader, or GPU execution
authority.
