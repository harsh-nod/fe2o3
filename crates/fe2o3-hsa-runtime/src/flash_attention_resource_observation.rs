...
use fe2o3_host::{
    FlashAttentionV1KernelResourceObservationV1, ReviewedFlashAttentionV1RuntimeAdapterV1,
};

const INVALID_RESOURCE_BINDING: &str = "FlashAttention kernel resource binding";
...
unsafe impl ReviewedFlashAttentionV1RuntimeAdapterV1 for ReviewedHsaRuntimeAdapterV1 {
...
) -> Result<FlashAttentionV1KernelResourceObservationV1, HsaRuntimeAdapterError> {
