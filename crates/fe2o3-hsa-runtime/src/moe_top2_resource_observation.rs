...
use fe2o3_host::{MoeTop2V1KernelResourceObservationV1, ReviewedMoeTop2V1RuntimeAdapterV1};

const INVALID_RESOURCE_BINDING: &str = "MoeTop2 kernel resource binding";
...
unsafe impl ReviewedMoeTop2V1RuntimeAdapterV1 for ReviewedHsaRuntimeAdapterV1 {
...
) -> Result<MoeTop2V1KernelResourceObservationV1, HsaRuntimeAdapterError> {
