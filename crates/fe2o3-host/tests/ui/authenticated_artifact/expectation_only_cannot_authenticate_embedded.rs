...
use fe2o3_host::{
    AuthenticatedKernelArtifactV1, CompilerGeneratedKernelExpectationV1,
    CompilerGeneratedKernelProfileV1, ObservedContext,
};
...
fn authenticate(observed: &ObservedContext) {
    let _ = AuthenticatedKernelArtifactV1::<Marker>::authenticate(observed);
}
