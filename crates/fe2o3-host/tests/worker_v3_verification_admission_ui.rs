...
fn worker_v3_verification_typestate_is_closed() {
    ...
    if cfg!(feature = "worker-v3-verifier-test-support") {
        for case in [
            ...
            "compiler_current_record_evidence_view_blocks_bound_lane_move.rs",
            "compiler_current_record_evidence_view_blocks_owner_move.rs",
            "compiler_current_record_evidence_view_cannot_clone.rs",
            ...
            "load_envelope_evidence_view_blocks_owner_move.rs",
            "load_envelope_evidence_view_cannot_clone.rs",
            "load_envelope_evidence_view_cannot_escape.rs",
