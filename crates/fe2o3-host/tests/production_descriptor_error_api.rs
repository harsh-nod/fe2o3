use fe2o3_host::{
    ApplicationDescriptorHandoffErrorV1, ProductionWorkerV3AuthenticationErrorV1,
...
fn production_descriptor_errors_are_public_without_worker_v2() {
    ...
    fn accepts_authentication(_: Option<ProductionWorkerV3AuthenticationErrorV1<std::io::Error>>) {}
