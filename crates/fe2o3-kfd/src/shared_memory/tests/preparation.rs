...
pub(crate) struct PreparationMemoryFixtureV1 {
    ...
    pub(super) control_release_skip: Option<usize>,
    pub(super) control_release_projection_fault: Option<(
        usize,
        control_cleanup::CleanupStageV1,
        adapter::ProjectionFaultV1,
    )>,
    pub(super) data_release_process_poisoned: usize,
    pub(super) data_release_calls: usize,
    pub(super) data_release_native_fault: Option<(usize, &'static str, bool)>,
    pub(super) data_release_currentness_fault: Option<(usize, usize, bool)>,
    pub(super) data_release_projection_ordinal: Option<usize>,
...
impl PreparationMemoryFixtureV1 {
    ...
    pub(crate) fn with_host_budget(configured: bool, bytes: u64, host_bytes: u64) -> Self {
        ...
        Self {
            ...
            control_release_skip: None,
            control_release_projection_fault: None,
            data_release_process_poisoned: 0,
            data_release_calls: 0,
            data_release_native_fault: None,
            data_release_currentness_fault: None,
            data_release_projection_ordinal: None,
