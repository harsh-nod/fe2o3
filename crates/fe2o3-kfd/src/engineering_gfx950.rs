...
#[path = "engineering_gfx950_debug_cold_v1.rs"]
mod debug_cold;
#[cfg(target_endian = "little")]
#[path = "engineering_gfx950_debug_metadata_v1.rs"]
mod debug_metadata;
...
impl Context {
    ...
    fn load(
        ...
        self.check_idle()?;
        self.check_currentness(true)?;
        let kernel = self.materialize_admitted_kernel(object, expected_hash, symbol)?;
