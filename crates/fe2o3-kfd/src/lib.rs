...
pub use queue::{
    ...
    Gfx942SdmaDispatchDataDemotionFailureV1, Gfx942SdmaMultiQueueExecutionCustodyV1,
...
pub use sdma::{
    ...
    GFX942_SDMA_RING_BYTES_V1, GFX942_SDMA_SUBMISSION_BYTES_V1, Gfx942CombinedSdmaCapacityV1,
