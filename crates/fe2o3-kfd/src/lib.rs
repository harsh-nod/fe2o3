...
pub use queue::{
    ...
    Gfx942ComputeEventReleaseObservationV1, Gfx942DetachedFixedDispatchV1,
    ...
    Gfx942PromotedSdmaDestinationV1, Gfx942R66NativeObservationFailureV1,
    ...
    KfdTargetRuntimeDebugQueueV1, MAX_ACTIVE_DEPENDENCY_TARGETS_PER_SESSION_V1,
...
pub use sdma::{
    ...
    Gfx942DevicePoolUsageV1, Gfx942DirectionalSdmaQueueObservationV1, Gfx942NativeXgmiSdmaBatchV1,
    Gfx942NativeXgmiSdmaQueueCreationFailureV1, Gfx942NativeXgmiSdmaQueueV1,
