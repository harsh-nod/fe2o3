...
use super::{
    ...
    checks::CheckError, continuity::Native, native,
};
use fe2o3_kernel_ir::{
...
/// Additional unreserved storage over the consumed pidfd's full logical charge.
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct LiveClientPidfdStorageV2(usize);
impl LiveClientPidfdStorageV2 {
    /// Keep the input reservation and reserve this delta before retaining the owner.
...
/// launch, signal, wait, reap, raw descriptor or transfer operation.
///
