...
use gpu_host::__generated::GeneratedHostReadSliceV1;
...
fn arguments(target: &[u32]) -> atomic_gpu::Arguments<'_> {
    atomic_gpu::Arguments::new(GeneratedHostReadSliceV1::new(target))
}
