...
pub fn lds_exclusive_scan_u32_3_v1(values: &[u32], mut output: DisjointSlice<u32>) {
    exclusive_scan_u32_body!(values, output, 3);
}
...
pub fn lds_exclusive_scan_u32_65_v1(values: &[u32], mut output: DisjointSlice<u32>) {
    exclusive_scan_u32_body!(values, output, 65);
}
...
pub fn lds_exclusive_scan_u32_v1(values: &[u32], mut output: DisjointSlice<u32>) {
    exclusive_scan_u32_body!(values, output, 255);
}
