...
use fe2o3_gfx950_advanced_attention::{
    ...
    GFX950_ADVANCED_ATTENTION_WORKGROUP_V1,
};
...
#[test]
fn package_states_the_pending_lowering_boundary() {
    ...
    assert!(GFX950_ADVANCED_ATTENTION_SOURCE_BLOCKER_V1.contains("no authenticated"));
    assert!(GFX950_ADVANCED_ATTENTION_SOURCE_BLOCKER_V1.contains("gfx950 tensor/transpose"));
    assert!(GFX950_ADVANCED_ATTENTION_SOURCE_BLOCKER_V1.contains("runtime execution"));
}
