...
pub const GENERAL_TILED_GEMM_SOURCE_BLOCKER_V1: &str = "authenticated optimized MIR receives only non-authoritative structural analysis; production frontend correspondence is disabled until the complete optimized-MIR authority proof is closed";
...
pub const GENERAL_TILED_GEMM_SOURCE_BLOCKERS_V1: [&str; 5] = [
    ...
    "the 15-case proof-sensitive mutation corpus is a non-authoritative diagnostic oracle, not a positive-source verifier",
];
