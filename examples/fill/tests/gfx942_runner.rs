...
fn runner_enters_only_the_bounded_production_application_route() {
    ...
    assert!(
        RUNNER.contains("fe2o3_tutorial_hardware_authority_run_gfx942 \"$example_dir\" fe2o3-fill")
    );
    for forbidden in [
        "run-gfx942-common",
        "engineering hsaco",
...
#[test]
fn host_uses_the_generated_capability_application_route() {
    for required in [
        "fill_gpu::Arguments::new",
