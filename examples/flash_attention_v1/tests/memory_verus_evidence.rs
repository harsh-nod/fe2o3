...
const PROOF_SHA256: &str = "298a8d199ef57ba6581d82ea10b11ee6189e530cce8f5e0c0e69973e89238e6f";
...
const TRANSCRIPT: &str =
    "FE2O3_FLASH_ATTENTION_MEMORY_V1_VERUS_OK mutations=9 obligations=13";
const TRANSCRIPT_SHA256: &str =
    "6fd2d81784a642be8b2a6bf1985ff99c02e46d72816aa5294213022188732706";
...
#[test]
fn runner_is_fail_closed_and_transcript_authenticated() {
    for marker in [
...
#[test]
fn transcript_and_proof_mutations_change_the_receipt_identity() {
...
fn exact_memory_verus_runner_executes_authenticated_evidence() {
    let manifest = Path::new(env!("CARGO_MANIFEST_DIR"));
