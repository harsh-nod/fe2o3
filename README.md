...
entrypoint hardens itself before consuming fixed FDs 3 through 8. Its build gate
rejects dynamic-loader edges, undefined symbols, and non-fail-closed startup.
