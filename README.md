...
| Runtime | Pure-Rust KFD/AQL foundations, bounded persistent H2D/D2H/D2D storage, one exact full-allocation persistent compute bridge, and MI300X execution diagnostics; public application authorization, unified multi-device compute, and parity qualification are incomplete |
